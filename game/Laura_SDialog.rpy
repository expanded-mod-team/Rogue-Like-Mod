...
label Laura_SexDialog(TempLine = 0, TempLust = 0, TempLust2 = 0):    
    ...
    if Trigger == "hand":
            ...
            if not Speed:
                        ...
                        if L_Hand > 2:
                                ...
                                $ TempLust += 2 if L_Lust < 60 else 0
                        else:
                                $ Line = Line + "She just seems to be looking it over"
                                $ TempLust += 2 if L_Lust < 40 else 0
                                $ TempFocus += -3 if P_Focus > 50 else 2
                            
                        $ L_Addict -= 1 if D20S > 10 else 2
                        return
            
            if L_Hand > 4:                          # After the 5th time 
                        if Speed <= 1:                      #slow 
            ...
            elif 2 < L_Hand <= 4:                       #third through 5th time
                        if Speed <= 1:                      #slow
    ...
    #End Handy dialog ////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            if not Speed:
                        ...
                        $ TempLust += 6 if L_Lust > 60 else 3 
                        return
            
            if L_Tit > 4 and L_Blow:                                        #5th+ and blown
                        if Speed <= 1:                                              #slow
                            ...
                            $ TempLust += 7 if L_Lust > 60 else 4       
                        else:                                                       #fast
                            ...
                            $ TempFocus += 20 if P_Focus > 40 else 5                      
                            $ TempLust += 6 if L_Lust > 70 else 4    
                     
                
            elif L_Tit > 1:                                                 #third through 5th time
                    if Speed <= 1:                                              #slow
                        ...
                        $ TempLust += 6 if L_Lust > 60 else 4    
                    ...
                    if Speed <= 1:                                              #slow
                        ...
                        $ TempLust += 5 if L_Lust > 60 else 3    
    ...
    #End Action Titfuck ///////////////////////////////////////////////////////////////////////////////
            ...
            if not Speed: #if Laura is not moving                
                    if "hungry" in L_Traits:
                            ...
                            $ TempLust += 3 if L_Lust < 40 else 1                    
                    elif L_Blow > 2:
                            call LauraFace("sly")
                    ...
                    if L_Blow <= 1 or (L_Obed >= 500 and L_Obed > L_Inbt):
                            $ TempLust += 2 if L_Lust > 60 else 0                 
            ...
            if Speed == 1:                                                                  #Speed 1 (licking)
                    if L_Blow > 4:                                                                  #After the 5th time
                            ...
                            $ TempLust += 2 if L_Lust > 80 else 1
                        
                    elif L_Blow > 1:                                                                #After the 2nd time
                    ...
                    if L_Blow > 4:                                                                  #After the 5th time
                            ...
                            $ TempLust += 2 if L_Lust > 70 else 1    
                            ...
                            $ TempLust += 1 if L_Lust > 60 else 0    
                    ...
                    if L_Blow > 4:                                                                  #After the 5th time
                            ...
                            $ TempLust += 3 if L_Lust > 60 else 1    
                    ...
                    if L_Blow > 4:                                                                  #After the 5th time
                            ...
                            $ TempLust += 3 if L_Lust > 60 else 2    
                            ...
                            $ TempFocus += 20 if P_Focus > 40 else 5                      
                            $ TempLust += -3 if L_Lust < 60 else -1                        
                            $ TempLust += 5 if L_Obed > 500 else 0  
                            ...
                            $ TempLust += -5 if L_Lust < 60 else -2                       
                            $ TempLust += 7 if L_Obed > 500 else 0  
                    $ L_Addict -= 3
    ...
    # end L_Blowjob                                 //////////////////////////////////////////////////////////////////////////////
            ...
            if L_Sex > 4:
                if Speed > 1:                       # After the 5th time fast
                        ...
                        $ TempLust += 16 if L_Lust > 70 else 10                    
                        ...
                        $ TempLust += 12 if 40 > L_Lust > 90 else 10                        
                ...
                if Speed > 1:             #third through 5th time fast
                    ...
                    $ TempLust += 14 if L_Lust > 80 else 10
                    ...
                    $ TempLust += 10 if 50 > L_Lust > 90 else 8
                ...
                if Speed > 1:            # First and second time fast
                    ...
                    $ TempLust += 10 if L_Lust > 80 else 6
                    ...
                    $ TempLust += 8 if 60 > L_Lust > 90 else 6
    ...
    # end L_Sex                                 ////////////////////////////////////////////////////////////////////////////// 
            ...
            $ TempLust2 = 2
            if L_Panties and not L_PantiesDown: #if panties are in the way
                $ TempLust2 -= 1
            if HoseNum("Laura") >= 6: #if complete hose
                $ TempLust2 -= 1        
            if L_Legs and not L_Upskirt: #If pants/skirt is up
            ...
            if L_Hotdog >= 2:
                if Speed > 1:       # After the 2ndtime fast
                    ...
                    $ TempLust += (TempLust2 + 8) if 50 > L_Lust > 80 else (TempLust2 + 2)
                    ...
                    $ TempLust += (TempLust2 + 7) if 30 > L_Lust > 70 else (TempLust2 + 3)
                ...
                if Speed > 1:       #fast
                    ...
                    $ TempLust += (TempLust2 + 4) if 50 > L_Lust > 80 else (TempLust2 + 2)
                    ...
                    $ Line = Line + renpy.random.choice(["She grinds slowly against your cock", 
                        ...
                        "She slides slowly back and forth along your cock"])
                    $ TempFocus += (TempLust2 + 5) if P_Focus < 60 else (TempLust2 + 3)
                    $ TempLust += (TempLust2 + 5) if 50 > L_Lust > 70 else (TempLust2 + 2)
    ...
    # end L_Hotdog                                 //////////////////////////////////////////////////////////////////////////////
            ...
            if L_Anal >= 5:
                    if Speed > 1:#Fast
                            ...
                            $ TempLust += 14 if L_Lust > 80 else 9
                            ...
                            $ TempLust += 12 if 50 < L_Lust < 90 else 8
                              
            else: #if L_Loose:     #You've done some anal stuff before       
                    if Speed > 1:             #third through 5th time fast
                            $ Line = Line + renpy.random.choice(["She bounces rapidly against your cock", 
                                "You thrust into her and she squeaks a bit",
                                "You quickly grind back and forth inside her",
                            ...
                            $ TempLust += 12 if L_Lust > 80 else 6
                            ...
                            $ TempLust += 8 if 70 > L_Lust > 90 else 4
...
#                            $ TempLust += 2 if L_Lust > 80 else -3
...
#                            else:
#                                call Statup("Laura", "Lust", 10, -1, 1)
#                            call Statup("Laura", "Lust", 200, 2) 
                            
#                            $ TempFocus += 10 if P_Focus > 60 else 6                   
#                            $ TempLust += 4 if L_Lust > 60 else -1
                            
            $ TempLust = 0 if (L_Lust - TempLust) < 0 else TempLust
            
    # end L_Anal                                 //////////////////////////////////////////////////////////////////////////////
    
    elif Trigger == "fondle breasts":   
                    $ Line = "You continue to fondle Laura. "    
                    if not L_Uptop and L_Over and L_Chest: #Full top
                                ...
                                $ TempLust += 4 if L_Lust > 50 else 2
                    elif not L_Uptop and L_Over:        #Just overtop
                                ...
                                $ TempLust += 4 if L_Lust > 50 else 2   
                    elif not L_Uptop and L_Chest:       #just bra
                                $ Line = Line + renpy.random.choice(["You reach under her tight top and massage her breasts", 
                                    "You pass your hands gently over her warm breasts", 
                                    "Her nipples catch on the fabric of her top as you grasp her warm flesh, you can see them stiffen",
                                    "She gasps as you grasp her under her top"])
                                $ TempFocus += 3 if P_Focus < 60 else 2    
                                $ TempLust += 5 if L_Lust > 50 else 2    
                    elif L_Pierce: #pierced
                                $ Line = Line + renpy.random.choice(["You reach out and massage her full breasts", 
                                ...
                                $ TempLust += 6 if L_Lust > 40 else 4  
                    else: #topless
                                $ Line = Line + renpy.random.choice(["You reach out and massage her full breasts", 
                                ...
                                $ TempLust += 6 if L_Lust > 50 else 3  
                    $ L_Addict -= 2
    ...
    # end R Fondle breasts                                 //////////////////////////////////////////////////////////////////////////////
                    ...
                    if not L_Uptop and L_Over and L_Chest: #Full top
                                ...
                                $ TempFocus += 2 if P_Focus < 50 else 1  
                                $ TempLust += 2 if L_Lust < 30 else 1
                    elif not L_Uptop and L_Over:        #Just overtop
                                $ Line = renpy.random.choice(["You bend down and motor-boat her breasts",
                                ...
                                $ TempFocus += 2 if P_Focus < 50 else 1
                                $ TempLust += 5 if L_Lust > 50 else 3
                    elif not L_Uptop and L_Chest:       #just bra
                                $ Line = renpy.random.choice(["You bend down and motor-boat her breasts",
                                ...
                                $ TempLust += 10 if L_Lust > 40 else 7
                                $ L_Addict -= 2
                    else: #topless
                                $ Line = renpy.random.choice(["You bend down and motor-boat her breasts",
                                    "You gently nibble at her nipples as you suck on them",
                                ...
                                $ TempLust += 10 if L_Lust > 50 else 7  
                                $ L_Addict -= 2
    ...
    # end R Suck breasts                                 //////////////////////////////////////////////////////////////////////////////
                    ...
                    if (L_Legs == "leather pants" or L_Legs == "mesh pants") and not L_Upskirt:
                                ...
                                $ TempLust += 1 if L_Lust < 50 else 0
                            
                    elif L_Legs == "skirt" and HoseNum("Laura") >= 5: # skirt with full hose          
                                ...
                                $ TempLust += 2 if L_Lust < 40 else 0                                
                                $ L_Addict -= 1 if D20S > 10 else 0                            
                    elif L_Legs == "skirt" and L_Hose: #skirt with stockings         
                                $ Line = renpy.random.choice(["You reach under skirt and stroke her thighs", 
                                        "You lift her skirt a bit and feel her firm thighs", 
                                        "Her legs twitch a bit beneath her skirt",
                                ...
                                $ TempLust += 2 if L_Lust < 50 else 0                               
                                $ L_Addict -= 1 if D20S > 10 else 0                            
                    elif L_Legs == "skirt":  #and no hose
                                $ Line = renpy.random.choice(["You reach under skirt and stroke her thighs", 
                                        "You lift her skirt a bit and feel her firm thighs", 
                                        "Her legs twitch a bit beneath her skirt",
                                        "She gasps as you stroke her warm thighs",
    ...
    # end R fondle thighs                               //////////////////////////////////////////////////////////////////////////////
                    ...
                    if Speed == 2 and D20S <= 10:
                            ...
                            if (L_Legs == "pants" or L_Legs == "mesh pants") and not L_Upskirt:
                                    ...
                                    if L_Panties == "shorts" and not L_PantiesDown: #shorts on
                                    ...
                                    elif L_Panties and not L_PantiesDown: #Just panties
                            ...
                            $ TempLust += 6 if L_Lust > 40 else 3
                            $ L_Addict -= 2  
                            ...
                            if (L_Legs == "pants" or L_Legs == "mesh pants") and not L_Upskirt:
                                    ...
                                    if L_Panties == "shorts" and not L_PantiesDown: #shorts on
                                            ...
                                            if D20S <= 10:
                                                ...
                                                $ TempLust += 4 if L_Lust > 40 else 2
                                                $ L_Addict -= 2  
                            ...
                            if D20S > 10:#If it touches skin
                                ...
                                $ TempFocus += 2 if P_Focus < 50 else 1  
                                $ TempLust += 2 if L_Lust > 40 else 1
    ...
    # end R fondle pussy                               /////////////////////////////////////////////////////////////////////////////
                            ...
                            if (L_Legs == "pants" or L_Legs == "mesh pants") and not L_Upskirt:
                                        ...
                                        if L_Panties == "shorts" and not L_PantiesDown: #shorts on
                                               ...
                                               $ Line = renpy.random.choice(["You push her skirt up and lick at her pussy through her hose",                 
                                                ...
                                                if D20S <= 10:
                                                    ...
                                                    $ TempLust += 4 if L_Lust > 60 else 2
                                                    $ L_Addict -= 3  
                                                else: #If it touches skin
                                                    $ TempFocus += 1 
                                                    $ TempLust += 1
                                ...
                                if D20S > 10: #If it touches skin
                                    ...
                                    $ TempLust += 10 if L_Lust > 60 else 5
                                    $ L_Addict -= 3  
                                else: 
                                    $ TempFocus += 2 if P_Focus < 50 else 1  
                                    $ TempLust += 5 if L_Lust > 60 else 3
    ...
    # end R lick pussy                               /////////////////////////////////////////////////////////////////////////////
                        ...
                        if (L_Legs == "pants" or L_Legs == "mesh pants") and not L_Upskirt:
                                ...
                                if L_Panties == "shorts" and not L_PantiesDown: #shorts on
                                        ...
                                        if D20S <= 10:
                                            $ TempFocus += 2 if P_Focus < 50 else 1  
                                            $ TempLust += 3 if L_Lust > 40 else 2
                                            $ L_Addict -= 1  
                                        else: #If it touches skin
                                            $ TempFocus += 1 
                                            $ TempLust += 1
                        ...
                        #no skirt or pants
                        elif L_Panties and not L_PantiesDown: # panties   
    ...
    # end R fondle ass                               /////////////////////////////////////////////////////////////////////////////
                            ...
                            $ TempFocus += 2 if P_Focus < 50 else 1  
                            $ TempLust += 6 if L_Lust > 70 else 3
    ...
    # end R insert ass                              /////////////////////////////////////////////////////////////////////////////
                            ...
                            if (L_Legs == "pants" or L_Legs == "mesh pants") and not L_Upskirt:
                                ...
                                if D20S > 10: #If it touches skin
                                    ...
                                    $ TempLust += 9 if L_Lust > 60 else 4
                                    $ L_Addict -= 3  
                                else: 
                                    $ TempFocus += 1 if P_Focus < 50 else 0  
                                    $ TempLust += 4 if L_Lust > 60 else 2
    ...
    # end R lick ass                               /////////////////////////////////////////////////////////////////////////////
                        ...
                        if (L_Legs == "pants" or L_Legs == "mesh pants") and not L_Upskirt:
                                ...
                                $ TempFocus += 1 if P_Focus < 50 else 0  
                                $ TempLust += 3 if L_Lust < 50 else 1
                                ...
                                if L_Legs == "skirt" and L_Panties:            
                                    ...
                                    $ TempFocus += 2 if P_Focus < 50 else 1  
                                    $ TempLust += 8 if L_Lust > 70 else 5
                                elif L_Legs == "skirt":            
                                    ...
                                    $ TempFocus += 3 if P_Focus < 50 else 1  
                                    $ TempLust += 10 if L_Lust > 70 else 8
    # end R dildo pussy                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        if (L_Legs == "pants" or L_Legs == "mesh pants") and not L_Upskirt:
                                ...
                                if L_Legs == "skirt" and L_Panties:            
                                    ...
                                    $ TempFocus += 2 if P_Focus < 50 else 1  
                                    $ TempLust += 9 if L_Lust > 70 else 6
                                elif L_Legs == "skirt":            
                                    $ Line = renpy.random.choice(["You push her skirt aside, and slide the dildo into her tight hole", 
                                            "You slide the toy deep into her ass",
                                    ...
                                    $ TempFocus += 2 if P_Focus < 50 else 1  
                                    $ TempLust += 8 if L_Lust > 70 else 6
                                else:            
                                    ...
                                    $ TempFocus += 3 if P_Focus < 50 else 1  
                                    $ TempLust += 11 if L_Lust > 70 else 7
    # end R dildo ass                              /////////////////////////////////////////////////////////////////////////////
...
#                $ TempLust = 0
    ...
    # end R Masturbation                               /////////////////////////////////////////////////////////////////////////////
                ...
                call Laura_SexDialog_Threeway("lesbian")      
                        ...
                        if L_Foot > 4:                          # After the 5th time 
                                    if Speed <= 1:                      #slow 
                                        $ Line = Line + renpy.random.choice(["Her movements have become almost masterful, her slightest touch starts you twitching",
                                                "She slowly caresses you in a way that makes your blood boil, then pulls back at the last second",
                                                "She knows what to do now, and rubs your cock with smooth strokes, focusing occasionally on the head",
                        ...
                        elif L_Foot >= 3:                       #third through 5th time
                                    if Speed <= 1:                      #slow
    ...
    #End Footy dialog ////////////////////////////////////////////////////////////////////////////////////////////////////////
                        ...
                        $ L_Addict -= 3 
                        if L_Kissed > 10 and L_Love >= 700:#Loving
                                ...
                                $ TempLust += 3 if L_Lust < 50 else 0
                                $ TempLust += 1 if L_Lust < 90 else 0
                        elif L_Kissed > 5:#reasonably experienced        
                                ...
                                $ Line = renpy.random.choice(["She tentatively presses her lips against yours", 
                                        ...
                                        "Your hands slide down her body as your lips brush hers"]) 
                                $ TempFocus += 1 if P_Focus < 70 else 0  
                                $ TempLust += 2 if L_Lust < 30 else 0
                                $ TempLust += 1 if L_Lust < 70 else 0
...
label Laura_Self_Lines(Mode = "T3", Action = Trigger3, TempLustX = 0): 
    ...
    if not Action or D20S >= 15: 
            if Trigger != "masturbation" and "passive" in L_Traits:
    ...
    if Action == "hand": 
            ...
            $ TempFocus += 2 if L_Hand > 2 else 0
                    
            $ TempLustX += 2 if L_Lust < 60 else 1
            $ TempLustX += 2 if L_Hand > 2 else 0
            $ L_Addict -= 1            
    else:
        if L_Lust >= 80:   
        ...
        $ TempLustX += 4 if L_Lust > 80 else 0        
        $ TempLustX += 5 if L_Lust < 40 else 3                   #Bonus if she is relatively low lust
...
label Laura_Self_Set(Mode = "T3", Action = Trigger3, Length=0, Count2=0, Options =[]): 
    ...
    if Mode == "T3" and Trigger != "masturbation":
            ...
            if Taboo and L_SEXP >= 50 and ApprovalCheck("Laura", 500, "I"):
                if L_Lust <= 50:
                    return
            elif L_SEXP >= 25 and ApprovalCheck("Laura", 300, "I"):
                if L_Lust <= 30:
                    return
            else:
                    return
    ...
    if Trigger == "masturbation":
                ...
                if "dildo" in L_Inventory:
                        $ Options.append("dildo pussy")  
                        $ Options.append("dildo anal")                  
                if "vibrator" in L_Inventory:            
                        $ Options.append("vibrator pussy") 
            
    else:
                if Mode != "T5" and Trigger in ("fondle pussy", "fondle breasts", "fondle thighs", "kiss you", "fondle ass", "suck breasts") and L_Hand >= 5:
                        $ Options.append("hand")
                ...
                if "fondle pussy" not in Options and (L_Obed < L_Inbt):
                        $ Options.append("fondle pussy")
                    
                if "fondle ass" not in Options and (L_Obed < L_Inbt):
                        $ Options.append("fondle ass")
                    
                if "fondle breasts" not in Options and (L_Obed < L_Inbt):
                        $ Options.append("fondle breasts")
    # End filling options
...
label Laura_SexDialog_Threeway(Mode = 0, Action = 0, ActiveGirl = Primary, TempLine = 0, TempLust = 0, TempLust2 = 0, TempFocus = 0):
    ...
    # end R Masturbation Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        if Trigger == "blow" and L_Blow > 5 and Trigger4 == "kiss girl":
...
label Laura_Threeway_Set(Preset = 0, Mode = 0, Action = Trigger4, ActiveGirl = Primary, State = "watcher", TempLust = 0, TempLust2 = 0, TempFocus = 0):
            ...
            if not Preset: 
                    ...
                    if Mode == "lesbian": 
                            ...
                            if Trigger3 == "kiss girl" and L_Lust <= 20 and L_Org < 1:
            ...
            if Trigger == "lesbian":
                    ...
                    if Preset in ("hand","blow","kiss you","kiss both"):
                            ...
                            if Action != "kiss girl":                                
                                    ...
                                    $ Action = "kiss girl" 
                                    $ Trigger3 = "kiss girl" 
                                    if "lesbian" not in L_RecentActions:
                                            $ L_Les += 1
                    ...
                    pass            
            elif GirlLikeCheck("Laura",ActiveGirl) >= 600 and ApprovalCheck("Laura", (1500-(10*L_Les)-(10*(GirlLikeCheck("Laura",ActiveGirl)-60)))): 
...
#                if "dildo" in L_Inventory: #add later once these systems are done
#                    $ Options.append("dildo pussy") 
#                    if L_Loose:
