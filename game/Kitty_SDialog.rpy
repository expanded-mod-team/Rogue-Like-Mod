...
label Kitty_SexDialog(TempLine = 0, TempLust = 0, TempLust2 = 0):
    ...
    #End Handy dialog ////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            if not Speed:
                        if K_Tit > 2:
                            $ Line = "Kitty begins to rub her chest against you"
                        else:
            ...
            if K_Tit > 4 and K_Blow:                                        #5th+ and blown
                        if Speed <= 1:                                              #slow
                            ...
                            $ TempFocus += 12 if P_Focus < 70 else 4                      
                            ...
                            $ Line = renpy.random.choice(["Kitty rapidly rocks her breasts up and down around your cock", 
                                    ...
                                    "Kitty dances her nipples across the shaft",
                            ...
                            $ TempFocus += 15 if P_Focus > 40 else 5                      
                            $ TempLust += 5 if K_Lust > 70 else 3    
                     
                
            elif K_Tit > 1:                                                 #third through 5th time
                    if Speed <= 1:                                              #slow
                        $ Line = renpy.random.choice(["Kitty slides her breasts up and down around your cock", 
                        ...
                        $ Line = renpy.random.choice(["Kitty rapidly slides her breasts up and down around your cock", 
                        ...
                        $ TempFocus += 12 if P_Focus > 50 else 7                      
                        $ TempLust += 5 if K_Lust > 60 else 4    
                       
            else:                                                           #First and second time
                    if Speed <= 1:                                              #slow
                        $ Line = renpy.random.choice(["Kitty sort of presses her breasts back and forth against your cock", 
                        ...
                        $ TempFocus += 9 if P_Focus < 60 else 5                      
                        $ TempLust += 4 if K_Lust > 60 else 3    
                        ...
                        $ TempFocus += 6 if P_Focus > 70 else 3                      
                        $ TempLust += 4 if K_Lust > 60 else 3    
...
#                       $ TempLust = 0
    ...
    # end R Masturbation                               /////////////////////////////////////////////////////////////////////////////
                        ...
                        call Kitty_SexDialog_Threeway("lesbian")   
...
label Kitty_Self_Lines(Mode = "T3", Action = Trigger3, TempLustX = 0): 
    ...
    if not Action or D20S >= 15:   
            if Trigger != "masturbation" and "passive" in K_Traits:
                    ...
                    $ Line = 0
                    return                            
            call Kitty_Self_Set(Mode, Action)
    ...
    if Action == "hand": 
        ...
        if Partner != "Kitty": #If this is a primary, Trigger3 action
            $ TempLust = TempLustX
...
label Kitty_SexDialog_Threeway(Mode = 0, Action = 0, ActiveGirl = Primary, TempLine = 0, TempLust = 0, TempLust2 = 0, TempFocus = 0):
                        ...
                        if D20S <= 8 and (Trigger == "blow" or Trigger == "hand"): #This is a random bonus dialog
                            if Trigger == "blow": #If Rogue is blowing you
                                ...
                                $ Line = renpy.random.choice(["Kitty's tongue brushes against " + ActiveGirl + "'s hand as they work",
                                        ...
                                        "Kitty takes a turn to stroke a few times before passing it back",
                                        "Kitty and " + ActiveGirl + " get into an alternating rhythm"]) 
                            $ TempLust2 += 1 if GirlLikeCheck(ActiveGirl,"Kitty") >= 800 else 0                                             
                        else:
    ...
    # end K_Blowjob Threeway                                //////////////////////////////////////////////////////////////////////////////
                        ...
                        $ TempLust2 += 5 if GirlLikeCheck(ActiveGirl,"Kitty") >= 800 else 2
                        $ TempFocus += 1 
    # end R Fondle breasts Threeway                           //////////////////////////////////////////////////////////////////////////////
                        ...
                        $ TempLust += 2 if ApprovalCheck("Kitty", 500, "I") else 1  # Kitty's lust
                        $ TempLust2 += 4 if GirlLikeCheck(ActiveGirl,"Kitty") >= 800 else 2
                        $ TempFocus += 1                      
    # end R Suck breasts    Threeway                             //////////////////////////////////////////////////////////////////////////////
                        ...
                        $ TempLust += 2 if ApprovalCheck("Kitty", 500, "I") else 1  # Kitty's lust
                        $ TempLust2 += 5 if GirlLikeCheck(ActiveGirl,"Kitty") >= 800 else 3
                        $ TempFocus += 1  
    ...
    # end R fondle pussy  Threeway                             /////////////////////////////////////////////////////////////////////////////
                        ...
                        $ TempLust2 += 7 if GirlLikeCheck(ActiveGirl,"Kitty") >= 800 else 4
                        $ TempFocus += 3  
    ...
    # end R lick pussy   Threeway                            /////////////////////////////////////////////////////////////////////////////
                        ...
                        $ TempLust2 += 3 if GirlLikeCheck(ActiveGirl,"Kitty") >= 800 else 1
                        $ TempFocus += 1  
    # end R fondle ass   Threeway                            /////////////////////////////////////////////////////////////////////////////
                        ...
                        if ActiveGirl == "Rogue" and not R_Loose:
                                        $ TempLust2 -= 3
    ...
    # end R Masturbation   Threeway                            /////////////////////////////////////////////////////////////////////////////
                        ...
                        if Trigger == "blow" and K_Blow > 5 and Trigger4 == "kiss girl":  
                                    ...
                                    if Action == "kiss girl" or Mode == "lesbian":
                                        if Trigger == "lesbian" and Partner != "Kitty":
                        ...
                        $ TempLust += 1 if ApprovalCheck("Kitty", 500, "I") else 0  # Kitty's lust
                        $ TempLust += 1 if GirlLikeCheck("Kitty",ActiveGirl) >= 800 else 0
                        $ TempLust2 += 2 if GirlLikeCheck(ActiveGirl,"Kitty") >= 800 else 1
                        $ TempFocus += 1  
    # end K Kissing Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        $ TempLust += 1 if GirlLikeCheck("Kitty",ActiveGirl) >= 600 else 0  # Kitty's lust
                        $ TempLust += 2 if GirlLikeCheck("Kitty",ActiveGirl) >= 800 else 1  # Kitty's lust
...
label Kitty_Threeway_Set(Preset = 0, Mode = 0, Action = Trigger4, ActiveGirl = Primary, State = "watcher", TempLust = 0, TempLust2 = 0, TempFocus = 0):    
            ...
            if Trigger == "lesbian":
                    ...
                    if Preset in ("hand","blow","kiss you","kiss both"):
                            ...
                            pass
                    elif GirlLikeCheck("Kitty",ActiveGirl) >= 600 and ApprovalCheck("Kitty", 500, "I"):
                            pass
                    else:
                    ...
                    pass                            
            elif GirlLikeCheck("Kitty",ActiveGirl) >= 600 and ApprovalCheck("Kitty", (1500-(10*K_Les)-(10*(GirlLikeCheck("Kitty",ActiveGirl)-60)))): 
                    #If she likes both of you a lot, threeway
                    $ State = "threeway"
            elif ApprovalCheck("Kitty", 1000): 
                    #If she likes you well enough, Hetero
                    $ State = "hetero"            
            elif GirlLikeCheck("Kitty",ActiveGirl) >= 700: 
            ...
            if State == "lesbian" or State == "threeway":
                ...
                if ApprovalCheck("Kitty", 800, "I") or GirlLikeCheck("Kitty",ActiveGirl) >= 800:
                    $ Options.append("lick pussy")
                if ApprovalCheck("Kitty", 900, "I") and GirlLikeCheck("Kitty",ActiveGirl) >= 900:
...
#                    $ Options.append("vibrator") 
            ...
            if Preset:
                if Preset in Options:
                        ...
                        $ Options[0] = Preset 
                        ch_k "Oh, ok. . ." 
                elif ApprovalCheck("Kitty", 800, "I") or ApprovalCheck("Kitty", 1500):
            ...
            if Options[0] == "masturbation":
                        ...
                        call Seen_First_Peen("Kitty",ActiveGirl,React=1)
...
#            elif Options[0] == "vibrator":    
                        ...
                        $ Line = "Kitty seems content to just watch the two of you"
                        $ Action = "watch"
                        $ TempLust += 1 if GirlLikeCheck("Kitty",ActiveGirl) >= 600 else 0  # Kitty's lust
                        $ TempLust += 2 if GirlLikeCheck("Kitty",ActiveGirl) >= 800 else 1  # Kitty's lust
                        $ TempLust2 += 1 if ApprovalCheck(ActiveGirl, 500, "I") else 0
            ...
            if Mode == "lesbian":
                ...
                #Sets Kitty's action and Lust if this is a starting action
                $ Trigger4 = Action
                $ K_Lust += TempLust2
            else:
