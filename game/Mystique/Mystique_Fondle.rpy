...
label Mystique_Massage:
    ...
    $ Approval = Mod_ApprovalCheck("Mystique", 500, TabM = 2) # 95, 110, 125 -120(215)
    ...
    if Approval >= 2:             
        ...
        menu:
            ...
            "Maybe later?" if "no massage" not in newgirl["Mystique"].DailyActions:
                ...
                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 20, 1)  
...
label Mystique_Fondle_Breasts:
    ...
    $ Approval = Mod_ApprovalCheck("Mystique", 950, TabM = 3) # 95, 110, 125 -120(215)
    ...
    if Approval >= 2:             
        ...
        menu:
            ...
            "[[Grab her chest anyway]":                                               # Pressured into fondling. 
                $ Approval = Mod_ApprovalCheck("Mystique", 350, "OI", TabM = 3) # 35, 50, 65
...
label Mystique_FB_Prep: #Animation set-up 
    ...
    $ Cnt = 0     
    if Taboo:
        call Mod_DrainWord("Mystique","tabno")
    call Mod_DrainWord("Mystique","no fondle breasts")
...
label Mystique_FB_Cycle: #Repeating strokes
    while Round >=0:  
        ...
        if newgirl["Mystique"].SEXP >= 100 or Mod_ApprovalCheck("Mystique", 1200, "LO"):
            pass
                    ...
                    pass  
        elif Cnt == (15 + newgirl["Mystique"].FondleB) and newgirl["Mystique"].SEXP >= 15 and not Mod_ApprovalCheck("Mystique", 1500):
                    $ newgirl["Mystique"].Brows = "confused" 
                    menu:
                        ...
                        "Let's try something else." if MultiAction: 
                                ...
                                jump Mystique_FB_After
                        "No, this is fun.":   
                                if Mod_ApprovalCheck("Mystique", 1200) or Mod_ApprovalCheck("Mystique", 500, "O"):                        
                                    ...
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 50, -3, 1)
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 80, -4, 1)
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 30, -1, 1)                    
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, -1, 1)  
                                    $ newgirl["Mystique"].RecentActions.append("angry")
                                    $ newgirl["Mystique"].DailyActions.append("angry")   
                                    jump Mystique_FB_After
        #End Count check
        ...
        call Mod_Sex_Dialog("Mystique",Partner)
...
label Mystique_Suck_Breasts:
    ...
    $ Approval = Mod_ApprovalCheck("Mystique", 1050, TabM = 4) # 105, 120, 135, Taboo -160(265)
    ...
    if Approval >= 2:                                                                   #She's into it. . .
        ...
        menu:
            ...
            "[[Start sucking anyway]":                                               # Pressured into licking. 
                $ Approval = Mod_ApprovalCheck("Mystique", 450, "OI", TabM = 3) # 45, 60, 75, -120(165)
                if Approval > 1 or (Approval and newgirl["Mystique"].Forced):
                    call MystiqueFace("sad")
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -5, 1)
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 20, -2, 1)                 
...
label Mystique_SB_Prep:                                                                 #Animation set-up 
    ...
    if not newgirl["Mystique"].SuckB:        
        if newgirl["Mystique"].Forced:
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -25)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 25)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 17) 
        else:
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 10)
    ...
    if Taboo:
        call Mod_DrainWord("Mystique","tabno")
    call Mod_DrainWord("Mystique","no suck breasts")
    ...
    while Round >=0:  
        ...
        if newgirl["Mystique"].SEXP >= 100 or Mod_ApprovalCheck("Mystique", 1200, "LO"):
            pass
                    ...
                    pass
        elif Cnt == (15 + newgirl["Mystique"].SuckB) and newgirl["Mystique"].SEXP >= 15 and not Mod_ApprovalCheck("Mystique", 1500):
                    $ newgirl["Mystique"].Brows = "confused"        
                    menu:
...
label Mystique_Fondle_Thighs:
    ...
    $ Approval = Mod_ApprovalCheck("Mystique", 750, TabM=1) # 75, 90, 105, Taboo -40(105)
    ...
    if Situation == "pullback":     
        ...
        if newgirl["Mystique"].Lust > 60:
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -3)
        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 90, 1)
        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 2)
    ...
    if Approval >= 2:                                                                   #She's into it. . .
        ...
        menu:
            ...
            "[[Start caressing her thigh anyway]":                                               # Pressured into fondling. 
                $ Approval = Mod_ApprovalCheck("Mystique", 350, "OI", TabM = 2) # 35, 50, 65, -80(105)
                if Approval > 1 or (Approval and newgirl["Mystique"].Forced):
                    call MystiqueFace("sad")
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -5, 1)
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 20, -2, 1)                 
                    ...
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -8)  
                    call MystiqueFace("angry", 1)
                    "She slaps your hand away."   
                    $ newgirl["Mystique"].RecentActions.append("angry")
                    $ newgirl["Mystique"].DailyActions.append("angry")   
...
label Mystique_FT_Prep:                                                                 #Animation set-up 
    ...
    if Taboo:               
        $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 200, (int(Taboo/5)))                               
        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 200, (2*(int(Taboo/5))))
    ...
    if Taboo:
        call Mod_DrainWord("Mystique","tabno")
    call Mod_DrainWord("Mystique","no fondle thighs")
    ...
    while Round >=0:  
        ...
        if newgirl["Mystique"].SEXP >= 100 or Mod_ApprovalCheck("Mystique", 1200, "LO"):
            pass
                    ...
                    $ newgirl["Mystique"].Brows = "confused"
                    ch_m "Luxurious, yes?"   
        elif Cnt == (15 + newgirl["Mystique"].FondleT) and newgirl["Mystique"].SEXP >= 15 and not Mod_ApprovalCheck("Mystique", 1500):
                    $ newgirl["Mystique"].Brows = "confused"        
                    menu:
                        ch_m "You certainly seem to be enjoying yourself, but perhaps we could add some variety?"                         
                        "Finish up.":
...
label Mystique_Fondle_Pussy:
    ...
    $ Approval = Mod_ApprovalCheck("Mystique", 1050, TabM = 2) # 105, 120, 135, Taboo -80(185)
    ...
    if Approval >= 2:                                                                   #She's into it. . .
        ...
        menu:
            ...
            "[[Start fondling anyway]":                                               # Pressured into fondling. 
                $ Approval = Mod_ApprovalCheck("Mystique", 450, "OI", TabM = 2) # 45, 60, 75, -80(125)
                if Approval > 1 or (Approval and newgirl["Mystique"].Forced):
                    call MystiqueFace("sad")
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -5, 1)
...
label Mystique_FP_Prep: #Animation set-up 
    ...
    if not newgirl["Mystique"].FondleP:        
        if newgirl["Mystique"].Forced:
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -50)
    ...
    if Taboo:
        call Mod_DrainWord("Mystique","tabno")
    call Mod_DrainWord("Mystique","no fondle pussy")
    ...
    while Round >=0:  
        ...
        if newgirl["Mystique"].SEXP >= 100 or Mod_ApprovalCheck("Mystique", 1200, "LO"):
            pass
                    ...
                    pass
        elif Cnt == (15 + newgirl["Mystique"].FondleP) and newgirl["Mystique"].SEXP >= 15 and not Mod_ApprovalCheck("Mystique", 1500):
                    $ newgirl["Mystique"].Brows = "confused"        
                    menu:
                        ch_m "You certainly seem to be enjoying yourself, but perhaps we could add some variety?"                         
                        "Finish up.":
...
label Mystique_Insert_Pussy:
    call Shift_Focus("Mystique")
    if Situation == "auto":                                                                  #You auto-start                    
        if Mod_ApprovalCheck("Mystique", 1100, TabM = 2):
            call MystiqueFace("surprised")
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 90, 1)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 2)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 3) 
    ...
    if Mod_ApprovalCheck("Mystique", 1100, TabM = 2):                                                                   #She's into it. . .               
        if newgirl["Mystique"].Forced:
            call MystiqueFace("sad")
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -3, 1)
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 20, -2, 1)
...
label Mystique_IP_Prep: #Animation set-up     
    if not newgirl["Mystique"].InsertP:
        ...
        if newgirl["Mystique"].Forced:
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -60)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 55)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 35) 
        else:
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 10)
...
label Mystique_Lick_Pussy: 
    ...
    $ Approval = Mod_ApprovalCheck("Mystique", 1250, TabM = 4) # 125, 140, 155, Taboo -160(285)
    ...
    if Approval >= 2:                                                                   #She's into it. . .               
        if newgirl["Mystique"].Forced:
            ...
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 1)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 3)            
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 200, 3)
            ch_m "Mmmmmm. . ."                
        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 20, 1)
        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 1)
        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 2) 
        ...
        menu:
            ...
            "[[Get in there anyway]":                                               # Pressured into being licked. 
                $ Approval = Mod_ApprovalCheck("Mystique", 750, "OI", TabM = 4) # 75, 90, 105, -160(235)
                if Approval > 1 or (Approval and newgirl["Mystique"].Forced):
                    call MystiqueFace("sad")
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -5, 1)
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -2)                 
...
label Mystique_LP_Prep: #Animation set-up  
    ...
    if not newgirl["Mystique"].LickP:        
        if newgirl["Mystique"].Forced:
            ...
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 35)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 75) 
        else:
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 35)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 15)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 35)
    if Taboo:
        $ newgirl["Mystique"].Inbt += int(Taboo/10)  
    ...
    if Taboo:
        call Mod_DrainWord("Mystique","tabno")
    call Mod_DrainWord("Mystique","no lick pussy")
    ...
    while Round >=0:  
        ...
        if newgirl["Mystique"].SEXP >= 100 or Mod_ApprovalCheck("Mystique", 1200, "LO"):
            pass
                    ...
                    pass
        elif Cnt == (15 + newgirl["Mystique"].LickP) and newgirl["Mystique"].SEXP >= 15 and not Mod_ApprovalCheck("Mystique", 1500):
                    $ newgirl["Mystique"].Brows = "confused"        
                    menu:
...
label Mystique_Fondle_Ass: 
    ...
    $ Approval = Mod_ApprovalCheck("Mystique", 850, TabM=1) # 85, 100, 115, Taboo -40(125)
    ...
    if Approval >= 2:                                                                   #She's into it. . .        
        ...
        menu:
            ...
            "[[Start fondling anyway]":                                               # Pressured into fondling. 
                $ Approval = Mod_ApprovalCheck("Mystique", 250, "OI", TabM = 3) # 25, 40, 55, -120(145)
                if Approval > 1 or (Approval and newgirl["Mystique"].Forced):
                    call MystiqueFace("sad")
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -3, 1)
...
label Mystique_FA_Prep: #Animation set-up  
    ...
    if not newgirl["Mystique"].FondleA:        
        if newgirl["Mystique"].Forced:
            ...
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 10)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 12)
    ...
    if Taboo:
        call Mod_DrainWord("Mystique","tabno")
    call Mod_DrainWord("Mystique","no fondle ass")
    ...
    while Round >=0:  
        ...
        if newgirl["Mystique"].SEXP >= 100 or Mod_ApprovalCheck("Mystique", 1200, "LO"):
            pass
                    ...
                    pass
        elif Cnt == (15 + newgirl["Mystique"].FondleA) and newgirl["Mystique"].SEXP >= 15 and not Mod_ApprovalCheck("Mystique", 1500):
                    $ newgirl["Mystique"].Brows = "confused"        
                    menu:
...
label Mystique_Insert_Ass:
    ...
    $ Approval = Mod_ApprovalCheck("Mystique", 1300, TabM = 3) # 130, 145, 160, Taboo -120(250)
    ...
    if Approval >= 2:                                                                   #She's into it. . .               
        ...
        menu:
            ...
            "[[Slide a finger in anyway]":                                               # Pressured into being fingered. 
                $ Approval = Mod_ApprovalCheck("Mystique", 950, "OI", TabM = 3) # 95, 110, 125, -120(215)
                if Approval > 1 or (Approval and newgirl["Mystique"].Forced):                    
                    call MystiqueFace("surprised", 1)
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -5, 1)
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -2)                 
    ...
    if "no insert ass" in newgirl["Mystique"].DailyActions:
        ...
        $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 80, 10) if newgirl["Mystique"].Inbt > 50 else Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 50, 3) 
        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, -2)      
        $ newgirl["Mystique"].RecentActions.append("angry")
        $ newgirl["Mystique"].DailyActions.append("angry")   
    elif Taboo:
...
label Mystique_IA_Prep: #Animation set-up 
    ...
    if not newgirl["Mystique"].InsertA:        
        if newgirl["Mystique"].Forced:
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -50)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 60)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 35) 
        else:
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 10)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 20)
    ...
    if Taboo:
        call Mod_DrainWord("Mystique","tabno")
    call Mod_DrainWord("Mystique","no insert ass")
    ...
    while Round >=0:  
        ...
        if newgirl["Mystique"].SEXP >= 100 or Mod_ApprovalCheck("Mystique", 1200, "LO"):
            pass
                    ...
                    pass
        elif Cnt == (15 + newgirl["Mystique"].InsertA) and newgirl["Mystique"].SEXP >= 15 and not Mod_ApprovalCheck("Mystique", 1500):
                    $ newgirl["Mystique"].Brows = "confused"        
                    menu:
...
label Mystique_Lick_Ass: 
    ...
    $ Approval = Mod_ApprovalCheck("Mystique", 1550, TabM = 4) # 155, 170, 185, Taboo -160(315)
    ...
    if Approval >= 2:                                                                   #She's into it. . .               
        ...
        menu:
            ...
            "[[Start licking anyway]":                                               # Pressured into being licked. 
                $ Approval = Mod_ApprovalCheck("Mystique", 1100, "OI", TabM = 4) # 110, 125, 140, -160(270)
                if Approval > 1 or (Approval and newgirl["Mystique"].Forced):
                    call MystiqueFace("sad")
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -5, 1)
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -2)                 
...
label Mystique_LA_Prep: #Animation set-up  
    ...
    if not newgirl["Mystique"].LickA:        
        if newgirl["Mystique"].Forced:
            ...
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 80) 
        else:
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 35)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 25)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 55)
    if Taboo:
        $ newgirl["Mystique"].Inbt += int(Taboo/10)  
        $ newgirl["Mystique"].Lust += int(Taboo/5)
    if Situation:     
    ...
    if Taboo:
        call Mod_DrainWord("Mystique","tabno")
    call Mod_DrainWord("Mystique","no lick ass")
    ...
    while Round >=0:  
        ...
        if newgirl["Mystique"].SEXP >= 100 or Mod_ApprovalCheck("Mystique", 1200, "LO"):
            pass
                    ...
                    pass
        elif Cnt == (15 + newgirl["Mystique"].LickA) and newgirl["Mystique"].SEXP >= 15 and not Mod_ApprovalCheck("Mystique", 1500):
                    $ newgirl["Mystique"].Brows = "confused"        
                    menu:
