...
label Mystique_SexDialog(TempLine = 0, TempLust = 0, TempLust2 = 0):
    ...
    # end R dildo ass   
                ...
                call NewGirl_Self_Lines("Mystique")
...
#                $ TempLust = 0
    ...
    # end E Masturbation                               /////////////////////////////////////////////////////////////////////////////
                ...
                call Mystique_SexDialog_Threeway("lesbian")
...
label Mystique_Self_Set(Mode = "T3", Action = Trigger3, Length=0, Count2=0, Options =[]): 
    ...
    if Mode == "T3" and Trigger != "masturbation":
            ...
            if Taboo and newgirl["Mystique"].SEXP >= 50 and Mod_ApprovalCheck("Mystique", 500, "I"):
                if newgirl["Mystique"].Lust <= 50:
                    return
            elif newgirl["Mystique"].SEXP >= 25 and Mod_ApprovalCheck("Mystique", 300, "I"):
...
label Mystique_SexDialog_Threeway(Mode = 0, Action = 0, ActiveGirl = Primary, TempLine = 0, TempLust = 0, TempLust2 = 0, TempFocus = 0):
    ...
    call NewGirl_Threeway_Set(Girl_ = "Mystique", Mode = Mode)
    ...
    # end newgirl["Mystique"].Blowjob Threeway                                //////////////////////////////////////////////////////////////////////////////
                        ...
                        if ActiveGirl == "Rogue": #If Mystique is fondling Rogue's breasts
                                $ TempLust += 2 if Mod_ApprovalCheck("Mystique", 500, "I") else 1  # Mystique's lust
    ...
    # end E fondle pussy Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        if ActiveGirl == "Rogue": #If Mystique is fondling Rogue's breasts
                                $ TempLust += 3 if Mod_ApprovalCheck("Mystique", 500, "I") else 1  # Mystique's lust
                                $ TempLust2 += 7 if R_LikeNewGirl["Mystique"] >= 800 else 4 
                        elif ActiveGirl == "Kitty": #If Mystique is stroking Kitty's pussy
                                $ TempLust += 3 if Mod_ApprovalCheck("Mystique", 600, "I") else 1  # Mystique's lust
    ...
    # end E lick pussy Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        if ActiveGirl == "Rogue": #If Mystique is fondling Rogue's breasts
                                $ TempLust += 1 if Mod_ApprovalCheck("Mystique", 500, "I") else 0  # Mystique's lust
    ...
    # end E fondle ass Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        if ActiveGirl == "Rogue": #If Mystique is fondling Rogue's breasts
                                ...
                                $ TempLust += 2 if Mod_ApprovalCheck("Mystique", 700, "I") else 1  # Mystique's lust
                                $ TempLust2 += 5 if K_LikeNewGirl["Mystique"] >= 800 else 3
                                if not K_Loose:
                                        $ TempLust2 -= 3
                        $ TempFocus += 1  
    ...
    # end E insert ass Threeway                             /////////////////////////////////////////////////////////////////////////////
                        ...
                        if ActiveGirl == "Rogue": #If Mystique is fondling Rogue's breasts
                                ...
                                $ TempLust += 3 if Mod_ApprovalCheck("Mystique", 800, "I") else 1  # Mystique's lust
                                $ TempLust2 += 5 if K_LikeNewGirl["Mystique"] >= 800 else 2
    ...
    # end E Kissing Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        if ActiveGirl == "Rogue": #If Mystique is fondling Rogue's breasts
                                ...
                                $ TempLust2 += 1 if Mod_ApprovalCheck("Rogue", 500, "I") else 0
                                $ TempLust2 += 1 if Mod_ApprovalCheck("Rogue", 700, "I") else 0
                                ...
                                $ TempLust2 += 1 if Mod_ApprovalCheck("Kitty", 500, "I") else 0
                                $ TempLust2 += 1 if Mod_ApprovalCheck("Kitty", 700, "I") else 0
                        $ TempFocus += 1  
