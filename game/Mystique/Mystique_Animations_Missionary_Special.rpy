...
image Mystique_SexSprite:
    ConditionSwitch(          
    "newgirl['Mystique'].LooksLike == 'Raven'", "Mystique_Mystique_SexSprite",
    "newgirl['Mystique'].LooksLike", "Mystique_" + str(newgirl['Mystique'].LooksLike) + "_SexSprite",
    ...
    "True", "Mystique_Mystique_SexSprite",
    ),
...
image Mystique_Emma_Sex_Body = LiveComposite(                                                                                
        ...
        (0,0), ConditionSwitch(                                                                                 #Wet look
            "newgirl['Mystique'].Water", "images/EmmaSexMissionary/Emma_Sex_Water_Body.png",   
            "True", Null(),              
            ), 
        (0,0),ConditionSwitch(                                                                                  #Outside Spunk
            "'belly' in newgirl['Mystique'].Spunk", "images/EmmaSexMissionary/Emma_Sex_Spunk_Body.png",   
            "True", Null(),  
            ),  
        )
...
image Mystique_Emma_Sex_Legs:
    LiveComposite(  
        ...
        (1120,840), 
        (0,0), ConditionSwitch(
            "newgirl['Mystique'].LegsUp", "images/EmmaSexMissionary/Emma_Sex_Legs_LegsUp.png",
            "True", "images/EmmaSexMissionary/Emma_Sex_Legs.png",
            ),                                                     #Legs Base
        (0,0), ConditionSwitch(                                                                                 #Wet look
            "newgirl['Mystique'].LegsUp", Null(),
            "newgirl['Mystique'].Water", "images/EmmaSexMissionary/Emma_Sex_Water_Legs.png",   
            "True", Null(),              
            ),  
        ...
        (0,0),ConditionSwitch(                                                                                  #Outside Spunk
            "'belly' in newgirl['Mystique'].Spunk", "images/EmmaSexMissionary/Emma_Sex_Spunk_Pelvis.png",   
            "True", Null(),  
            ),  
        ...
        (0,0), ConditionSwitch(                                                         #Shows different lower body motion depending on events
            ...
            "P_Cock == 'anal' or P_Cock == 'in' or P_Cock == 'out'", AlphaMask("Mystique_Emma_Sex_Feet", "images/EmmaSexMissionary/Emma_Sex_FeetMask.png"), 
...
image Mystique_Emma_Sex_Feet = LiveComposite(                                                                                          
        ...
        (1120,840), 
        (0,0), ConditionSwitch(
            "newgirl['Mystique'].LegsUp", "images/EmmaSexMissionary/Emma_Sex_Feet_LegsUp.png",
            "True", "images/EmmaSexMissionary/Emma_Sex_Feet.png",
            ),
        (0,0), ConditionSwitch(                                                                                 #Wet look
            "newgirl['Mystique'].Water", "images/EmmaSexMissionary/Emma_Sex_Water_Feet.png",   
            "True", Null(),              
            ),  
        )
...
image Mystique_Emma_Sex_Anus:
    contains:
            ...
            "newgirl['Mystique'].Loose", "images/EmmaSexMissionary/Emma_Sex_Hole_Loose.png",   
...
image Mystique_Emma_Sex_Pussy:
    ...
    contains:
            #Spunk under penis
            ConditionSwitch(    
                "'in' in newgirl['Mystique'].Spunk", "images/EmmaSexMissionary/Emma_Sex_Spunk_Puss_Under.png",   
                "True", Null(),  
                )  
    contains:
...
image Mystique_Common_Sex_Body_Static:
    contains:
            ConditionSwitch(          
            #"newgirl['Mystique'].LooksLike == 'Mystique'", "Mystique_Mystique_SexSprite",
            "newgirl['Mystique'].LooksLike", "Mystique_" + str(newgirl['Mystique'].LooksLike) + "_Sex_Body",
...
image Mystique_Common_Sex_Legs_Static:
    contains:
            ConditionSwitch(          
            #"newgirl['Mystique'].LooksLike == 'Mystique'", "Mystique_Mystique_SexSprite",
            "newgirl['Mystique'].LooksLike", "Mystique_" + str(newgirl['Mystique'].LooksLike) + "_Sex_Legs",
