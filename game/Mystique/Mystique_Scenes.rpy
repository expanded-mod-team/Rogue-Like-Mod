...
label MystiqueMeet:
    ...
    "You enter your room and lay down on the bed."
    call CleartheRoom("Mystique",0,1)
    $ newgirl["Mystique"].LooksLike = "Mystique"
    $ newgirl["Mystique"].Loc = "bg player"
    $ newgirl["Mystique"].Love = 400
    $ newgirl["Mystique"].Obed = 400
    $ newgirl["Mystique"].Inbt = 400
    # call Shift_Focus("Mystique")
    "After some time you notice something moving on the corner of the room." 
    # call Mod_Set_The_Scene
    $ Mystique_SpriteLoc = StageRight
    show Mystique_Sprite at SpriteLoc(Mystique_SpriteLoc) with easeinleft
    #call LastNamer   
    $ newgirl["Mystique"].GirlName = "????"
    ...
    "The blue woman quickly jumps towards you and shuts your mouth with her hands."
    with Shake((0, 0, 0, 0), 0.5, dist=5)
    "As soon as her skin touch yours something happens."
    show Mystique_Blue_Naked at SpriteLoc(Mystique_SpriteLoc) with fur
    ...
    hide Mystique_Blue_Naked with fur

    ch_m "No screaming, please."
    call NewGirl_Face("Mystique","surprised")
    "She looks down at her own naked body"
    ch_m "Looks like everything I heard about your powers is true"
    call NewGirl_Face("Mystique","normal")
    ch_m "So, can we agree with no screaming, [newgirl[Mystique].Petname]?"
    menu:
        "Yes":
            ch_m "Good."
        ". . .":
            ch_m "I'll take that as a yes."
    "She removes her hand from your mouth."
    show Mystique_Blue_Naked at SpriteLoc(Mystique_SpriteLoc)
    hide Mystique_Sprite
    $ newgirl["Mystique"].Legs = "black skirt"
    $ newgirl["Mystique"].Chest = "top"
    $ newgirl["Mystique"].Panties = "black panties"        
    $ newgirl["Mystique"].Hose = "stockings"
    show Mystique_Sprite at SpriteLoc(Mystique_SpriteLoc) with fur
    hide Mystique_Blue_Naked

    menu:
        "Wait, I know you":
            ch_p "Shapeshifting powers and blue skin, you're Mystique!"
            call NewGirl_Face("Mystique","smile")
            ch_m "Ohh, I'm flattered you know who I am."
        "I prefer you the other way":
            ch_p "I might still scream, better put your hand back at my mouth"
            call NewGirl_Face("Mystique","sly")
            ch_m "Men..."
            ch_m "I'm Mystique, you've probably already heard about me."
    $ newgirl["Mystique"].GirlName = "Mystique"

    ch_m "You have some amazing powers, [newgirl[Mystique].Petname]."
    call NewGirl_Face("Mystique","sexy")
    ch_m "Here, this is the address of my place, why don't you come visit me some time and maybe I'll touch you again."
    call NewGirl_Face("Mystique","bemused")
    ch_m "And please, keep this conversation just between us."
    call NewGirl_Face("Mystique","smile")
    "She handles you a piece of paper with an address on it and jumps out of your room through the open window."
    hide Mystique_Sprite with dissolve
...
label MystiqueMeetOld:    
    ...
    menu:
        extend ""
        "Yes?":
                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, 10) 
                call NewGirl_Face("Mystique","normal")
        ...
        "For such a hot teacher? Sure i've got some time.":
                ...
                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, 20) 
                $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 50, 5) 
                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 25, 15)  
    ...
    if P_Rep <= 200:
        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 10)
        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 90, 15) 
        $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 50, 5) 
    ...
    if R_SEXP >= 60 and K_SEXP >= 60:
        ...
        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, 5) 
        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 5)
        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 200, 5) 
        $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 50, 2) 
        call MystiqueFace("smile")
    ...
    if P_Lvl >= 7:
        ...
        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -5) 
        $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 10, -5, 1)  
    ...
    #             $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, 10) 
    #             $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 200, 10) 
    #             $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 50, 15) 
    ...
    menu:
        ...
        "If it means to be near you more often. . .":
                if Mod_ApprovalCheck("Mystique", 295, "L"):
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 200, 5) 
                    $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 50, 5) 
                    call MystiqueFace("sly")
        ...
        "What's in there for me?":
                if not Mod_ApprovalCheck("Mystique", 290, "L"):
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -5) 
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 5)
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 200, 5) 
                    call MystiqueFace("angry")
                    ...
                    if newgirl["Mystique"].Obed > 0:
                        ...
                        menu:
                            ...
                            "Spending more time with you would be plenty. . .":
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, 5) 
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 5)
                                    $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 20, 5) 
                                    call MystiqueFace("sly")
                            ...
                            "A kiss?":
                                    ...
                                    if Mod_ApprovalCheck("Mystique", 220, "I"):
                        ...
                        if Mod_ApprovalCheck("Mystique", 300, "L"):
                            call MystiqueFace("sly")
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 5)
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 200, 5) 
                            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 50, 5) 
...
#             $ renpy.pop_call()        
#             $ renpy.pop_call()
#             if Mod_ApprovalCheck("Rogue", 700, "I"): 
...
#             $ renpy.pop_call()        
#             $ renpy.pop_call()
#             if Mod_ApprovalCheck("Kitty", 700, "I"): 
...
label Mystique_Sleepover(sleepover = 0):  #Mystique_Update   
            ...
            if (newgirl["Mystique"].Sleep >= 3 and Mod_ApprovalCheck("Mystique", 800)) or Mod_ApprovalCheck("Mystique", 1100, "LI"):                                 
                    ...
                    $ sleepover = 1                    
            elif newgirl["Mystique"].Sleep < 3 or not Mod_ApprovalCheck("Mystique", 600):                            
            ...
            menu:
                ...
                "Sure." if sleepover:
                        if newgirl["Mystique"].Sleep <= 5:
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, 5) if newgirl["Mystique"].Love >= 500 else newgirl["Mystique"].Love
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 5)
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 25)
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 25, 25) 
                ...
                "No, sorry." if sleepover:                  
                        ...
                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 30, 6)
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 40, 4)
                ...
                "Ok, I'll head out. Good night." if not sleepover and bg_current == "bg Mystique":                        
                        ...
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 25, 2)            
                        call MystiqueFace("smile")
                        ch_m "Ok, good night. . ."
                ...
                "Are you sure I can't stay the night? . ." if not sleepover and not newgirl["Mystique"].Sleep and bg_current == "bg Mystique": 
                        if Mod_ApprovalCheck("Mystique", 1000) or Mod_ApprovalCheck("Mystique", 700, "L") or Mod_ApprovalCheck("Mystique", 500, "O"):
                ...
                "That was not a problem for you the other night . ." if not sleepover and newgirl["Mystique"].Sleep: #if she wants you gone  
                        if Mod_ApprovalCheck("Mystique", 900)or Mod_ApprovalCheck("Mystique", 700, "L") or Mod_ApprovalCheck("Mystique", 500, "O"):
                            call MystiqueFace("bemused", 1)
            ...
            if sleepover: #If she agreed
                    ...
                    if K_Loc == bg_current:
                        if K_LikeNewGirl["Mystique"] >= 800:                                
                                ...
                                call CleartheRoom("Mystique",1)
                    if newgirl["Mystique"].SEXP < 10 and not Mod_ApprovalCheck("Mystique", 600, "I") and not Mod_ApprovalCheck("Mystique", 600, "O"):
...
label Mystique_Morning:
            ...
            if "hungry" in newgirl["Mystique"].Traits and D20 > 50:
                    ...
                    $ Cnt = 0         
            elif newgirl["Mystique"].Blow >= 5 or Mod_ApprovalCheck("Mystique", 900, "I"):
                    $ Cnt = 1
            elif newgirl["Mystique"].Blow and Mod_ApprovalCheck("Mystique", 900):
                    $ Cnt = 1
            elif Mod_ApprovalCheck("Mystique", 1400): # Trinity < 1400
                    $ Cnt = 1
            else:
                    $ Cnt = 0 
            ...
            menu:
                ...
                "It's always nice sleeping with you." if newgirl["Mystique"].Sleep: 
                        if newgirl["Mystique"].Sleep < 5:
                            ...
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 8)    
                ...
                "I loved sleeping next to you." if not newgirl["Mystique"].Sleep:
                        ...
                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, 10)
                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 12)
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 12)  
                ...
                "It was fun.":
                        if not newgirl["Mystique"].Sleep:                    
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 10)            
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, 8)
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 15)
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 15) 
                        elif newgirl["Mystique"].Sleep < 5:
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, 8)
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 10)
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 35, 8)             
                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 8)
                ...
                "You were constantly tossing around.":            
                        $ newgirl["Mystique"].Blush = 1
                        if Mod_ApprovalCheck("Mystique", 800, "L"):
                            call MystiqueFace("bemused")
                        else:
                            call MystiqueFace("angry")
                        if newgirl["Mystique"].Sleep < 5:
                            ...
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 60, -8)
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 22)
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 22)  
                        else:
                            ch_m "Yeah, well. . . you should be used to that!"
                "You need to learn to stick to your side.":  
                        if newgirl["Mystique"].Sleep < 5:
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 80, -8) 
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 40)  
                        if Mod_ApprovalCheck("Mystique", 500, "O"):
                            call MystiqueFace("normal")
                            ch_m "Fine, whatever."
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 8) if newgirl["Mystique"].Sleep < 5 else newgirl["Mystique"].Obed
                        else:
                            call MystiqueFace("angry")
                            ch_m "That's not how you get me to come back." 
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 35, 20) if newgirl["Mystique"].Sleep < 5 else newgirl["Mystique"].Inbt  
...
label Mystique_MorningWood: #Mystique_Update   
            ...
            $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 80, 5)
            ...
            ch_u "\"Slurp, slurp, slurp.\""
            $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 80, 10)
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 80, 5)
            $ Trigger = "blow"
            ...
            menu:
                ...
                "So, um, you want to go on?":
                        if Line != "no":
                            call MystiqueFace("smile")
                            ch_m "Hehe, mmmm. . ."
                        elif Line == "no" and Mod_ApprovalCheck("Mystique", 1750):
                            call MystiqueFace("bemused")
                ...
                "Were you more interested in something else?":
                        if Line != "no":
                            ...
                            $ Line = "sex"
                        elif Line == "no" and Mod_ApprovalCheck("Mystique", 1650):
                            call MystiqueFace("bemused")
                ...
                "Sorry, but we could do something else." if Line == "no":
                        if Mod_ApprovalCheck("Mystique", 1350):
                            call MystiqueFace("sexy")
                            ch_m "I guess, maybe. . ."
                            ch_m "Like what?"
                            $ Line = "sex"
...
label Mystique_Caught_Classroom:  
            ...
            $ newgirl["Mystique"].RecentActions.append("unseen")    
            $ Line = 0
            call Mod_DrainWord("Mystique","no masturbation")
            ...
            if "classcaught" in newgirl["Mystique"].History: 
                    ...
                    menu:
                        ...
                        "Are you supposed to be rubbing it in class?":
                                call MystiqueFace("angry", Eyes="side")
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 5)
                                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 5) 
                                ch_m "Hrm."
                                call MystiqueFace("sly", Brows="angry")
                                $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 80, 3)
                        ...
                        "I think it was really hot.":
                                ...
                                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, 5)
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 10)
                                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 10) 
                                $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 80, 5)
                    ...
                    menu:
                        ...
                        "What do you you have in mind?":
                                call MystiqueFace("sly")
                                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, 5)
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 15)
                                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 15) 
                                $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 80, 5)
...
label Mystique_Detention:  
            ...
            menu:
                ...
                "I guess I should focus on my studies.":  
                        if Mod_ApprovalCheck("Mystique", 900) and "classcaught" in newgirl["Mystique"].History:
                                call MystiqueFace("perplexed")
                                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, -3) 
                                $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 80, 5)
                                ...
                                menu:
                                    ...
                                    "No, you're right, I take my education too lightly.":
                                        ...
                                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 80, 5) 
                                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 5)
                                        $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 80, 5)
                                        ch_m "Yes. . . Exactly. . ."
    ...
    menu:
        ...
        "Sorry sir, won't do it again.":
            if newgirl["Mystique"].Caught < 5:
                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, 10)
                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 30, -25)            
        ...
        "Just having a little fun, right [newgirl[Mystique].Pet]?":
            ...
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 90, 10)   
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 10) 
            ...
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 90, 20)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 30, -20)   
            ch_x "I've had enough of you, begone."
            
        "Just this. . . Mystique, plan Mu" if "Xavier's photo" in P_Inventory and P_Lvl >= 5:
            if Mod_ApprovalCheck("Mystique", 1500, TabM=1, Loc="No"):                   
                    jump Plan_Mu
            elif Mod_ApprovalCheck("Mystique", 1000, TabM=1, Loc="No"):
                    call MystiqueFace("perplexed")
                    $ newgirl["Mystique"].Brows = "sad"
            ...
            if PunishmentX:
                ...
                ch_x "I'm halving your daily stipend for [Count] days."                
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 10)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 90, 10)
        ...
        "You can suck it, old man.":
            call MystiqueFace("surprised")
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 90, 10)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 25)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 90, 40)  
            call XavierFace("angry")
            $ Count += 20
            ch_x "If that's your attitude, harsher methods might be necessary."
            if PunishmentX:
...
label Plan_Mu: #Mystique_Update   
    ...
    if "Kappa" in P_Traits:
            ...
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 40)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 30)
...
label Mystique_BF_Jerk:
    ...
    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 40)
    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 200, Count)
    ...
    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -Count)
    ...
    if "lover" not in newgirl["Mystique"].Petnames: 
            menu:
                ...
                "Catch her":
                    call MystiqueFace("perplexed", 2)
                    $ newgirl["Mystique"].Eyes = "surprised"
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 95, 10) 
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 95, 15) 
            ...
            menu:
                ...
                "Pull her close":
                    ...
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 95, 20) 
                    "You draw her into an embrace, arms wrapped tightly around her waist."
                    $ Line = "hug"
                "Stay like this":
                    $ newgirl["Mystique"].Eyes = "down"
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 95, 10) 
                ...
                "Let her go":
                    if 1 < newgirl["Mystique"].Event[6] < 4:
                        ...
                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 95, 10) 
                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 95, 20)
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 20)  
    ...
    if "lover" not in newgirl["Mystique"].Petnames:        
            ...
            menu:
                ...
                "I'd always catch you.":
                    call MystiqueFace("smile")
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 95, 20) 
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 15)
        ...
        menu:
            ...
            "You love me?":
                ...
                menu:
                    ...
                    "Yeah, of course I do!":
                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, 30)
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 200, 60)  
                        call MystiqueFace("smile")
                    "I mean, a little?": 
                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 20)
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, -10)  
                        ch_m "That's not a \"yes.\" . ."
                        $ Line = "awkward"
                    "Not really.":
                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -30) 
                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 30)
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, -30)  
            ...
            "Well that's awkward.":
                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -30) 
                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 40)
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, -20)  
                        call MystiqueFace("perplexed", 2)
                        $ Line = "awkward"
    else:
            ...
            "I think you're pretty great.":
                ...
                menu:
                    ...
                    "Yeah, of course I do!":
                        ...
                        call MystiqueFace("smile")
                    "I mean, a little?":
                        if Mod_ApprovalCheck("Mystique", 1200, "OI"):
                            call MystiqueFace("sad")
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -30) 
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 90, 20)
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 10)  
                    ...
                    "Not really.":     
                        call MystiqueFace("sad")
                        if Mod_ApprovalCheck("Mystique", 1500, "OI"):
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -30) 
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 30)
                            ch_m "Ouch. . ."
                        else:
                            $ Line = "awkward"
            "I was thinking something more casual. . .":
                        call MystiqueFace("sad")
                        if Mod_ApprovalCheck("Mystique", 1200, "OI") or Mod_ApprovalCheck("Mystique", 700, "I"):
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -30) 
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 90, 20)
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 90, 30)  
                            ch_m "Close enough."
                        else:  
                            $ Line = "awkward"
                            
    if Line == "awkward":   
        if Mod_ApprovalCheck("Mystique", 700, "O"):   
            ch_m "Fine, this doesn't have to be love."
        elif Mod_ApprovalCheck("Mystique", 700, "I"):
            ch_m "Fine, just sex it is."            
        elif Mod_ApprovalCheck("Mystique", 1200, "OI"):
            ch_m "Fine, I can work with that."
        else:
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -50) 
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 95, 50)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, -50)  
    ...
    if not newgirl["Mystique"].Sex:
        ...
        menu:
            ...
            "Yeah, let's do this. . . [[have sex]":      
                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "E_Inbt", newgirl["Mystique"].Inbt, 30, 30) 
                ch_m "Hmm. . ."  
...
label Mystique_Love_Redux:
    ...
    if newgirl["Mystique"].Event[6] >= 25:
            ...
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 95, 10) 
            if Mod_ApprovalCheck("Mystique", 950, "L"):
                $ Line = "love"
            else:
                call MystiqueFace("sad")
...
label Mystique_Sub:     #Mystique_Update   
    ...
    menu:    
        ...
        "Sorry. I didn't mean to come off like that.":
                ...
                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 80, 5)
                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 200, -5)
                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, -5)
                ch_m "No!  Don't get the wrong idea!  I just. . ." 
        "Yup. Deal with it.": 
                if Mod_ApprovalCheck("Mystique", 1000, "LO"):
                        ...
                        menu:        
                            ...
                            "Sorry.  I kind of thought you were getting into me being like that.": 
                                    ...
                                    $ newgirl["Mystique"].Eyes = "side"
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 95, 5)
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 200, 5)
                                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 5)
                                    ". . ."
    ...
    if not Line:
            ...
            menu:
                ...
                "Good. If you wanna be with me, that's how it'll be.":
                        if Mod_ApprovalCheck("Mystique", 1000, "LO"):
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 200, 15)
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 10)
                            ch_m "I guess I walked into that one. . ."                        
                        else:
                            call MystiqueFace("sadside", 1)
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -5)
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 200, 10)                      
                            ...
                            menu:      
                                ...
                                "I think I could maybe do that." : 
                                        ...
                                        $ newgirl["Mystique"].Eyes = "side"
                                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 95, 5)
                                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 200, 3)
                                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 5)
                ...
                "You sure you don't want me to back off a little?":  
                        ...
                        menu:
                            ...
                            "Well. . .yeah.  I {i}do{/i} think it's weird.  Sorry.":                                
                                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -15)
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 200, -5)
                                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, -10)
                                $ Line = "embarrassed"
...
label Mystique_Sub_Asked: #Mystique_Update   
    ...
    menu:
        ...
        "Well, I wanted to say I was sorry.  And I was hoping maybe we could give it another shot.":
                if "sir" in newgirl["Mystique"].Petnames and Mod_ApprovalCheck("Mystique", 850, "O"): 
                        #if this is asking about the "master" name, and her Obedience is higher than 700
                        pass
                elif Mod_ApprovalCheck("Mystique", 550, "O"): 
        ...
        "Listen. . .I know it's what you want.  Do you want to try again, or not?":
                ...
                if "sir" in newgirl["Mystique"].Petnames and Mod_ApprovalCheck("Mystique", 850, "O"): 
                        ch_m "Ok, fine."
                elif Mod_ApprovalCheck("Mystique", 600, "O"): 
                        ch_m "Um, ok."
                else: 
                        #if it's instead about earning the "sir" title, and her approval is over 500
                        call MystiqueFace("sadside", 1)
                        ...
                        menu:
                            ...
                            "Not gonna happen.":
                                    if "sir" in newgirl["Mystique"].Petnames and Mod_ApprovalCheck("Mystique", 900, "O"): 
                                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -5)
                                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 200, 10)
                                            ch_m ". . ."
                                    elif Mod_ApprovalCheck("Mystique",650, "O"):  
                                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -5)
                                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 200, 10)
                                            ch_m "I, um. . ."    
                                    else: #if it failed both those things,     
...
label Mystique_Master:  #Mystique_Update   
    ...
    menu:
        ...
        "As if I care what you think, slut.":
                ...
                menu:
                    ...
                    "Sorry. I just don't care what you want.":
                            if Mod_ApprovalCheck("Mystique", 1400, "LO"): 
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 200, 10)
                                    ch_m "That's so. . ." 
                                    call MystiqueFace("sly", 1)
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, 20)
        ...
        "Not me.  It's kind of creepy.":
                    ...
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -10)
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 200, -20)
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, -25)
...
label Mystique_Sexfriend:   #Mystique_Update   
    ...
    if not Line: #all this gets skipped if the "rude" response was procced above
            if Mod_ApprovalCheck("Mystique", 850, "L"):                  
                    ...
                    menu:
                        ...
                        "I was kinda hoping.":
                            call MystiqueFace("sexy", 1)
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 80, 10) 
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 5)    
            ...
            elif Mod_ApprovalCheck("Mystique", 1000, "LI"): 
                    call MystiqueFace("sexy", 1)
    ...
    if not Line:            
            ...
            menu:
                ...
                "You mean. . . like, being {i}friends with benefits{/i}?":
                        ...
                        menu:
                            ...
                            "That may be the sluttiest thing I've ever heard in my life.":
                                    ...
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -30) 
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 10)
                                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, -40)  
                ...
                "Uhm, to be honest, I'd rather not.":
                        call MystiqueFace("sadside",2)
                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 15)
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, -15)  
...
label Mystique_Daddy:       #Mystique_Update   
    ...
    menu:
        ...
        "Ok, go right ahead?":            
            call MystiqueFace("smile")
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 20)          
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 10)            
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 30) 
            ch_m "Squee!"            
        "What do you mean by that?": 
            ...
            menu:
                ...
                "Sounds interesting, fine by me.":     
                    call MystiqueFace("smile")
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 15)          
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 20)            
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 25) 
                    ch_m "Great! . . daddy."  
                ...
                "No, that creeps me out.":    
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -10)          
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 45)            
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 5)  
                    call MystiqueFace("angry")
                    ch_m "Hrmph." 
        "No, that creeps me out.":
...
label Mystique_Cheated(Other = "Rogue", Resolution = 0, B = 0):  #Other is the other girl, Resolution is Resolution count, you want this over 2 at least. B is the bonus modifier
    ...
    if newgirl["Mystique"].Cheated:
        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -50) 
        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, -25)
        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, -50)   
    else:
        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -120) 
        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, -30)
        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, -20)  
    ...
    menu:
        ...
        "Uhm. . .sorry?":
                ...
                if Mod_ApprovalCheck("Mystique", 900, "LO"):
                    $ Resolution += 1
                else:
                    $ Line = "angry"
        ...
        "Could you chill out and tell me what you mean?":
                call MystiqueFace("sad",2)
                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -10) 
                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 40, 5, 1) 
                ...
                if Mod_ApprovalCheck("Mystique", 500, "O"):
                    $ Resolution += 1  
                elif Mod_ApprovalCheck("Mystique", 1200, "LO"):
                    $ Resolution -= 1    
                else:
                    $ Resolution -= 3
                    $ Line = "angry"
    ...
    if not Line:
            ...
            menu:
                ...
                "I'm sorry. . . ":
                        ...
                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 5) 
                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 5)  
                        if not Mod_ApprovalCheck("Mystique", 900, "L"):
                ...
                "Whatever.":
                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -10) 
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 5)   
                        if Mod_ApprovalCheck("Mystique", 900, "L") and not Mod_ApprovalCheck("Mystique", 500, "O"):
                                $ Resolution -= 2
                                $ Line = "angry"
                        else:
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 10) 
    ...
    if Line == "maybe":
            ...
            if Mod_ApprovalCheck("Mystique", 1250):
                    ...
                    if Mod_ApprovalCheck("Mystique", 1500) and Resolution >= 3:
                            call MystiqueFace("embarrassed")
