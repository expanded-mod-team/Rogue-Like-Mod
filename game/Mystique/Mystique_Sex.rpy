...
label Mystique_SexMenu: 
    ...
    call Mod_Set_The_Scene(Dress = 0)
...
#        anchor (0.5, 0.0)
    ...
    if "caught" in newgirl["Mystique"].RecentActions or "angry" in newgirl["Mystique"].RecentActions:  
        ...
        call MystiqueOutfit
        call Mod_DrainWord("Mystique","caught",1,0)
        return
...
label Mystique_Jackin(Cnt = 0, TempVar = 0):
    if "unseen" in newgirl["Mystique"].RecentActions:        
            ...
            if newgirl["Mystique"].SEXP < 10 and "classcaught" not in newgirl["Mystique"].History:
                    ...
                    $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 50, 7) 
                    ...
                    $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 60, 10)
            elif Mod_ApprovalCheck("Mystique", 1200, TabM = 3):
                    call MystiqueFace("surprised", 1)
                    $ newgirl["Mystique"].Eyes = "down"
                    "Mystique looks down at your cock and smiles."            
                    call MystiqueFace("sly", 0)
                    $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 70, 12)
            elif Mod_ApprovalCheck("Mystique", 500, "I", TabM=2):
                    call MystiqueFace("surprised", 1)
                    $ newgirl["Mystique"].Eyes = "down"
                    "Mystique glances at it, but just smiles in amusement."        
                    call MystiqueFace("sly", 0)
                    $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 70, 15)
            else:
                    call MystiqueFace("angry", 1)
                    $ newgirl["Mystique"].Eyes = "down"
            ...
            if newgirl["Mystique"].Action:
                ...
                if newgirl["Mystique"].Hand >= 5 and Mod_ApprovalCheck("Mystique", 1200, TabM = 3):
                        $ Cnt = newgirl["Mystique"].Hand - 4
                        $ Cnt = 10 if Cnt > 10 else Cnt
                        while Cnt:
                            $ Options.append("hand") 
                            $ Cnt -= 1
                if newgirl["Mystique"].Blow >= 5 and Mod_ApprovalCheck("Mystique", 1400, TabM = 3):
                        ...
                        while Cnt:
                            $ Options.append("blow") 
                            $ Cnt -= 1
                if newgirl["Mystique"].Tit >= 5 and Mod_ApprovalCheck("Mystique", 1300, TabM = 5):
                        $ Cnt = newgirl["Mystique"].Tit - 4
                        $ Cnt = 10 if Cnt > 10 else Cnt
                        while Cnt:
                            $ Options.append("Tit") 
                            $ Cnt -= 1
                if newgirl["Mystique"].Sex >= 5 and Mod_ApprovalCheck("Mystique", 1500, TabM = 5):
                        ...
                        while Cnt:
                            $ Options.append("sex") 
                            $ Cnt -= 1
                if newgirl["Mystique"].Anal >= 5 and Mod_ApprovalCheck("Mystique", 1700, TabM = 5):
...
label Mystique_TouchCheek:  
    ...
    if "addict Mystique" in P_Traits:
        ...
        $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 40, 5)
        
    if Mod_ApprovalCheck("Mystique", 1000):
    ...
    elif Mod_ApprovalCheck("Mystique", 800) or Mod_ApprovalCheck("Mystique", 700, "L"):
        ...
        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 50, -3)
        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 1)
    ...
    if "no cheek" in newgirl["Mystique"].DailyActions: 
        menu:
            "Sorry, sorry, won't happen again.":
                if Mod_ApprovalCheck("Mystique", 300):
                    call MystiqueFace("sexy", 1)
            ...
            "You know you wanted it.":
                if Mod_ApprovalCheck("Mystique", 400, "OI") or Mod_ApprovalCheck("Mystique", 800):
                    call MystiqueFace("normal", 1)
                    $ newgirl["Mystique"].Eyes = "squint"
                    ch_m "Don't presume. . . so much."
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 60, -1) 
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 30, 2)                        
        ...
        menu:
            "Sorry, you looked so lovely.":
                if Mod_ApprovalCheck("Mystique", 850, "LI"):
                    call MystiqueFace("sexy", 1)
                    ch_m "Don't make promises you can't keep."
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 80, 2)
                elif Mod_ApprovalCheck("Mystique", 500, "LI"):
                    call MystiqueFace("smile", 1)
            ...
            "You had a fly on you.":
                if Mod_ApprovalCheck("Mystique", 700, "LI"):
                    call MystiqueFace("sexy", 1)
            ...
            "Are you sure you didn't enjoy that?":
                if Mod_ApprovalCheck("Mystique", 850):
                    call MystiqueFace("sexy", 1)
                    $ newgirl["Mystique"].Eyes = "side"
...
label Mystique_Slap_Ass:
    ...
    if Mod_ApprovalCheck("Mystique", 300, "O", TabM=1):   
        call MystiqueFace("sexy", 1)
        $ newgirl["Mystique"].Mouth = "surprised"
        $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 51, 3, 1)
        if Action_Check("Mystique", "recent", "slap") < 4:
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 200, 1)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 2) if newgirl["Mystique"].Slap <= 5 else newgirl["Mystique"].Obed
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 1) if newgirl["Mystique"].Slap <= 10 else newgirl["Mystique"].Obed
    ...
    if Taboo:    
        ...
        if renpy.showing("Mystique_Doggy"):
            ch_m "[Line2]"
            $ Line2 = 0
        if not Mod_ApprovalCheck("Mystique", 900, TabM=3) and "public" not in newgirl["Mystique"].History:
            call MystiqueFace("angry",1)
        ...
        elif not Mod_ApprovalCheck("Mystique", 1500, TabM=3) and "public" not in newgirl["Mystique"].History:
            call MystiqueFace("bemused",2)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 2) if newgirl["Mystique"].Slap <= 5 else newgirl["Mystique"].Obed
            ...
            $ newgirl["Mystique"].Mouth = "smile"
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 1) if newgirl["Mystique"].Slap <= 5 else newgirl["Mystique"].Obed
...
label Mystique_Makeout:
    ...
    $ Approval = Mod_ApprovalCheck("Mystique", 700, TabM=1) # 50, 65, 80, Taboo -40(90)
    ...
    if Approval > 1 and not newgirl["Mystique"].Kissed and not newgirl["Mystique"].Forced:        
        ...
        call MystiqueFace("sexy")
        ch_m "Mwa."            
    elif Mod_ApprovalCheck("Mystique", 500, "O") and newgirl["Mystique"].Obed > newgirl["Mystique"].Love:
        call MystiqueFace("normal")
        ch_m "Of course."
        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 1)
    elif Mod_ApprovalCheck("Mystique", 300, "O") and Mod_ApprovalCheck("Mystique", 200, "L"):
        call MystiqueFace("sexy")
        ch_m "Ok, fine."
...
label Mystique_KissPrep:    
    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 10, 1)
    ...
    call Mod_DrainWord("Mystique","no kissing")
    ...
    if not newgirl["Mystique"].Kissed: 
        ...
        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 60, 25)            
        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 30, 20)
...
label Mystique_Kiss_After:
    ...
    if "kissing" not in newgirl["Mystique"].RecentActions:
        if newgirl["Mystique"].Love > 300:
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 60, 4)
        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, 1)
        $ newgirl["Mystique"].RecentActions.append("kissing")                      
        $ newgirl["Mystique"].DailyActions.append("kissing") 
    ...
    if not Situation and newgirl["Mystique"].Kissed > 5 and newgirl["Mystique"].Lust > 50 and Mod_ApprovalCheck("Mystique", 950):
            call MystiqueFace("sexy", 1)
...
label Mystique_Masturbate: #(Situation = Situation):
    ...
    $ Approval = Mod_ApprovalCheck("Mystique", 1300, TabM = 2) # 120, 135, 150, Taboo -80(200)
    
    call Mod_DrainWord("Mystique","unseen",1,0)
    ...
    if Situation == "join":       # This triggers if you ask to join in        
                    ...
                    menu:        
                        ...
                        "You look like you have things well in hand. . .":
                                if newgirl["Mystique"].Lust >= 50:
                                    ...
                                    jump MystiqueM_Cycle
                                elif Mod_ApprovalCheck("Mystique", 1200):
                                    call MystiqueFace("sly")
                ...
                call MystiqueOutfit
                $ newgirl["Mystique"].Action -= 1
                $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 50, 30)
                call Checkout(1)
                $ Line = 0
                $ Situation = 0      
                $ renpy.pop_call()          #removes the call to this label 
...
label Mystique_Offhand(TempLine=0):
    ...
    if Trigger2 == "kissing":
                ...
                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 75, 1) if newgirl["Mystique"].Love >= 300 else newgirl["Mystique"].Love
...
label Mystique_Taboo(Cnt= 1, Public=0):    
    ...
    if Taboo <= 20:
            ...
            if "exhibitionist" in newgirl["Mystique"].Traits:                
                    ...
                    $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 200, 5) 
                    $ Line = "A"
            elif Mod_ApprovalCheck("Mystique", 750, "I", TabM=Cnt-Public):
                    ...
                    $ Line = "B"
            elif Mod_ApprovalCheck("Mystique", 1000, "OI", TabM=Cnt-Public):     
