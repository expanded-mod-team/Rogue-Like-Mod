...
label Mystique_Missionary_SexPrep:
    ...
    if Situation != "auto":
        ...
        if newgirl["Mystique"].Panties == "zipper panties":
            ...
            call SetPantiesMystique("zipper panties open")
            if newgirl["Mystique"].Chest == "bustier bra":
                call SetChestMystique("bustier bra open")
    ...
    while Round >=0:  
        ...
        if Line and P_Focus < 100:                                                    #Player Command menu
                    ...
                    menu:
                        ...
                        #     #call SetChestMystique("bustier bra")
                        #     #call SetPantiesMystique("zipper panties")
