...
image Mystique_Doggy_Body:
    LiveComposite(                                                                                         #Upper body
        ...
        (0,0), ConditionSwitch(                                                                                 #tanktop
            ...
            "True", GetOutfitString("images/MystiqueDoggy/Mystique_Doggy_Chest_", newgirl['Mystique'].Chest, ".png"),
            "True", Null(),            
            ), 
...
image Mystique_Doggy_Ass:
    LiveComposite(                                                                                          #Lower body
        ...
        (0,0), ConditionSwitch(                                                                                 #Panties back
            ...
            "True", GetOutfitString("images/MystiqueDoggy/Mystique_Doggy_Panties_", newgirl['Mystique'].Panties, "_Back.png"),
            "True", Null(),                     
            ),  
        (0,0), ConditionSwitch(                                                                                 #Wet look
        ...
        #    "R_Panties == 'green panties' and R_Wet > 1", "images/RogueDoggy/Rogue_Doggy_Undies_Down_Wet.png",
            "True", GetOutfitString("images/MystiqueDoggy/Mystique_Doggy_Panties_", newgirl['Mystique'].Panties, "_Down.png"),
        ...
        #    "newgirl['Mystique'].Panties == 'green panties' and R_Wet", "images/RogueDoggy/Rogue_Doggy_Undies_Wet.png",          
            "True", GetOutfitString("images/MystiqueDoggy/Mystique_Doggy_Panties_", newgirl['Mystique'].Panties, ".png"),
        ...
        (0,0), ConditionSwitch(                     #Legs Layer(skirts)
            "newgirl['Mystique'].Upskirt and P_Sprite and P_Cock == 'anal' and Speed", GetOutfitString("images/MystiqueDoggy/Mystique_Doggy_Legs_", newgirl['Mystique'].Legs, "_UpAnal.png"),
            "newgirl['Mystique'].Upskirt", GetOutfitString("images/MystiqueDoggy/Mystique_Doggy_Legs_", newgirl['Mystique'].Legs, "_Up.png"),
            "True", GetOutfitString("images/MystiqueDoggy/Mystique_Doggy_Legs_", newgirl['Mystique'].Legs, ".png"),
            "True", Null(),                      
            ),   
