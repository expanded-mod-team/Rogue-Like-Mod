...
label KFT_Prep:                                                                 #Animation set-up 
    ...
    if Taboo:               
        call Statup("Kitty", "Lust", 200, (int(Taboo/5)))                               
        call Statup("Kitty", "Inbt", 200, (2*(int(Taboo/5))))
...
label KLP_Prep: #Animation set-up  
    ...
    if not K_LickP:        
        if K_Forced:
            ...
            call Statup("Kitty", "Obed", 70, 35)
            call Statup("Kitty", "Inbt", 80, 75) 
        else:
            call Statup("Kitty", "Love", 90, 35)
            call Statup("Kitty", "Obed", 70, 15)
            call Statup("Kitty", "Inbt", 80, 35)
    if Taboo:
        $ K_Inbt += int(Taboo/10)  
