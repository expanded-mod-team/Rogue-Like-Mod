...
label Rogue_MorningWood:
            ...
            $ Count = 3
            $ Line = 0
            call Seen_First_Peen("Rogue",0,1)
            while Count > 0:
                    call Statup("Player", "Focus", 80, 10)
                    call Statup("Rogue", "Lust", 80, 5)
                    menu:
...
label Rogue_BF:
    ...
    menu: 
        ...
        "I'm with someone now." if P_Harem:             
            ...
            menu:
                ...
                "They wouldn't be cool with that." if len(P_Harem) > 1:
                    $ Line = "no."
                "I'm sorry, but. . . no." if R_Event[5] != 20:
                    $ Line = "no."
                "No way.":
                    jump Rogue_BF_Jerk
            if Line == "no": 
...
label Rogue_BF_Jerk:
    ...
    call Statup("Rogue", "Obed", 50, 40)
    if R_Event[5] != 20:
            call Statup("Rogue", "Obed", 200, (20* R_Event[5]))
    if 20 > R_Event[5] >= 3:
            call RogueFace("sad")
    ...
    if 1 <  K_Event[5] < 20:
            ...
            call Statup("Rogue", "Love", 200, -(50* R_Event[5]))
    else:
...
label Rogue_Love_Jerk:    
    ...
    $ Count = (20* R_Event[6])
    call Statup("Rogue", "Obed", 50, 40)
    call Statup("Rogue", "Obed", 200, Count)
    if R_Event[6] == 3:
        call RogueFace("sad")
    ...
    $ Count = (100* R_Event[6])
    call Statup("Rogue", "Love", 200, -Count)    
    if "Historia" in P_Traits:
        return 0
    $ R_Loc = "bg rogue"
    $ bg_current = "bg player"
...
label Rogue_Sub_Jerk:
    ...
    ch_r "Hrmph!"
    $ Count = (20* R_Event[7])
    call Statup("Rogue", "Inbt", 50, 30)
    call Statup("Rogue", "Inbt", 200, Count)    
    if "Historia" not in P_Traits:
        $ renpy.pop_call()
    if R_Event[7] == 2:
        call RogueFace("sad")
        ...
        "What do you mean by that?":            
            ...
            menu:
                ...
                "You should do your own thing, you don't need me telling you what to do.":                                            
                    ...
                    call Statup("Rogue", "Inbt", 50, 100)  
                    call Statup("Rogue", "Inbt", 90, 50)  
                    ch_r "For now at least. . ."
                    call Statup("Rogue", "Obed", 200, -200)
                    $ R_Event[8] = 3
...
label Rogue_Sexfriend:  
    ...
    menu:
        extend ""
        "Sounds fun!":
            call Statup("Rogue", "Inbt", 200, 100) 
            $ R_Petnames.append("sex friend")
            "Rogue nods obediently."            
        "What do you mean by that?":            
            $R_Brows = "confused"              
