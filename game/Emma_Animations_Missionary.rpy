...
image Emma_Missionary:            
    LiveComposite(                                                                                 #Base body
        (1120,840),  
        (0,0), ConditionSwitch(                                                         #Shows different upper body motion depending on events  
            "P_Sprite and P_Cock == 'anal' and Speed >= 3", "Emma_Sex_Missionary_Body_Anim3",
            "P_Sprite and P_Cock == 'anal' and Speed >= 2", "Emma_Sex_Missionary_Body_Anim2",
            "P_Sprite and P_Cock == 'anal' and Speed", "Emma_Sex_Missionary_Body_Anim1",
            "P_Sprite and P_Cock == 'in' and Speed >= 3", "Emma_Sex_Missionary_Body_Anim3",
            "P_Sprite and P_Cock == 'in' and Speed >= 2", "Emma_Sex_Missionary_Body_Anim2",
            "P_Sprite and P_Cock == 'in' and Speed", "Emma_Sex_Missionary_Body_Anim1",
            "P_Sprite and P_Cock == 'out' and Speed >= 2","Emma_Hotdog_Body_Anim2",
            
            "P_Sprite and P_Cock == 'foot' and Speed >= 2", "Emma_Sex_Missionary_Body_FootAnim2",
            "P_Sprite and P_Cock == 'foot' and Speed", "Emma_Sex_Missionary_Body_FootAnim1",
            "P_Sprite and P_Cock == 'foot'", "Emma_Sex_Missionary_Body_FootAnimStatic",
            "True", "Emma_Sex_Missionary_Body_Static",           
            ),  
        (0,0), ConditionSwitch(                                                         #Shows different lower body motion depending on events
            "P_Sprite and P_Cock == 'anal' and Speed >= 3", "Emma_Sex_Missionary_Legs_Anim3",
            "P_Sprite and P_Cock == 'anal' and Speed >= 2", "Emma_Sex_Missionary_Legs_Anim2",
            "P_Sprite and P_Cock == 'anal' and Speed", "Emma_Sex_Missionary_Legs_Anim1",
            "P_Sprite and P_Cock == 'in' and Speed >= 3", "Emma_Sex_Missionary_Legs_Anim3",
            "P_Sprite and P_Cock == 'in' and Speed >= 2", "Emma_Sex_Missionary_Legs_Anim2",
            "P_Sprite and P_Cock == 'in' and Speed", "Emma_Sex_Missionary_Legs_Anim1",
            "P_Sprite and P_Cock == 'out' and Speed >= 2","Emma_Hotdog_Legs_Anim2",
            
            "P_Sprite and P_Cock == 'foot' and Speed >= 2", "Emma_Sex_Missionary_Legs_FootAnim2",
            "P_Sprite and P_Cock == 'foot' and Speed", "Emma_Sex_Missionary_Legs_FootAnim1",
            "P_Sprite and P_Cock == 'foot'", "Emma_Sex_Missionary_Legs_FootAnimStatic",
            "True", "Emma_Sex_Missionary_Legs_Static",            
            ),        
        ) 
    align (0.6,0.0)
    pos (650,230)#(750,230)
...
image Emma_Sex_Missionary_Body_Static:
    contains:
            "Emma_Sex_Missionary_Body"
    pos (650,230)
            
image Emma_Sex_Missionary_Legs_Static:
    contains:
            "Emma_Sex_Missionary_Legs"
    pos (650,230)

image Emma_Sex_Missionary_Body = LiveComposite(                                                                                
        #the torso/head used in the sex pose, referenced by Emma_Missionary
        (1120,840),
        (350,-275), "Emma_HairBack_Sex",    #(260,-350)   (402 -200 with 0 rotation)                                                                                #Hair underlayer
        (0,0), ConditionSwitch(                                                                                 #Body Base
        #     "E_Pierce == 'barbell'", "images/EmmaSexMissionary/Emma_Sex_Body_Barbell.png",   
        #     "E_Pierce == 'ring'", "images/EmmaSexMissionary/Emma_Sex_Body_Ring.png",   
        ...
        (0,0), ConditionSwitch(                                                                                 #gloves
            "E_Arms == 'black gloves'", "images/EmmaSexMissionary/Emma_Sex_Gloves_Black.png",
            "E_Arms == 'white gloves'", "images/EmmaSexMissionary/Emma_Sex_Gloves_White.png",
            "True", Null(),
            ), 
        ...
        (0,0), ConditionSwitch(                                                                                 #Wet look
            "E_Water", "images/EmmaSexMissionary/Emma_Sex_Water_Body.png",   
            "True", Null(),              
            ), 
        ...
        (0,0),ConditionSwitch(                                                                                  #Outside Spunk
            "'belly' in E_Spunk", "images/EmmaSexMissionary/Emma_Sex_Spunk_Body.png",   
            "True", Null(),  
            ),  
        )

image Emma_Sex_Missionary_HairBack:
    LiveComposite(
        (555,673), 
        (0,0), ConditionSwitch(       
...
image Emma_Sex_Missionary_Head:
    LiveComposite(
        (555,673), 
...
image Emma_Head_Sex:
    # The head used for the sex pose, referenced by Emma_Sex_Missionary_Body
    "Emma_Sex_Missionary_Head"
    zoom 1.5
    anchor (0.5,0.5)
    rotate 5
    xzoom -1
...
image Emma_HairBack_Sex:
    # The hair behind the head for the sex pose, referenced by Emma_Sex_Missionary_Body            
    "Emma_Sex_Missionary_HairBack"
    zoom 1.5
    anchor (0.5,0.5)   
    rotate 5         
    xzoom -1

#image Emma_Sex_Missionary_Legs = LiveComposite(  
image Emma_Sex_Missionary_Legs:
    LiveComposite(  
        #the legs used in the sex pose, referenced by Emma_Missionary
        (1120,840), 
        (0,0), ConditionSwitch(
            "E_LegsUp", "images/EmmaSexMissionary/Emma_Sex_Legs_LegsUp.png",
            "True", "images/EmmaSexMissionary/Emma_Sex_Legs.png",
            ),                                                     #Legs Base
        ...
        (0,0), ConditionSwitch(                                                                                 #Wet look
            "E_LegsUp", Null(),
            "E_Water", "images/EmmaSexMissionary/Emma_Sex_Water_Legs.png",   
            "True", Null(),              
            ),  
        (0,0), "Emma_Sex_Missionary_Anus",                                                                          #Anus Composite 

        (0,0), "Emma_Sex_Missionary_Pussy",                                                                         #Pussy Composite
        ...
        #     "E_Upskirt", Null(),                               
        #     "E_Legs == 'capris' and E_Wet > 1", "images/EmmaSexMissionary/Emma_Sex_Pants_Blue_Wet.png",
        #     "E_Legs == 'capris'", "images/EmmaSexMissionary/Emma_Sex_Pants_Blue.png",
        #     "E_Legs == 'black jeans' and E_Wet > 1", "images/EmmaSexMissionary/Emma_Sex_Pants_BlacE_Wet.png",
        #     "E_Legs == 'black jeans'", "images/EmmaSexMissionary/Emma_Sex_Pants_Black.png",
        #     "E_Legs == 'shorts' and E_Wet > 1", "images/EmmaSexMissionary/Emma_Sex_Shorts_Wet.png",
        #     "E_Legs == 'shorts'", "images/EmmaSexMissionary/Emma_Sex_Shorts.png",
        #     "E_Legs == 'yoga pants' and E_Wet > 1", "images/EmmaSexMissionary/Emma_Sex_Pants_Yoga_Wet.png",
        #     "E_Legs == 'yoga pants'", "images/EmmaSexMissionary/Emma_Sex_Pants_Yoga.png",
        #     "True", Null(),                      
        #     ),   
        # (0,0), ConditionSwitch(                                                                                 #Over Layer
        #     "E_Over == 'towel'", "images/EmmaSexMissionary/Emma_Sex_Towel_Legs.png",
        #     "True", Null(),                    
        #     ),   
        (0,0),ConditionSwitch(                                                                                  #Outside Spunk
            "'belly' in E_Spunk", "images/EmmaSexMissionary/Emma_Sex_Spunk_Pelvis.png",   
            "True", Null(),  
            ),  
        ...
        (0,0), ConditionSwitch(                                                         #Shows different lower body motion depending on events
            "not Speed", "Emma_Sex_Missionary_Feet",  
            "E_LegsUp and (P_Cock == 'anal' or P_Cock == 'in' or P_Cock == 'out')", "Emma_Sex_Missionary_Feet", 
            "P_Cock == 'anal' or P_Cock == 'in' or P_Cock == 'out'", AlphaMask("Emma_Sex_Missionary_Feet", "images/EmmaSexMissionary/Emma_Sex_FeetMask.png"), 
            "True", "Emma_Sex_Missionary_Feet",            
            ),
        )
    
image Emma_Sex_Missionary_Feet = LiveComposite(                                                                                          
        #the lower legs used in the sex pose, referenced by Emma_Sex_Missionary_Legs
        (1120,840), 
        (0,0), ConditionSwitch(
            "E_LegsUp", "images/EmmaSexMissionary/Emma_Sex_Feet_LegsUp.png",
        ...
        #     ),
        (0,0), ConditionSwitch(                                                                                 #Wet look
            "E_Water", "images/EmmaSexMissionary/Emma_Sex_Water_Feet.png",   
            "True", Null(),              
            ),  
        # (0,0), ConditionSwitch(                                                                                 #Legs Layer
        #     "E_Upskirt", Null(),                               
        #     "E_Legs == 'capris'", "images/EmmaSexMissionary/Emma_Sex_Feet_Blue.png",
        #     "E_Legs == 'black jeans'", "images/EmmaSexMissionary/Emma_Sex_Feet_Black.png",
        #     "E_Legs == 'yoga pants'", "images/EmmaSexMissionary/Emma_Sex_Feet_Yoga.png",
        #     "True", Null(),                      
        #     ),   
        )
...
image Emma_Pussy_Fucking0:
    ...
    contains:
            ...
            "images/EmmaSexMissionary/Emma_Sex_Pussy_Open.png"
    contains:
            # pubes
            ConditionSwitch(             
                "not E_Pubes", Null(),         
    ...
    contains:
            ...
            AlphaMask("Emma_Sex_Missionary_Zero_Anim0", "Emma_Pussy_Open_Mask") 
...
image Emma_Pussy_Fucking1:
    ...
    contains:
            # The animation of Zero's moving penis, masked by her pussy shape
            AlphaMask("Emma_Sex_Missionary_Zero_Anim1", "Emma_Pussy_Open_Mask") 

image Emma_Pussy_Fucking2:
    # This is the visual for her pussy during the Speed 2 mode (slow). 
    contains:
            # The background plate of her pussy
            "images/EmmaSexMissionary/Emma_Sex_Pussy_Fucking.png"
    contains:
            # pubes
            ConditionSwitch(             
                "not E_Pubes", Null(),         
    ...
    contains:
            # The animation of Zero's moving penis, masked by her pussy shape
            AlphaMask("Emma_Sex_Missionary_Zero_Anim2", "Emma_Pussy_Fucking_Mask") 
...
image Emma_Pussy_Fucking3:  #rename this to 3
    ...
    contains:
            # The animation of Zero's moving penis, masked by her pussy shape
            AlphaMask("Emma_Sex_Missionary_Zero_Anim3", "Emma_Pussy_Fucking_Mask") 
            
image Emma_Pussy_Fucking_Mask:
        #This is the mask image for Emma's wide open pussy
        contains:
            "images/EmmaSexMissionary/Emma_Sex_Pussy_Mask.png"   
...
image Emma_Pussy_Spunk_Heading:                
    "images/EmmaSexMissionary/Emma_Sex_Spunk_Puss_Over.png"
    anchor (0.5,0.5)
    pos (0.5,0.5)
    xzoom 0.8
            
image Emma_Sex_Missionary_Pussy:            
    # This is the visual for her pussy during the Speed 0 mode (static).     
    contains:
            # The background plate of her pussy            
            ConditionSwitch(    
                "P_Sprite and P_Cock == 'in' and Speed >= 2", "images/EmmaSexMissionary/Emma_Sex_Pussy_Fucking.png",
                "P_Sprite and P_Cock == 'in' and Speed", "images/EmmaSexMissionary/Emma_Sex_Pussy_Open.png",
                "P_Sprite and P_Cock == 'in'", "images/EmmaSexMissionary/Emma_Sex_Pussy_Closed.png",    
                "Trigger == 'lick pussy'", "images/EmmaSexMissionary/Emma_Sex_Pussy_Open.png",   
                "True", "images/EmmaSexMissionary/Emma_Sex_Pussy_Closed.png",
                )
    contains:
            # The background plate of her pussy            
            ConditionSwitch(    
                "not E_Wet", Null(),  
                "P_Sprite and P_Cock == 'in' and Speed >= 2", "images/EmmaSexMissionary/Emma_Sex_WetPussy_F.png",
                "True", "images/EmmaSexMissionary/Emma_Sex_WetPussy_C.png",
                )
    # contains: 
    #         #ring piercing
    #         ConditionSwitch(  
    #             "E_Pierce != 'ring'", Null(),
    #             "not P_Sprite or P_Cock != 'in' or Speed <= 1", "images/EmmaSexMissionary/Emma_Sex_Pussy_Ring.png",
    #             "True", "images/EmmaSexMissionary/Emma_Sex_Pussy_RingF.png",
    #             ) 
    # contains: 
    #         #barbell piercing
    #         ConditionSwitch(  
    #             "E_Pierce != 'barbell'", Null(),
    #             "not P_Sprite or P_Cock != 'in' or Speed <= 1", "images/EmmaSexMissionary/Emma_Sex_Pussy_Barbell.png",
    #             "True", "images/EmmaSexMissionary/Emma_Sex_Pussy_BarbellF.png",
    #             )             
    contains:
            # pubes
            ConditionSwitch(    
    ...
    contains:
            #Spunk under penis
            ConditionSwitch(    
                "'in' in E_Spunk", "images/EmmaSexMissionary/Emma_Sex_Spunk_Puss_Under.png",   
                "True", Null(),  
                )  
    contains:
            # The animation of Zero's moving penis, masked by her pussy shape
            ConditionSwitch(    
                "not P_Sprite", Null(),  
                "P_Sprite and P_Cock == 'in' and Speed >= 3", AlphaMask("Emma_Sex_Missionary_Zero_Anim3", "Emma_Pussy_Fucking_Mask"),
                "P_Sprite and P_Cock == 'in' and Speed >= 2", AlphaMask("Emma_Sex_Missionary_Zero_Anim2", "Emma_Pussy_Fucking_Mask"),
                "P_Sprite and P_Cock == 'in' and Speed", AlphaMask("Emma_Sex_Missionary_Zero_Anim1", "Emma_Pussy_Open_Mask"),
                "P_Sprite and P_Cock == 'in'", AlphaMask("Emma_Sex_Missionary_Zero_Anim0", "Emma_Pussy_Open_Mask"),  
                "True", Null(),  
                )  
    contains:
            #Spunk over penis
            ConditionSwitch(    
                ...
                "True", "images/EmmaSexMissionary/Emma_Sex_Spunk_Puss_Over.png",  
                )  
...
image Emma_Sex_Missionary_Zero_Anim0:
...
image Emma_Sex_Missionary_Zero_Anim1:
...
image Emma_Sex_Missionary_Zero_Anim2:
...
image Emma_Sex_Missionary_Zero_Anim3:
...
image Emma_Sex_Missionary_Legs_Anim1:
...
image Emma_Sex_Missionary_Legs_Anim2:            
...
image Emma_Sex_Missionary_Legs_Anim3:
...
image Emma_Sex_Missionary_Body_Anim1:
...
image Emma_Sex_Missionary_Body_Anim2:            
...
image Emma_Sex_Missionary_Body_Anim3:
...
image Emma_Sex_Missionary_Anus:
    contains:
            #Anus background plate
            ConditionSwitch(                                                                                             
            "P_Sprite and P_Cock == 'anal' and Speed >= 3", "images/EmmaSexMissionary/Emma_Sex_Hole_Open.png",         
            "P_Sprite and P_Cock == 'anal' and Speed >= 2", "images/EmmaSexMissionary/Emma_Sex_Hole_Open.png",
            "P_Sprite and P_Cock == 'anal' and Speed", "Emma_Anal_Heading",
            "P_Sprite and P_Cock == 'anal'", "Emma_Anal_Tip", 
            "E_Loose", "images/EmmaSexMissionary/Emma_Sex_Hole_Loose.png",   
            "True", "images/EmmaSexMissionary/Emma_Sex_Hole_Tight.png", 
            )    
    contains:
            #Spunk under penis
            ConditionSwitch(    
                "'anal' not in E_Spunk", Null(),  
                "P_Sprite and P_Cock != 'anal' and Speed >= 1", "images/EmmaSexMissionary/Emma_Sex_Spunk_Anal_Under.png",  
                "P_Sprite and P_Cock != 'anal' and Speed == 1", "Emma_Anal_Spunk_Heading_Under",
                "True", "images/EmmaSexMissionary/Emma_Sex_Spunk_Anal_Closed.png",  
                )  
    contains:
    ...
    contains:
            ...
            ConditionSwitch(    
                ...
                "True", "images/EmmaSexMissionary/Emma_Sex_Spunk_Anal_Over.png",  
                )  
...
image Emma_Anal_Fucking2:
    ...
    contains:
            # The background plate of her pussy
            "images/EmmaSexMissionary/Emma_Sex_Hole_Open.png"
    contains:
            # The animation of Zero's moving penis, masked by her pussy shape
...
image Emma_Anal_Fucking_Mask:
        #This is the mask image for Emma's wide open pussy
        contains:
            "images/EmmaSexMissionary/Emma_Sex_Hole_Mask.png"               
...
image Emma_Anal_Spunk_Heading_Over:                
    "images/EmmaSexMissionary/Emma_Sex_Spunk_Anal_Over.png"
    anchor (0.5,0.5)
    pos (0.5,0.5)
    xzoom 0.8
    block:
...
image Emma_Anal_Spunk_Heading_Under:                
    "images/EmmaSexMissionary/Emma_Sex_Spunk_Anal_Under.png"
    anchor (0.5,0.5)
    pos (0.5,0.5)
    xzoom 0.6
    block:
...
image Emma_Sex_Missionary_Legs_FootAnim1:            
...
image Emma_Sex_Missionary_Legs_FootAnim2:            
        #this is the animation for Emma's lower body during Footjobs, Speed 2 (slow)
        contains:
            subpixel True
            "Emma_Sex_Missionary_Legs"
...
image Emma_Sex_Missionary_Legs_FootAnimStatic:            
        #this is the animation for Emma's lower body during Footjobs, Speed 2 (slow)
        contains:
            subpixel True
            "Emma_Sex_Missionary_Legs"
...
transform Emma_Sex_Missionary_Legs_FootAnim1A():            
        #this is the animation for Emma's lower body during Footjobs, Speed 2 (slow)
            subpixel True
...
transform Emma_Sex_Missionary_Legs_FootAnim2A():            
        #this is the animation for Emma's lower body during Footjobs, Speed 2 (slow)
            subpixel True
            offset (0,0) #X less is left, Y less is up
            block:
...
transform Emma_Sex_Missionary_Legs_FootAnimStaticA():            
        #this is the animation for Emma's lower body during Footjobs, Speed 2 (slow)
            subpixel True
            offset (0,0) #X less is left, Y less is up
            block:
...
image Emma_Sex_Missionary_Body_FootAnim1:            
...
image Emma_Sex_Missionary_Body_FootAnim2:            
        #this is the animation for Emma's upper body during Footjobs, Speed 2 (slow)
        contains:
            subpixel True
            "Emma_Sex_Missionary_Body"
...
image Emma_Sex_Missionary_Body_FootAnimStatic:            
        #this is the animation for Emma's upper body during Footjobs, Speed 2 (slow)
        contains:
            subpixel True
            "Emma_Sex_Missionary_Body"
...
transform Emma_Sex_Missionary_Body_FootAnim1A():            
        #this is the animation for Emma's upper body during Footjobs, Speed 2 (slow)
            subpixel True
            offset (0,0) #X less is left, Y less is up
            block:
...
transform Emma_Sex_Missionary_Body_FootAnim2A():            
        #this is the animation for Emma's upper body during Footjobs, Speed 2 (slow)
            subpixel True
            offset (0,0) #X less is left, Y less is up
            block:
...
transform Emma_Sex_Missionary_Body_FootAnimStaticA():            
        #this is the animation for Emma's upper body during Footjobs, Speed 2 (slow)
            subpixel True
            offset (0,0) #X less is left, Y less is up
            block:
...
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>                                     Sex Launch/Reset
label Emma_Missionary_Launch(Line = "solo"): 
    if Line == "sex":        
        $ P_Cock = "in"
    elif Line == "anal":
        $ P_Cock = "anal"
