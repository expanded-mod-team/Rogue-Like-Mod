...
label DateNight(Prime_Bonus=0,Second_Bonus=0,Play_Cost=0,Prime_Cost=0,Second_Cost=0):
    ...
    if "yesdate" in L_DailyActions:  #Checks if Laura is in
            $ Party.append("Laura")
    ...
    if "Laura" in Party and "stoodup" in L_History:
                $ L_History.remove("stoodup") 
...
label Date_Crossed(Girls=[],Check=0,CrossedP=0,CrossedS=0,Count=0):
    ...
    if Party[0] == "Rogue":
            if Party[1] == "Kitty":
                    ...
                    $ CrossedP = R_LikeLaura
                    $ CrossedS = L_LikeRogue
    elif Party[0] == "Kitty":
            if Party[1] == "Rogue":
                    ...
                    $ CrossedP = K_LikeLaura
                    $ CrossedS = L_LikeKitty 
    elif Party[0] == "Emma":                
            if Party[1] == "Rogue":
                    ...
                    $ CrossedP = E_LikeLaura
                    $ CrossedS = L_LikeEmma 
    elif Party[0] == "Laura":                
            if Party[1] == "Rogue":
                    $ CrossedP = L_LikeRogue
                    $ CrossedS = R_LikeLaura
            elif Party[1] == "Kitty":
                    $ CrossedP = L_LikeKitty
                    $ CrossedS = K_LikeLaura             
            elif Party[1] == "Emma":
                    $ CrossedP = L_LikeEmma
                    $ CrossedS = E_LikeLaura
...
label Date_Sex_Break(Lead=0,Previous=0,Repeat=0):
    ...
    if Lead == "Rogue":
            if Previous == "Kitty":
                ...
                if R_LikeLaura >= 700 and L_LikeRogue >= 700:
                        #They like each other and will share
                        $ L_RecentActions.append("noticed Rogue")
                        return 1
                elif ApprovalCheck("Laura", 1400) and L_LikeRogue >= 500:
    ...
    #End Lead Rogue
            ...
            if Previous == "Rogue":
                ...
                if K_LikeLaura >= 700 and L_LikeEmma >= 700:
                        #They like each other and will share
                        $ L_RecentActions.append("noticed Kitty")
                        return 1
                elif ApprovalCheck("Laura", 1400) and L_LikeKitty >= 500:
    ...
    #End Lead Kitty
            ...
            if Previous == "Rogue":
                ...
                if E_LikeLaura >= 700 and L_LikeEmma >= 700:
                        #They like each other and will share
                        $ L_RecentActions.append("noticed Emma")
                        return 1
                elif ApprovalCheck("Laura", 1400) and L_LikeEmma >= 500:
    ...
    #End Lead Emma
            ...
            if Previous == "Rogue":
                if L_LikeRogue >= 700 and R_LikeLaura >= 700:
                        #They like each other and will share
                        $ R_RecentActions.append("noticed Laura")
                        return 1
                elif ApprovalCheck("Rogue", 1400) and R_LikeLaura >= 500:
                        #Rogue likes you, and likes Kitty enough to be chill
                        call RogueFace("sly")
                        "Rogue winks at you, but doesn't move to get involved."
                        $ R_RecentActions.append("noticed Laura")
                ...
                if E_LikeKitty >= 700 and K_LikeLaura >= 700:
                        #They like each other and will share
                        $ K_RecentActions.append("noticed Laura")
                        return 1
                elif ApprovalCheck("Kitty", 1400) and K_LikeLaura >= 500:
                ...
                if L_LikeEmma >= 700 and E_LikeLaura >= 700:
                        #They like each other and will share
                        $ L_RecentActions.append("noticed Laura")
                        return 1
                elif ApprovalCheck("Emma", 1400) and E_LikeLaura >= 500:
                        #Emma likes you, and likes Kitty enough to be chill
                        call EmmaFace("sly")
                        "Emma winks at you, but doesn't move to get involved."
...
label Date_Paying(Activity="dinner", Total_Cost=0):  
    ...
    if Line == "you":
            ...
            if ApprovalCheck("Laura", 900) and not Party[1]:
                    ...
                    call Statup("Laura", "Obed", 80, 2)     
                    if bg_current != "bg movies" and "dinnersex" in L_RecentActions:
    ...
    if Line == "deadbeat":  
            ...
            if "Laura" in Party:
                    ...
                    if ApprovalCheck("Laura", 800):
                        ch_l "You gotta cover your own tab, [L_Petname]."         
                    else:
                        $ L_Brows = "angry"
                        ch_l "Get your act together." 
                        call Statup("Laura", "Love", 200, -4)
                        if "deadbeat" not in L_History:  
                            $ L_History.append("deadbeat") 
                        else:
                            call Laura_Date_Over
    #end choice consequences
    
    #Boosts lust based on price spent
    $ Count = int(Prime_Bonus/2)
    $ Count = 10 if Count >= 10 else Count
    if Party[0] == "Rogue":
                call Statup("Rogue", "Lust", 60, Count)                
    elif Party[0] == "Kitty":
                call Statup("Kitty", "Lust", 60, Count)                
    elif Party[0] == "Emma":
                call Statup("Emma", "Lust", 70, Count)                
    elif Party[0] == "Laura":
                call Statup("Laura", "Lust", 60, Count)
                
    $ Count = int(Second_Bonus/2)
    $ Count = 10 if Count >= 10 else Count    
    if Party[1] == "Rogue":
                call Statup("Rogue", "Lust", 60, Count)
    elif Party[1] == "Kitty":
                ...
                call Statup("Emma", "Lust", 75, Count)
    elif Party[1] == "Laura":
                call Statup("Laura", "Lust", 60, Count)
...
label Readytogo(R=0):    
    ...
    if R_Loc == bg_current and "yesdate" in R_DailyActions:  
            ...
            $R=1
    elif L_Loc == bg_current and "yesdate" in L_DailyActions: 
            ch_l "Ready?"
            $R=1
    menu:
        ...
        "Let's cancel that date, just hang out." if R:
                ...
                if E_Loc == bg_current and "yesdate" in E_DailyActions:  #Checks if Emma is in
                        ch_e "Suit yourself."
                        $ E_DailyActions.remove("yesdate")
                if L_Loc == bg_current and "yesdate" in L_DailyActions:  #Checks if Laura is in
                        ch_l "Ok, whatever."
                        $ L_DailyActions.remove("yesdate")
    return
