...
label Rogue_SexDialog(TempLine = 0, TempLust = 0, TempLust2 = 0):    
            ...
            if R_Tit > 4 and R_Blow:                                        #5th+ and blown
                        if Speed <= 1:                                              #slow
                            ...
                            $ Line = renpy.random.choice(["Rogue rapidly rocks her breasts up and down around your cock", 
                                    ...
                                    "Rogue dances her nipples across the shaft",
    ...
    # end R_Anal                                 //////////////////////////////////////////////////////////////////////////////
                    ...
                    if not R_Uptop and R_Over and R_Chest: #Full top
                    ...
                    elif not R_Uptop and R_Over:        #Just overtop
                                ...
                                $ TempLust += 4 if R_Lust > 50 else 2   
                    elif not R_Uptop and R_Chest:       #just bra
...
#                $ TempLust = 0
    ...
    # end R Masturbation                               /////////////////////////////////////////////////////////////////////////////
                ...
                call Rogue_SexDialog_Threeway("lesbian")      
                        ...
                        $ Line = "Rogue continues stroke your cock with her feet. "
                        ...
                        if R_Foot > 4:                          # After the 5th time 
                                    if Speed <= 1:                      #slow 
                                        $ Line = Line + renpy.random.choice(["Her movements have become almost masterful, her slightest touch starts you twitching",
                                                "She slowly caresses you in a way that makes your blood boil, then pulls back at the last second",
                                                "She knows what to do now, and rubs your cock with smooth strokes, focusing occasionally on the head",
                        ...
                        elif R_Foot >= 3:                       #third through 5th time
                                    if Speed <= 1:                      #slow
...
label Rogue_Self_Lines(Mode = "T3", Action = Trigger3, TempLustX = 0): 
    ...
    if not Action or D20S >= 15: 
            if Trigger != "masturbation" and "passive" in R_Traits:
                    ...
                    $ Line = 0
                    return            
            call Rogue_Self_Set(Mode, Action)
    ...
    if Action == "hand": 
        ...
        if Partner != "Rogue": #If this is a primary, Trigger3 action
            $ TempLust = TempLustX
...
label Rogue_SexDialog_Threeway(Mode = 0, Action = 0, ActiveGirl = Primary, TempLine = 0, TempLust = 0, TempLust2 = 0, TempFocus = 0):
                        ...
                        if D20S <= 8 and (Trigger == "blow" or Trigger == "hand"): #This is a random bonus dialog
                            if Trigger == "blow": #If Kitty is blowing you
                                ...
                                $ Line = renpy.random.choice(["Rogue's tongue brushes against " + ActiveGirl + "'s hand as they work",
                                        ...
                                        "Rogue takes a turn to stroke a few times before passing it back",
                                        "Rogue and " + ActiveGirl + " get into an alternating rhythm"])  
                            $ TempLust2 += 1 if GirlLikeCheck(ActiveGirl,"Rogue") >= 800 else 0                
                        else:
    ...
    # end R_Blowjob Threeway                                //////////////////////////////////////////////////////////////////////////////
                        ...
                        $ TempLust2 += 5 if GirlLikeCheck(ActiveGirl,"Rogue") >= 800 else 2
                        $ TempFocus += 1 
    # end R Fondle breasts Threeway                                //////////////////////////////////////////////////////////////////////////////
                        ...
                        $ TempLust += 2 if ApprovalCheck("Rogue", 500, "I") else 1  # Rogue's lust
                        $ TempLust2 += 4 if GirlLikeCheck(ActiveGirl,"Rogue") >= 800 else 2
                        $ TempFocus += 1                      
    # end R Suck breasts Threeway                                //////////////////////////////////////////////////////////////////////////////
                        ...
                        $ TempLust += 2 if ApprovalCheck("Rogue", 500, "I") else 1  # Rogue's lust
                        $ TempLust2 += 5 if GirlLikeCheck(ActiveGirl,"Rogue") >= 800 else 3
                        $ TempFocus += 1  
    ...
    # end R fondle pussy Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        $ TempLust2 += 7 if GirlLikeCheck(ActiveGirl,"Rogue") >= 800 else 4
                        $ TempFocus += 3  
    ...
    # end R lick pussy Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        $ TempLust2 += 3 if GirlLikeCheck(ActiveGirl,"Rogue") >= 800 else 1
                        $ TempFocus += 1  
    ...
    # end R Masturbation Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        if Trigger == "blow" and R_Blow > 5 and Trigger4 == "kiss girl":
                                    ...
                                    if Action == "kiss girl" or Mode == "lesbian":
                                        if Trigger == "lesbian" and Partner != "Rogue":
                                        ...
                                        $ Line = Line + renpy.random.choice([", occasionally coming up for air", 
                                                ...
                                                ", trailing kisses down her neck"])                                                
                        $ TempLust += 1 if ApprovalCheck("Rogue", 500, "I") else 0  # Rogue's lust
                        $ TempLust += 1 if GirlLikeCheck("Rogue",ActiveGirl) >= 800 else 0
                        $ TempLust2 += 2 if GirlLikeCheck(ActiveGirl,"Rogue") >= 800 else 1 
                        $ TempFocus += 1  
    # end R Kissing Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        $ TempLust += 1 if GirlLikeCheck("Rogue",ActiveGirl) >= 600 else 0  # Rogue's lust
                        $ TempLust += 2 if GirlLikeCheck("Rogue",ActiveGirl) >= 800 else 1  # Rogue's lust
...
label Rogue_Threeway_Set(Preset = 0, Mode = 0, Action = Trigger4, ActiveGirl = Primary, State = "watcher", TempLust = 0, TempLust2 = 0, TempFocus = 0):
            ...
            if Trigger == "lesbian":
                    ...
                    if Preset in ("hand","blow","kiss you","kiss both"):
                            ...
                            pass
                    elif GirlLikeCheck("Rogue",ActiveGirl) >= 600 and ApprovalCheck("Rogue", 500, "I"):
                            pass
                    else:
                    ...
                    pass            
            elif GirlLikeCheck("Rogue",ActiveGirl) >= 600 and ApprovalCheck("Rogue", (1500-(10*R_Les)-(10*(GirlLikeCheck("Rogue",ActiveGirl)-60)))): 
                    #If she likes both of you a lot, threeway
                    $ State = "threeway"
            elif ApprovalCheck("Rogue", 1000): 
                    #If she likes you well enough, Hetero
                    $ State = "hetero"            
            elif GirlLikeCheck("Rogue",ActiveGirl) >= 700: 
            ...
            if State == "lesbian" or State == "threeway":  
                ...
                if ApprovalCheck("Rogue", 800, "I") or GirlLikeCheck("Rogue",ActiveGirl) >= 800:
                    $ Options.append("lick pussy")
                if ApprovalCheck("Rogue", 900, "I") and GirlLikeCheck("Rogue",ActiveGirl) >= 900:
...
#                    $ Options.append("vibrator") 
            ...
            if Preset:
                ...
                elif ApprovalCheck("Rogue", 750, "I") or ApprovalCheck("Rogue", 1500):
            ...
            if Options[0] == "masturbation":
                        ...
                        call Seen_First_Peen("Rogue",ActiveGirl,React=1)
...
#                        call RThreewayPussy_Launch #Launches position change
                        ...
                        if "lesbian" not in R_RecentActions:
                                ...
                                $ R_RecentActions.append("lesbian") 
                        $ TempLust += 3 if ApprovalCheck("Rogue", 600, "I") else 1  # Rogue's lust
                        $ TempLust2 += 8 if GirlLikeCheck(ActiveGirl,"Rogue") >= 800 else 5
                        $ TempFocus += 3  
...
#                        call RThreewayPussy_Launch #Launches position change
                        ...
                        $ TempLust2 += 3 if GirlLikeCheck(ActiveGirl,"Rogue") >= 600 else 2
                        $ TempFocus += 1  
...
#                        call RThreewayPussy_Launch #Launches position change
                        ...
                        if "lesbian" not in R_RecentActions:
                                ...
                                $ R_RecentActions.append("lesbian") 
                        $ TempLust += 3 if ApprovalCheck("Rogue", 800, "I") else 1  # Rogue's lust
                        $ TempLust2 += 6 if GirlLikeCheck(ActiveGirl,"Rogue") >= 800 else 4
                        $ TempFocus += 2  
...
#            elif Options[0] == "vibrator":    
                        ...
                        $ Line = "Rogue is just watching the two of you intently"
                        $ Action = "watch"
                        $ TempLust += 1 if GirlLikeCheck("Rogue",ActiveGirl) >= 600 else 0  # Rogue's lust
                        $ TempLust += 2 if GirlLikeCheck("Rogue",ActiveGirl) >= 800 else 1  # Rogue's lust
                        $ TempLust2 += 1 if ApprovalCheck(ActiveGirl, 500, "I") else 0
            ...
            if Mode == "lesbian":
                ...
                #Sets Rogue's action and Lust if this is a starting action
                $ Trigger4 = Action
                $ R_Lust += TempLust2
            else:
...
label Dirty_Talk(D20=0, TempCheck=0, TempLine=0, TempTrigger=Trigger4, ActiveGirl=0): 
    ...
    #Rogue    
    if (Primary == "Rogue" and D20 in (2,3)) or (Secondary == "Rogue" and Trigger4 and D20 == 4):
            
                    
            #If the primary is Rogue and 1-10 or Rogue is the Partner and 11-15 
            if Primary == "Rogue":
            ...
            if "vocal" not in R_Traits:
                    ...
                    pass
            elif Trigger == "lesbian" or (Secondary == "Rogue" and TempTrigger not in ("hand","blow","masturbation")):
                    #if this is a lesbian action, or if the threesome action is girl-focused  
                    
                    if "unseen" not in R_RecentActions and D20 <= 5:
                            #if they know you're watching, there is a 3/10 or 2/5 chance
                            $ TempLine = "Hmm, enjoying the show, "+R_Petname+"?" #you watching
                    elif D20 <= 10:
                            pass
                    ...
                    if not TempLine:
                            ...
                            $ TempLine = renpy.random.choice([
                                    "Touch'n ya is so amazing, " + ActiveGirl + ".",
                    ...
                    if "unseen" not in R_RecentActions:
                            ...
                            if D20 <= 3: 
                                ...
                                if "cockout" in P_RecentActions:
                                    # Your cock's out
                                    $ TempLine = renpy.random.choice([
                                                "Could I get some of that, " + R_Petname + "?",
                                                "Why don'tcha bring that over here, " + R_Petname + "?"
                                                ])
                                else:
                                    # Your cock's not out
                                    $ TempLine = renpy.random.choice([
                                                "Why so shy, " + R_Petname + "?",
                                    ...
                                    $ TempLine = renpy.random.choice([
                                                ...
                                                "Come on over here, " + R_Petname + ". Take me however ya want.",
                                                "Hmm, enjoying the show, "+R_Petname+"?",    
                    ...
                    if D20 <= 10:
                            pass
                    elif R_SEXP <= 20 or TempCheck == "kiss you":
                        ...
                        $ TempLine = renpy.random.choice([
                                    ...
                                    "Seems like you like my hand, huh, " + R_Petname + "?",
                                    "I can feel you get harder in my hand. . .",
                                    ])
                    elif TempCheck == "blow":
                        $ TempLine = renpy.random.choice([
                                    "Your cock is so warm. . .",
                                    "You taste so nice, " + R_Petname + ".",
                        ...
                        $ TempLine = renpy.random.choice([
                                    "Your cock is so warm. . .",
                                    "I can feel you between my breasts, " + R_Petname + ".",
                                    "I can feel you get harder in there. . ."              
                                    ])
                    elif TempCheck == "sex" or TempCheck == "anal":
                        if D20 <= 3 and TempCheck == "anal" and R_Loose <= 1:
                    ...
                    if not TempLine:
                        ...
                        if Primary == "Rogue":
                                $ TempLine = renpy.random.choice([
                                        "I want ya so bad, " + R_Petname + ".",
                                        "Your touch is so amazin, " + R_Petname + ".",
                                        "Oooh, right there. . .",
                                        "More, gimme more!",
                                ...
                                $ TempLine = renpy.random.choice([
                                        "I want ya so bad, " + R_Petname + ".",
                                        "Could I get some of that, " + R_Petname + "?",
                                        "Think ya could maybe share that, " + ActiveGirl + "?",
                                        "Come on over here, " + R_Petname + ". Take me however ya want.",
                                        "So that's what you look like from this angle.",
                                        "I love the look you get on your face, " + R_Petname + ".",
                                        "That's right, give it to her.",
                                        "You're really getting into it, " + ActiveGirl + "."
                                        ])
            #End Rogue's dirty talk lines  
            if not TempLine:
                    if not ActiveGirl:
                            $ ActiveGirl = R_Petname
                    $ TempLine = renpy.random.choice([
                            "Mmmh. . .",
                            "Ung. . .",
                            "Ooooh. . .",
    ...
    elif (Primary == "Kitty" and D20 in (2,3)) or (Secondary == "Kitty" and Trigger4 and D20 == 4):
            #procs if she's prinary 2-3, or secondary 4
            ...
            if "vocal" not in K_Traits:
                    ...
                    #drops it down to the generic grunts  
                    pass
            elif Trigger == "lesbian" or (Secondary == "Kitty" and TempTrigger not in ("hand","blow","masturbation")):
                    #if this is a lesbian action, or if the threesome action is girl-focused 
                    
                    if "unseen" not in K_RecentActions and D20 <= 7:
                            #if they know you're watching, there is a 3/10 or 2/5 chance
                            $ TempLine = "Hmm, like what you see, "+K_Petname+"?" #you watching
                    elif TempTrigger == "fondle breasts":                            
                        if ActiveGirl == "Emma":
                            $ TempLine = "I'm so jelly here Emma." #fondle breasts
                        else:
                            $ TempLine = "I love these tits, "+ActiveGirl+"." #fondle breasts
                    elif TempTrigger == "suck breasts":                           
                        if ActiveGirl == "Emma":                 
                            $ TempLine = "These tits are {i}amazing,{/i} Emma." #fondle breasts
                        else:       
                            $ TempLine = "Hmm, you taste so good, "+ActiveGirl+"." #suck breasts
                    elif TempTrigger == "fondle pussy":                            
                            $ TempLine = "So wet, "+ActiveGirl+"." #fondle pussy
                    elif TempTrigger == "lick pussy":                 
                        if ActiveGirl == "Rogue" and R_Pubes:
                            $ TempLine = "I love your little stripe, Rogue." #lick pussy                            
                        else:
                            $ TempLine = "You're drowning me here, "+ActiveGirl+"." #lick pussy
                    ...
                    if "unseen" not in K_RecentActions:
                            ...
                            if D20 <= 3: 
                                ...
                                if "cockout" in P_RecentActions:
                                    # Your cock's out
                                    $ TempLine = renpy.random.choice([
                                                "Hmm, I'd like some of that, " + K_Petname + "?",
                                                "Could I get a taste, " + K_Petname + "?"
                                                ])
                                else:
                                    # Your cock's not out
                                    $ TempLine = renpy.random.choice([
                                                "Feeling shy, " + K_Petname + "?",
                                                "How 'bout a little tat for tit?"
                                                ])
                            else:
                                    # It's over a 3 roll
                                    $ TempLine = renpy.random.choice([
                                                "I really want you, " + K_Petname + ".",
                                                "Come'ere, " + K_Petname + ". Gimme a taste.",
                                                "Hmm, like the show, "+K_Petname+"?",    
                                                "You look so cute over there, " + K_Petname + "."
                                                ])
                    ...
                    if D20 <= 10:
                            pass
                    elif K_SEXP <= 30 or TempCheck == "kiss you":
                            #If she's relatively inexperienced
                            $ TempLine = renpy.random.choice([
                        ...
                        $ TempLine = renpy.random.choice([
                                    "Your cock is so warm. . .",
                                    "I love the way it"+K_like+"feels in my hands.",
                                    "Seems like you like my hand, huh, " + R_Petname + "?",
                                    "I can feel you get harder in my hand. . .",
                                    ])
                    elif TempCheck == "blow":
                        if D20 <= 3:
                            ch_k "I hope you don't think I'm[K_like]a slut for saying this. . ."                                
                            $ TempLine = "but I love how you taste, " + K_Petname + "."
                        else:        
                            $ TempLine = renpy.random.choice([
                                        "So warm. . .",
                                        "You taste so good, " + K_Petname + ".",
                        ...
                        $ TempLine = renpy.random.choice([
                                    "Your cock is so warm. . .",
                                    "I can feel you between my breasts, " + K_Petname + ".",
                                    "I can feel you get harder in there. . ."              
                                    ])
                    elif TempCheck == "sex" or TempCheck == "anal":
                        if D20 <= 3 and TempCheck == "anal" and K_Loose <= 1:
                    ...
                    if not TempLine:
                        ...
                        if Primary == "Kitty":
                                $ TempLine = renpy.random.choice([
                                            ...
                                            "I think I just"+K_like+"discovered one of your other mutant powers, " + K_Petname + ".",
                                            "I like it."+K_Like+"a {i}lot{/i}.",
                                            "Oooh, that's it. . .",
                                            "More, gimme more!",
                                            "That look's so cute, " +K_Petname + "!",
                                            "I've never wanted a guy like I want you, " + K_Petname + "."
                                            ])
                        else:
                                $ TempLine = renpy.random.choice([
                                            "Don't take all the fun, " + ActiveGirl + ".",
                                            "I could use some attention over here, " + K_Petname + ".",
                                            "I got something over here for you, " + K_Petname + ".",
                                            ...
                                            "That looks like fun, " + ActiveGirl + "."
                                            ])
                                
            #End Kitty's dirty talk lines  
            if not TempLine:
                    if not ActiveGirl:
                            $ ActiveGirl = K_Petname
                    $ TempLine = renpy.random.choice([
                            "Mmmh. . .",
                            "Ung. . .",
                            "Ooooh. . .",
    ...
    elif (Primary == "Emma" and D20 in (2,3)) or (Secondary == "Emma" and Trigger4 and D20 == 4):
            #procs if she's prinary 2-3, or secondary 4
            ...
            if "vocal" not in E_Traits:
                    ...
                    #drops it down to the generic grunts
                    pass
            elif Trigger == "lesbian" or (Secondary == "Emma" and TempTrigger not in ("hand","blow","masturbation")):
                    #if this is a lesbian action, or if the threesome action is girl-focused  
                    
                    if "unseen" not in E_RecentActions and D20 <= 5:
                            #if they know you're watching, there is a 3/10 or 2/5 chance
                            $ TempLine = "Are you enjoying the performance, "+E_Petname+"?" #you watching
                            ...
                            if ActiveGirl == "Kitty":
                                ...
                                $ TempLine = "Such pressure, "+ActiveGirl+"." #fondle pussy   
                    elif TempTrigger == "lick pussy":                            
                            if ActiveGirl == "Laura":
                    ...
                    if "unseen" not in E_RecentActions:
                            ...
                            if D20 <= 3: 
                                ...
                                if "cockout" in P_RecentActions:
                                    # Your cock's out
                                    $ TempLine = renpy.random.choice([
                                                "Oh, I could use some of that, " + E_Petname + "?",
                                                "Why don't you join me over here, " + E_Petname + "?"
                                                ])
                                else:
                                    # Your cock's not out
                                    $ TempLine = renpy.random.choice([
                                                "Feeling shy, " + E_Petname + "?",
                                                "I feel like you aren't enjoying the show."
                                                ])
                            else:
                                    # It's over a 3 roll
                                    $ TempLine = renpy.random.choice([
                                                "I need you over here, " + E_Petname + ".",
                                                "Come here, " + E_Petname + ". Take me.",
                                                "I hope you're enjoying the show, "+E_Petname+".",    
                                                "I do love the look on your face, " + E_Petname + "."
                                                ])
                    #else: D20 >=15, drops to generic options
            else:
                    #if neither lesbian nor masturbation
                    ...
                    if D20 <= 10:
                            pass
                    elif E_SEXP <= 30 or TempCheck == "kiss you":
                            #If she's relatively inexperienced
                            $ TempLine = renpy.random.choice([
                        ...
                        $ TempLine = renpy.random.choice([
                                    ...
                                    "I take it you're enjoying yourself, " + E_Petname + "?",
                                    "I can feel you grow harder. . .",
                                    ])
                    elif TempCheck == "blow":
                        $ TempLine = renpy.random.choice([
                                    "So delicious. . .",
                                    "I must say, I enjoy the flavor, " + E_Petname + ".",
                                    "I can feel you get harder in my mouth. . .",
                                    "Mmhmhm. . .",
                                    "-gulp-. . .",                                    
                                    ])
                        ...
                        $ TempLine = renpy.random.choice([
                                    "Your cock is so warm. . .",
                                    "I can feel you between my breasts, " + E_Petname + ".",
                    ...
                    if not TempLine:
                        ...
                        if Primary == "Emma":
                                ...
                                $ TempLine = renpy.random.choice([
                                        "Oh " + E_Petname + "? Don't keep me waiting.",
                                        "Oh " + ActiveGirl + "? Could you share some of that?",
                                        "Come on over here, " + E_Petname + ", ravish me.",
                                        "You certainly do put on a show.",
                                        "You're simply adorable, " + E_Petname + ".",
                                        "Nngh, give it to her.",
                                        "You seem to be enjoying yourself, " + ActiveGirl + "."
                                        ])
            #End Emma's dirty talk lines  
            if not TempLine:
                    if not ActiveGirl:
                            $ ActiveGirl = E_Petname
                    $ TempLine = renpy.random.choice([
                            "Mmmh. . .",
                            "Ung. . .",
                            "Ooooh. . .",
    ...
    elif (Primary == "Laura" and D20 in (2,3)) or (Secondary == "Laura" and Trigger4 and D20 == 4):
            #procs if she's prinary 2-3, or secondary 4
                    
            if Primary == "Laura":
                        #if Laura is primary, Tempcheck is the Trigger variable
                        $ TempCheck = Trigger                
                        $ ActiveGirl = Secondary
                        $ TempTrigger = Trigger3
            else:
                        #if Laura is secondary, Tempcheck is the Trigger4 variable
                        $ TempCheck = Trigger4
                        $ ActiveGirl = Primary
                        $ TempTrigger = Trigger4   
                        
            $ D20 = renpy.random.randint(1, 20)
            if ApprovalCheck("Laura", 1500):
                $ D20 -= 5
            elif ApprovalCheck("Laura", 1200):
                $ D20 -= 3
            
            if "vocal" not in L_Traits:
                    if L_Lust >= 60:
                        pass
                    else:
                        return
                    ...
                    #drops it down to the generic grunts
                    pass
            elif Trigger == "lesbian" or (Secondary == "Laura" and TempTrigger not in ("hand","blow","masturbation")):
                    #if this is a lesbian action, or if the threesome action is girl-focused  
                    
                    if "unseen" not in L_RecentActions and D20 <= 5:
                            #if they know you're watching, there is a 3/10 or 2/5 chance
                            $ TempLine = "Looking good, "+L_Petname+"?" #you watching
                    elif TempTrigger == "fondle breasts":                            
                            if ActiveGirl == "Emma": 
                    ...
                    if "unseen" not in L_RecentActions:
                            ...
                            if D20 <= 3: 
                                ...
                                if "cockout" in P_RecentActions:
                                    ...
                                    # Your cock's not out
                                    $ TempLine = renpy.random.choice([
                                                "You aren't shy, are you " + L_Petname + "?",
                                                "Pants, lose'em."
                                                ])
                            else:
                                    # It's over a 3 roll
                                    $ TempLine = renpy.random.choice([
                                                "Get over here, " + L_Petname + ".",
                                                "Not enjoying the show, "+L_Petname+"?",    
                                                "Heh, the look on your face, " + L_Petname + "."
                                                ])
                    ...
                    if D20 <= 5:
                            pass
                    elif L_SEXP <= 30 or TempCheck == "kiss you":
                            #If she's relatively inexperienced
                            $ TempLine = renpy.random.choice([
                                    "You're good at this, " + L_Petname + ".",
                        ...
                        $ TempLine = renpy.random.choice([
                                    ...
                                    "Seems like you're having fun, " + L_Petname + "?",
                                    "You seem to be getting harder. . .",
                                    ])
                    elif TempCheck == "blow":
                        $ TempLine = renpy.random.choice([
                                    "Mmm, delicious. . .",
                                    "That's an interesting taste, " + L_Petname + ".",
                                    "Did you just get harder? . .",
                                    "-Slurp.-",
                                    "Mmhmhm. . .",
                                    "-gulp-. . .",                                    
                        ...
                        $ TempLine = renpy.random.choice([
                                    "Your cock is so warm. . .",
                                    "I can feel you between my breasts, " + L_Petname + ".",
                                    "I can feel you get harder in there. . ."              
                                    ])
                    elif TempCheck == "sex" or TempCheck == "anal":
                            $ TempLine = renpy.random.choice([
                    ...
                    if not TempLine:
                        ...
                        if Primary == "Laura":
                                $ TempLine = renpy.random.choice([
                                        "Wow, " + L_Petname + ".",
                                        "That's great, " + L_Petname + ".",                                        
                                        "Oooh, that's nice. . .",
                                        "More!",
                                        "You're great, " + L_Petname + ".",
                                        "Ok, that was a good one. . ."
                                        ])
                        else:
                                $ TempLine = renpy.random.choice([
                                        "Hey, " + L_Petname + "? Don't keep me waiting.",
                                        "Hey, " + ActiveGirl + "? Share, uh?",
                                        "Het over here, " + L_Petname + ".",
                                        "Well you certainly put on a show.",
                                        "You're looking hot, " + L_Petname + ".",
                                        "You're looking hot, " + ActiveGirl + ".",
                                        "Nngh, yeah, stick it to her.",
                                        "Well you seem to be having fun, " + ActiveGirl + "."
                                        ])
            #End Laura's dirty talk lines  
            if not TempLine:
                    if not ActiveGirl:
                            $ ActiveGirl = L_Petname
                    $ TempLine = renpy.random.choice([
                            "Mmmh. . .",
                            "Ung. . .",
                            "Ooooh. . .",
