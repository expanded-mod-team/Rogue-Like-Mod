...
image Emma_Doggy_Body:
    LiveComposite(                                                                                         #Upper body
        ...
        (0,0), ConditionSwitch(                                                                                 #tanktop
            ...
            "E_Chest == 'modded black corset'", "images/EmmaDoggy/Emma_Doggy_CorsetBlack.png",
            "True", Null(),            
            ), 
...
image Emma_Doggy_Ass = LiveComposite(                                                                                          #Lower body
        ...
        (0,0), ConditionSwitch(                                                                                 #Panties back
            ...
            "E_Panties == 'modded black panties'", "images/EmmaDoggy/Emma_Doggy_PantiesBlack_Back.png",
            ...
            #"E_Panties == 'lace panties' or E_Panties == 'modded black panties'", "images/EmmaDoggy/Emma_Doggy_Panties_Back.png",  
        ...
        (0,0), ConditionSwitch(                                                                                 #Panties back
            "not E_Hose", Null(),  
            "E_Hose == 'modded white thigh high'", "images/EmmaDoggy/Emma_Doggy_Legs_ThighHighWhite.png",
            "E_Hose == 'modded black thigh high'", "images/EmmaDoggy/Emma_Doggy_Legs_ThighHighBlack.png",
            "True", Null(),                     
            ), 
        (0,0), ConditionSwitch(                                                                                 #Wet look
        ...
        #    "R_Panties == 'green panties' and R_Wet > 1", "images/RogueDoggy/Rogue_Doggy_Undies_Down_Wet.png",
            ...
            "E_Panties == 'modded black panties'", "images/EmmaDoggy/Emma_Doggy_PantiesBlack_Down.png",
        ...
        #    "R_Panties == 'lace panties' or R_Panties == 'modded black panties'", "images/RogueDoggy/Rogue_Doggy_Panties_Down.png",  
            "True", Null(),                     
            ),  
        ...
        #    "E_Panties == 'green panties' and R_Wet", "images/RogueDoggy/Rogue_Doggy_Undies_Wet.png",          
            ...
            "E_Panties == 'modded black panties'", "images/EmmaDoggy/Emma_Doggy_PantiesBlack.png",
        ...
        #    "R_Panties == 'modded black panties'", "images/RogueDoggy/Rogue_Doggy_Panties.png", 
        ...
        (0,0), ConditionSwitch(                                                                                 #Legs Layer
            ...
            "E_Legs == 'modded black pants' and E_Upskirt", "images/EmmaDoggy/Emma_Doggy_Pants_Black_Down.png",            
            "E_Legs == 'modded black pants' and E_Wet > 1", "images/EmmaDoggy/Emma_Doggy_Pants_Black_Wet.png",
            "E_Legs == 'modded black pants'", "images/EmmaDoggy/Emma_Doggy_Pants_Black.png",
