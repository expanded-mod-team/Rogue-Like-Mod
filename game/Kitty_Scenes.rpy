            ...
            menu:
                ...
                "You were constantly tossing around.":            
                        ...
                        if K_Sleep < 5:
                            ...
                            call Statup("Kitty", "Love", 60, -8)
                            call Statup("Kitty", "Obed", 50, 22)
                            call Statup("Kitty", "Inbt", 50, 22)  
                        else:
                            ch_k "Yeah, well. . . you should be used to that!"
                "You need to learn to stick to your side.":  
                        if K_Sleep < 5:
                            call Statup("Kitty", "Love", 80, -8) 
...
label Kitty_MorningWood:
            ...
            ch_u "\"Slurp, slurp, slurp.\""
            call Statup("Player", "Focus", 80, 10)
            call Statup("Kitty", "Lust", 80, 5)
            $ Trigger = "blow"
            $ K_Eyes = "down"
            "You open your eyes. . ."
            ...
            $ Count = 3
            $ Line = 0
            call Seen_First_Peen("Kitty",0,1)
            while Count > 0:
                    #Looping portion
                    call Statup("Player", "Focus", 80, 10)
                    call Statup("Kitty", "Lust", 80, 5)
...
label Kitty_BF:
    ...
    if K_Loc != bg_current:
        ...
        if "Kitty" not in Party:
            ...
            "Kitty turns towards you and asks if the two of you can talk."
    ...
    if len(P_Harem) >= 2:
        ch_k "I know you[K_like]really get around and all. . ."
    elif "Rogue" in P_Harem: 
        if "dating?" in K_Traits:    
            ...
            ch_k "I know you're kinda[K_like]dating [P_Harem[0]] and all. . ."
    ...
    menu: 
        ...
        "I'm with someone else now." if P_Harem:             
            ...
            menu:
                extend ""
                "Yes. Absolutely." if "KittyYes" in P_Traits:
                    call Statup("Kitty", "Love", 200, 30)
                    "Kitty wraps her arms around you and starts kissing you passionately."
                    call KittyFace("kiss") 
                    call K_Kissing_Launch("kiss you")
...
label Kitty_BF_Jerk:
    ...
    call Statup("Kitty", "Obed", 50, 40)
    if K_Event[5] != 20:
            call Statup("Kitty", "Obed", 200, (20* K_Event[5]))
    if 20 > K_Event[5] >= 3:
            call KittyFace("sad")
    ...
    if K_Event[5] != 20:
            call Statup("Kitty", "Love", 200, -(50* K_Event[5]))
    else:
        ...
        "Listen. . . I know it's what you want. Do you want to try again, or not?":
                ...
                if "sir" in K_Petnames:
                    if ApprovalCheck("Kitty", 850, "O"): 
                        ...
                        ch_k "But I still think you should[K_like] apologize for being a jerk to me."
                        menu:
                            extend ""
...
label Kitty_Sexfriend:  
    ...
    if not Line:            
            ...
            ch_k "[K_like]we could take our relationship a little further, if you wanted to."
            menu:
                extend ""
    ...
    if Line == "rude":    
            ...
            "Kitty leans in and passes her hand across your body."
...
label Kitty_Daddy:      
    ...
    if "dating" in K_Traits:
        ...
        ch_k "Hey, so[K_like]we've been hanging out," 
    ...
    ch_k "So[K_like]I was thinking, could I call you. . . \"daddy?\""  
    menu:
        extend ""
        "Ok, go right ahead?":            
            call KittyFace("smile") 
        ...
        "What do you mean by that?": 
            ...
            menu:
                ...
                "Sounds interesting, fine by me.":     
                    call KittyFace("smile") 
                    call Statup("Kitty", "Love", 90, 17)          
                    call Statup("Kitty", "Obed", 60, 20)            
                    call Statup("Kitty", "Inbt", 80, 25) 
                    ch_k "Nice! . . daddy."  
                    $ K_Petname = "daddy"
...
label Kitty_Cheated(Other = "Rogue", Resolution = 0, B = 0):  #Other is the other girl, Resolution is Resolution count, you want this over 2 at least. B is the bonus modifier
    ...
    if Other == "Rogue":
        ...
        if K_LikeEmma >= 900:
            ...
            $ Resolution += 1
        $ B = int((K_LikeEmma - 500)/2)
    elif Other == "Laura":
        if K_LikeLaura >= 900:
            $ Resolution += 2
        elif K_LikeLaura >= 800:
            $ Resolution += 1
        $ B = int((K_LikeLaura - 500)/2)
    
    $ Resolution -= K_Cheated if K_Cheated <= 3 else 3 #Adds to Resolution 3 or less based on cheating
    
    if K_Cheated:
        call Statup("Kitty", "Love", 200, -50) 
        call Statup("Kitty", "Obed", 80, -25)
        call Statup("Kitty", "Inbt", 50, -50)   
    else:
        call Statup("Kitty", "Love", 200, -120) 
        call Statup("Kitty", "Obed", 80, -30)
        call Statup("Kitty", "Inbt", 50, -20)  
    ...
    if not Line:
            ...
            call KittyFace("angry",2)
            ch_k "I {i}saw{/i} you and [Other]! I can't[K_like]believe you'd do that, [K_Petname]."
                                ...
                                menu:
                                    ...
                                    "You weren't wrong, [K_Pet].":
                                            ...
                                            menu:
                                                ...
                                                "[K_Like]really.":
                                                        call KittyFace("embarrassed")
                                                        ch_k "Then. . .[K_like]why did you do that with {i}[Other]?{/i} You had to know that would[K_like]hurt me."
                                                        menu:
                                                            extend ""
    ...
    if Line == "maybe":
            ...
            if ApprovalCheck("Kitty", 1250):
                    ...
                    ch_p "Thought about what it might be like if we invited [Other] into what we have together."                 
                    if ApprovalCheck("Kitty", 1500) and Resolution >= 3:
                            ...
                            ch_k "Assuming I'm interested. . . how're you going to convince [Other]?"
            ...
            if Line:
                    ...
                    call KittyFace("angry")
                    ch_k "So, you're telling me[K_like]you being with [Other] like that was your way of seeing if I'd be up for a threesome?"
        ...
        if Other == "Rogue" and K_LikeRogue >= 800:
                ...
                $ K_Traits.append("poly Rogue")
                $ K_Traits.append("ask Rogue")   
        elif Other == "Emma" and K_LikeEmma >= 800:
                call Statup("Kitty", "Inbt", 80, 25)   
                ch_k "Well, maybe Emma and I can work something out. . ."                            
                $ K_Traits.append("poly Emma")
                $ K_Traits.append("ask Emma")   
        elif Other == "Laura" and K_LikeLaura >= 800:
                call Statup("Kitty", "Inbt", 80, 25)   
                ch_k "Well, maybe Laura and I can work something out. . ."                            
                $ K_Traits.append("poly Laura")
                $ K_Traits.append("ask Laura")                
    ...
    if "saw with Rogue" in K_Traits: 
            ...
            if "poly Rogue" not in K_Traits:
                $ K_LikeRogue -= 50
    elif "saw with Emma" in K_Traits: 
            #Clean up the trait for this event
            $ K_Traits.remove("saw with Emma")
            if "poly Emma" not in K_Traits:
                $ K_LikeEmma -= 50
    elif "saw with Laura" in K_Traits: 
            #Clean up the trait for this event
            $ K_Traits.remove("saw with Laura")
...
label Kitty_Yoink(Girl=0,TempBonus=0,Over=0,Chest=0,Legs=0,Panties=0,Hose=0,Shy=0):  
    ...
    if GirlLikeCheck("Kitty",Girl) <= 200:
            $ TempBonus = 400
    elif GirlLikeCheck("Kitty",Girl) <= 400:
            $ TempBonus = 200
    elif GirlLikeCheck("Kitty",Girl) >= 800 or ApprovalCheck(Girl, 500, "I", TabM=3):
    ...
    menu:
        "Hey Kitty, why don't you snag [Girl]'s. . ."
        ". . . [Over]?" if Over:
                if Chest:
                        #if she has a bra on under it
                        $ Shy = 2
                        if ApprovalCheck("Kitty", 800, TabM=2, Bonus=TempBonus): 
                            #+800 check in standard taboo
                            #she's in
                            $ Line = "over"
                        elif ApprovalCheck("Kitty", 600, TabM=2, Bonus=TempBonus):
                        ...
                        $ Shy = 3
                        if ApprovalCheck("Kitty", 800, TabM=2.5, Bonus=(TempBonus*1.5)):
                            $ Line = "over"
                        elif ApprovalCheck("Kitty", 600, TabM=1.5, Bonus=TempBonus):
                            $ Line = "no"
                        else:
                            $ Line = "noway"
        ...
        ". . . [Chest]?" if Chest:
                if Over:
                        ...
                        $ Shy = 1
                        if ApprovalCheck("Kitty", 1200, TabM=1, Bonus=TempBonus): 
                            #+800 check in standard taboo
                            #she's in
                            $ Line = "chest"
                        elif ApprovalCheck("Kitty", 600, TabM=0.5, Bonus=TempBonus):
                            #she says no, but not mad
                            $ Line = "no"
                        else:
                            #she's mad
        ...
        ". . . [Legs]?" if Legs:
                if Panties or HoseNum(Girl) >= 10:
                        #if she has panties or tights on under it
                        $ Shy = 2
                        if ApprovalCheck("Kitty", 1000, TabM=2, Bonus=TempBonus): 
                            #+800 check in standard taboo
                            #she's in
                            $ Line = "legs"
                        elif ApprovalCheck("Kitty", 800, TabM=2, Bonus=TempBonus):
                            #she says no, but not mad
                            $ Line = "no"
                        else:
                            #she's mad
                        ...
                        $ Shy = 3
                        if ApprovalCheck("Kitty", 1000, TabM=2.5, Bonus=(TempBonus*1.5)):
                            $ Line = "legs"
                        elif ApprovalCheck("Kitty", 800, TabM=1.5, Bonus=TempBonus):
                            $ Line = "no"
                        else:
                            $ Line = "noway"
                            
        ". . . [Panties]?" if Panties:
                if Legs or HoseNum(Girl) >= 10:
                        #if she has legs or tights on over it
                        $ Shy = 1
                        if ApprovalCheck("Kitty", 1000, TabM=1, Bonus=TempBonus): 
                            #+800 check in standard taboo
                            #she's in
                            $ Line = "panties"
                        elif ApprovalCheck("Kitty", 800, TabM=0.5, Bonus=TempBonus):
                            #she says no, but not mad
                            $ Line = "no"
                        else:
                            #she's mad
        ...
        ". . . [Hose]?" if Hose:
                if Legs:
                        ...
                        $ Shy = 1
                        if ApprovalCheck("Kitty", 800, TabM=1, Bonus=TempBonus): 
                            #+800 check in standard taboo
                            #she's in
                            $ Line = "hose"
                        elif ApprovalCheck("Kitty", 800, TabM=0.5, Bonus=TempBonus):
                            ...
                            #she's mad
                            $ Line = "noway"
                elif Panties and HoseNum(Girl) >= 10:
    ...
    if Line == "no":
            ...
            call Statup("Kitty", "Love", 90, -(Shy))   
            ch_k "I really couldn't do that to her."
            return
    if Line == "noway":
            call AnyFace("Kitty","angry",1)      
            call Statup("Kitty", "Love", 90, -(2*Shy))        
            call Statup("Kitty", "Obed", 60, -(Shy))    
            ch_k "How could you[K_like]even {i}consider{/i} something like that?"
            return
    #else, she agrees. . .
               
    call Statup("Kitty", "Obed", 70, Shy) 
    call Statup("Kitty", "Inbt", 80, Shy)     
    "Kitty sneaks up behind [Girl]. . ."
    ...
    if Line == "over":
                ...
                "She reaches out and snags [Girl]'s [Over], tugging it through her body."
                ...
                if Girl == "Rogue":
                    ...
                    if not Over:
                            call Laura_First_Topless(1)
                if Over:
                    "She reaches through [Girl]'s [Over] and snags her [Chest]."
                else:
                    "She reaches out and snags [Girl]'s [Chest], tugging it free."
            
    elif Line == "legs":
                $ Line = Legs
                if Girl == "Rogue":
                    $ R_Legs = 0
                    if not Panties and HoseNum(Girl) < 10:
                ...
                "She reaches down and snags [Girl]'s [Legs], tugging them through her body."
            
    elif Line == "panties":
                $ Line = Panties
                if Girl == "Rogue":
                    $ R_Panties = 0
                    if not Legs and HoseNum(Girl) < 10:
                            call Rogue_First_Bottomless(1)
                elif Girl == "Emma":
                    $ E_Panties = 0
                    if not Legs and HoseNum(Girl) < 10:
                    ...
                    if not Legs and HoseNum(Girl) < 10:
                            call Laura_First_Bottomless(1)
                if Legs:
                    "She reaches down through [Girl]'s [Legs] and snags her [Panties]."
                elif Hose:
                    "She reaches down through [Girl]'s [Hose] and snags her [Panties]."
                else:
                    "She reaches out and snags [Girl]'s [Panties], tugging them free."
    elif Line == "hose":
                $ Line = Hose
                if Girl == "Rogue":
                    $ R_Hose = 0    
                    if not Legs and not Panties:
                            call Rogue_First_Bottomless(1)
                elif Girl == "Emma":
                    $ E_Hose = 0    
                    if not Legs and not Panties:
                    ...
                    if not Legs and not Panties:
                            call Laura_First_Bottomless(1)
                if Legs:
                    "She reaches down through [Girl]'s [Legs] and snags her [Hose]."
                else:
                    "She reaches out and snags [Girl]'s [Hose], tugging them free."
    
    "She then dashes back a few steps, slipping the [Line] behind her back."
    
    call Activity_Check(0,Girl,1,0,2) #Girl=0,Girl2=Girl,Silent=1,Removal=0,ClothesCheck=2)    
    $ Approval = _return
    
    $ K_DailyActions.append("yoink")
    if "yoink" not in K_History:
            $ K_History.append("yoink")
            
    if Girl == "Rogue":
            if "exhibitionist" in R_Traits:   
                $ Approval = 2
            $ R_DailyActions.append("yoink")
    elif Girl == "Emma":
            if "exhibitionist" in E_Traits:   
                $ Approval = 2
            $ E_DailyActions.append("yoink")
    elif Girl == "Laura":
            if "exhibitionist" in L_Traits:   
                $ Approval = 2
            $ L_DailyActions.append("yoink")
    ...
    if Shy <= 1:
            ...
            if Approval >= 2:  
                    ...
                    call Statup(Girl, "Inbt", 80, Shy)  
                    call Statup(Girl, "Lust", 80, 2) 
                    "[Girl] glances back in surprise, but then breaks into a quick smile."
            elif Approval: 
                    #this girl's annoyed
                    call AnyFace(Girl,"angry",1)
                    call Statup(Girl, "Love", 90, -(Shy)) 
                    "[Girl] glances back in surprise, and then glances over at you with a glare."
            else:
            ...
            if Approval >= 2: 
                    ...
                    call Statup(Girl, "Inbt", 80, Shy)  
                    call Statup(Girl, "Lust", 80, 2*Shy) 
                    "[Girl] glances back in surprise, but then breaks into a quick smile."
    ...
    if Approval:
            call GirlLikesGirl(Girl,"Kitty",900,(2*Shy),1)
            call GirlLikesGirl("Kitty",Girl,900,(2*Shy),1)
    else:
    ...
    if TempBonus > 0:
            if Approval < 2: 
                ...
                "Kitty smiles triumphantly."
            else:
                #she didn't like the girl, but the girl was fine
                call AnyFace("Kitty","angry",Eyes="side")
                "Kitty seems a bit annoyed at [Girl]'s attitude."
            
    elif not Approval:
                #she liked the girl well enough, but drove her off
                call AnyFace("Kitty","sly")
                call Statup("Kitty", "Lust", 80, Shy) 
                "Kitty seems a bit uncertain about the whole thing."
    else:
                #she liked the girl well enough, and the girl was fine
                call AnyFace("Kitty","sly")
                call Statup("Kitty", "Love", 80, 1) 
                call Statup("Kitty", "Lust", 80, Shy) 
                "Kitty laughs under her breath and waggles the [Line] at you."
    return
