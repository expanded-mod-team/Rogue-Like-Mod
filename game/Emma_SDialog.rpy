...
label Emma_SexDialog(TempLine = 0, TempLust = 0, TempLust2 = 0):
    ...
    #End Handy dialog ////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            if not Speed:
                        if E_Tit > 2:
                            ...
                            $ Line = "Emma squeezes her breasts together and slowly moves them along your shaft"
                        $ Speed = 1
            ...
            if E_Tit > 4 and E_Blow:                                        #5th+ and blown
                        if Speed <= 1:                                              #slow
                            ...
                            $ Line = renpy.random.choice(["Emma rapidly rocks her breasts up and down around your cock", 
                                    ...
                                    "Emma dances her nipples across the shaft",
    ...
    # end E_Blowjob                                 //////////////////////////////////////////////////////////////////////////////
            ...
            if not Speed: #if Emma is not moving   
                    $ Line = "She slowly slides her pussy against your cock. . "
                    return
    ...
    # end E_Hotdog                                 //////////////////////////////////////////////////////////////////////////////
            ...
            if not Speed:
                ...
                return
                    ...
                    $ Line = "Emma continues to slide your cock deep inside her. "      
            else: 
...
label Emma_SexDialog_Threeway(Mode = 0, Action = 0, ActiveGirl = Primary, TempLine = 0, TempLust = 0, TempLust2 = 0, TempFocus = 0):
    ...
    # end E_Hand Threeway                                //////////////////////////////////////////////////////////////////////////////
                    ...
                    if Speed > 2 and Trigger == "blow":
                        ...
                        if D20S <= 8 and (Trigger == "blow" or Trigger == "hand"): #This is a random bonus dialog
                            ...
                            $ TempLust2 += 1 if GirlLikeCheck(ActiveGirl,"Emma") >= 800 else 0                                                         
                        else:
    ...
    # end E_Blowjob Threeway                                //////////////////////////////////////////////////////////////////////////////
                        ...
                        $ TempLust2 += 5 if GirlLikeCheck(ActiveGirl,"Emma") >= 800 else 2
                        $ TempFocus += 1 
    # end E Fondle breasts Threeway                                //////////////////////////////////////////////////////////////////////////////
                        ...
                        $ TempLust += 2 if ApprovalCheck("Emma", 500, "I") else 1  # Emma's lust
                        $ TempLust2 += 4 if GirlLikeCheck(ActiveGirl,"Emma") >= 800 else 2
                        $ TempFocus += 1                      
    # end E Suck breasts Threeway                                //////////////////////////////////////////////////////////////////////////////
                        ...
                        $ TempLust += 2 if ApprovalCheck("Emma", 500, "I") else 1  # Emma's lust
                        $ TempLust2 += 5 if GirlLikeCheck(ActiveGirl,"Emma") >= 800 else 3
                        $ TempFocus += 1  
    ...
    # end E fondle pussy Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        $ TempLust2 += 7 if GirlLikeCheck(ActiveGirl,"Emma") >= 800 else 4
                        $ TempFocus += 3  
    ...
    # end E lick pussy Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        $ TempLust2 += 3 if GirlLikeCheck(ActiveGirl,"Emma") >= 800 else 1
                        $ TempFocus += 1  
    # end E fondle ass Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        if ActiveGirl == "Rogue" and not R_Loose:
                                        $ TempLust2 -= 3
                        elif ActiveGirl == "Kitty" and not K_Loose:
                                        $ TempLust2 -= 3
                        $ TempFocus += 1  
    ...
    # end E Masturbation Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        $ TempLust += 1 if ApprovalCheck("Emma", 500, "I") else 0  # Emma's lust
                        $ TempLust += 1 if GirlLikeCheck("Emma",ActiveGirl) >= 800 else 0
                        $ TempLust2 += 2 if GirlLikeCheck(ActiveGirl,"Emma") >= 800 else 1 
                        $ TempFocus += 1  
    # end E Kissing Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        $ TempLust += 1 if GirlLikeCheck("Emma",ActiveGirl)  >= 600 else 0  # Emma's lust
                        $ TempLust += 2 if GirlLikeCheck("Emma",ActiveGirl)  >= 800 else 1  # Emma's lust
...
label Emma_Threeway_Set(Preset = 0, Mode = 0, Action = Trigger4, ActiveGirl = Primary, State = "watcher", TempLust = 0, TempLust2 = 0, TempFocus = 0):
            ...
            if Trigger == "lesbian":
                    ...
                    if Preset in ("hand","blow","kiss you","kiss both"):
                            ...
                            pass
                    elif GirlLikeCheck("Emma",ActiveGirl) >= 600 and ApprovalCheck("Emma", 500, "I"):
                            pass
                    else:
                    ...
                    pass
            elif GirlLikeCheck("Emma",ActiveGirl) >= 600 and ApprovalCheck("Emma", (1500-(10*E_Les)-(10*(GirlLikeCheck("Emma",ActiveGirl)-60)))): 
                    #If she likes both of you a lot, threeway
                    $ State = "threeway"
            elif ApprovalCheck("Emma", 1000): 
                    #If she likes you well enough, Hetero
                    $ State = "hetero"            
            elif GirlLikeCheck("Emma",ActiveGirl) >= 700: 
            ...
            if State == "lesbian" or State == "threeway":
                ...
                if ApprovalCheck("Emma", 800, "I") or GirlLikeCheck("Emma",ActiveGirl) >= 700:
                    $ Options.append("lick pussy")
                if ApprovalCheck("Emma", 900, "I") and GirlLikeCheck("Emma",ActiveGirl) >= 800:
...
#                                $ Options.append("vibrator") 
            ...
            if Preset:
                if Preset in Options:
                        ...
                        $ Options[0] = Preset 
                        ch_e "Oh, very well. . ."
                elif ApprovalCheck("Emma", 700, "I") or ApprovalCheck("Emma", 1500):
...
#                        call RThreewayPussy_Launch #Launches position change
                        ...
                        $ TempLust2 += 3 if GirlLikeCheck("Emma",ActiveGirl) >= 600 else 1
                        $ TempFocus += 1  
