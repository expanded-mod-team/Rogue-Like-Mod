...
image Emma_Sprite_BG:
    LiveComposite(
        ...
        (0,0), ConditionSwitch(
            ...
            "'modded' in persistent.E_BG_Over", GetModdedString("images/EmmaSprite/EmmaSprite_Over_", persistent.E_BG_Over, "_Back.png"),
        ...
        (0,0), ConditionSwitch(
            ...
            "'modded' in persistent.E_BG_Panties", GetModdedString("images/EmmaSprite/EmmaSprite_Panties_", persistent.E_BG_Panties, "_DownBack.png"),
            "persistent.E_BG_Panties == 'sports panties'", "images/EmmaSprite/EmmaSprite_Panties_Sports_DownBack.png",   
            "persistent.E_BG_Panties == 'bikini bottoms'", "images/EmmaSprite/EmmaSprite_Panties_Bikini_DownBack.png",  
        ...
        (0,0), ConditionSwitch(
            ...
            "'modded' in persistent.E_BG_Hose", GetModdedString("images/EmmaSprite/EmmaSprite_Hose_", persistent.E_BG_Hose, ".png"),
            "persistent.E_BG_Hose == 'stockings'", "images/EmmaSprite/EmmaSprite_Stockings.png",   
            "persistent.E_BG_Hose == 'stockings and garterbelt'", "images/EmmaSprite/EmmaSprite_StockingsGarter.png",   
            "persistent.E_BG_Hose == 'garterbelt'", "images/EmmaSprite/EmmaSprite_Garter.png",   
            "True", Null(), 
            ), 
        (0,0), ConditionSwitch(
            ...
            "not persistent.E_BG_Panties or not persistent.E_BG_PantiesDown or (persistent.E_BG_Legs == 'pants' and not persistent.E_BG_Upskirt)", Null(), 
            "not persistent.E_BG_Panties", Null(), 
            "'modded' in persistent.E_BG_Panties and E_Wet", GetModdedString("images/EmmaSprite/EmmaSprite_Panties_", persistent.E_BG_Panties, "_DownWet.png"),
            "'modded' in persistent.E_BG_Panties", GetModdedString("images/EmmaSprite/EmmaSprite_Panties_", persistent.E_BG_Panties, "_Down.png"),
            "persistent.E_BG_Panties == 'sports panties' and E_Wet", "images/EmmaSprite/EmmaSprite_Panties_Sports_DownWet.png",  
...
#            "E_Wet", "images/EmmaSprite/EmmaSprite_Panties_Wet.png", #readd when sprite works 
        ...
        (0,0), ConditionSwitch(
            # pantyhose
            "persistent.E_BG_Hose == 'pantyhose' and not E_PantiesDown", "images/EmmaSprite/EmmaSprite_Hose.png",   
            "True", Null(),        
            ),  
        (0,0), ConditionSwitch(
            #pants    
            ...
            "persistent.E_BG_Upskirt", ConditionSwitch(                   
                        ...
                        "'modded' in persistent.E_BG_Legs", GetModdedString("images/EmmaSprite/EmmaSprite_Legs_", persistent.E_BG_Legs, "_Down.png"),
                        "persistent.E_BG_Boots", Null(),
                        "persistent.E_BG_Legs == 'pants'", "images/EmmaSprite/EmmaSprite_Pants_Down.png",   
                        "persistent.E_BG_Legs == 'yoga pants'", "images/EmmaSprite/EmmaSprite_Pants_Yoga_Down.png",   
                        "True", Null(),
                        ),                    
            "True", ConditionSwitch(                
                    #if it's the ring pericings
                    "persistent.E_BG_Wet", ConditionSwitch(   
                        #if she's not wet
                        "'modded' in persistent.E_BG_Legs", GetModdedString("images/EmmaSprite/EmmaSprite_Legs_", persistent.E_BG_Legs, "_Wet.png"),
                        "persistent.E_BG_Legs == 'pants'", "images/EmmaSprite/EmmaSprite_Pants.png",   
                        "persistent.E_BG_Legs == 'yoga pants'", "images/EmmaSprite/EmmaSprite_Pants_YogaWet.png",       
                        "persistent.E_BG_Legs == 'skirt'", "images/EmmaSprite/EmmaSprite_Skirt.png", 
                        "True", Null(),
                        ),
                    "True", ConditionSwitch(   
                        #if she's wet
                        "'modded' in persistent.E_BG_Legs", GetModdedString("images/EmmaSprite/EmmaSprite_Legs_", persistent.E_BG_Legs, ".png"),
                        "persistent.E_BG_Legs == 'pants'", "images/EmmaSprite/EmmaSprite_Pants.png",   
                        "persistent.E_BG_Legs == 'yoga pants'", "images/EmmaSprite/EmmaSprite_Pants_Yoga.png",       
                        "persistent.E_BG_Legs == 'skirt'", "images/EmmaSprite/EmmaSprite_Skirt.png", 
                        "True", Null(),
                        ),                    
                    ),    
        ...
        (0,0), ConditionSwitch(
            #boots    
            "not persistent.E_BG_PantiesDown and persistent.E_BG_Boots == 'thigh boots'", "images/EmmaSprite/EmmaSprite_Boots.png",    
            "True", Null(), 
            ),     
        (0,0), ConditionSwitch(
            #clothed lower piercings         
            "persistent.E_BG_Legs == 'skirt'", Null(),
            "persistent.E_BG_Pierce == 'barbell'", ConditionSwitch(   
                    #if it's the barbell pericings 
                    "persistent.E_BG_Legs and not persistent.E_BG_Upskirt", "images/EmmaSprite/EmmaSprite_Pierce_Pussy_BarOut.png",  
                    "persistent.E_BG_Panties and not persistent.E_BG_PantiesDown", "images/EmmaSprite/EmmaSprite_Pierce_Pussy_BarOut.png", 
                    "True", Null(),
                    ),    
            "persistent.E_BG_Pierce == 'ring'", ConditionSwitch(   
                    #if it's the ring pericings
                    "persistent.E_BG_Legs and not persistent.E_BG_Upskirt", "images/EmmaSprite/EmmaSprite_Pierce_Pussy_RingOut.png",  
                    "persistent.E_BG_Panties and not persistent.E_BG_PantiesDown", "images/EmmaSprite/EmmaSprite_Pierce_Pussy_RingOut.png", 
                    "True", Null(),
                    ),
            "True", Null(), 
            ),    
        (0,0), ConditionSwitch(
            ...
            "'modded' in persistent.E_BG_Chest and not persistent.E_BG_Uptop", GetModdedString("images/EmmaSprite/EmmaSprite_Chest_", persistent.E_BG_Chest, "_Under.png"),
            "persistent.E_BG_Chest == 'sports bra' and not persistent.E_BG_Uptop", "images/EmmaSprite/EmmaSprite_Bra_Sports_Under.png",   
            ...
            "persistent.E_BG_Chest == 'bikini top'", "images/EmmaSprite/EmmaSprite_Bra_Bikini_Under.png",   
            "True", Null(),              
            ), 
        (0,0), ConditionSwitch(
            #Over underlayer
        ...
        (0,0), ConditionSwitch(
            ...
            "True", "images/EmmaSprite/EmmaSprite_Water_Arms2.png", #if persistent.E_BG_Arms == 1      
            ), 
        (0,0), ConditionSwitch(
            #gloves 
        ...
        (0,0), ConditionSwitch(                                                                         
            ...
            "not persistent.E_BG_Uptop or persistent.E_BG_Over != 'jacket'", Null(),  
            "Emma_Arms == 2", "images/EmmaSprite/EmmaSprite_Jacket_2Arm_Up.png",              
            "True", "images/EmmaSprite/EmmaSprite_Jacket_1Arm_Up.png",   
            ), 
        (0,0), ConditionSwitch(
            #tits
            "Emma_Arms == 1", "images/EmmaSprite/EmmaSprite_TitsUp.png",   # persistent.E_BG_TitsUp = 1
            "persistent.E_BG_Chest in ('corset','lace bra','sports bra','bikini top') or persistent.E_BG_Chest in ('modded black corset','modded red sports bra','modded white sports bra', 'modded NewX', 'modded NewX black')", "images/EmmaSprite/EmmaSprite_TitsUp.png",   # persistent.E_BG_TitsUp = 1
            #"persistent.E_BG_Chest in ('modded black corset','modded red sports bra','modded white sports bra', 'modded NewX', 'modded NewX black')", "images/EmmaSprite/EmmaSprite_TitsUp.png",   # persistent.E_BG_TitsUp = 1
...
#                    "persistent.E_BG_Chest == 'sports bra'", "images/EmmaSprite/EmmaSprite_Pierce_Up_Ring.png", 
        ...
        (0,0), ConditionSwitch(                          
            #neck
            "not persistent.E_BG_Neck", Null(),
            "'modded' in persistent.E_BG_Neck", GetModdedString("images/EmmaSprite/EmmaSprite_Neck_", persistent.E_BG_Neck, ".png"),
        ...
        (0,0), ConditionSwitch(
            #Water effect 
            "not persistent.E_BG_Water", Null(),             
            "Emma_Arms == 1 or persistent.E_BG_Chest == 'corset'", "images/EmmaSprite/EmmaSprite_Water_TitsUp.png",  
            "True", "images/EmmaSprite/EmmaSprite_Water_TitsDown.png", #if persistent.E_BG_Arms == 1      
            ), 
        (0,0), ConditionSwitch(                                                                         #Chest layer
            "persistent.E_BG_Uptop and persistent.E_BG_Chest", ConditionSwitch(   
                            #if her top is up. . .
                            "persistent.E_BG_Chest == 'sports bra'", "images/EmmaSprite/EmmaSprite_Bra_Sports_Up.png",   
                            "persistent.E_BG_Chest == 'lace bra'", "images/EmmaSprite/EmmaSprite_Bra_Lace_Up.png",   
                            "persistent.E_BG_Chest == 'bikini top'", "images/EmmaSprite/EmmaSprite_Bra_Bikini_Up.png",      
                            "persistent.E_BG_Chest == 'corset'", "images/EmmaSprite/EmmaSprite_CorsetTits_Up.png",  
                            "True", Null(), 
                            ),    
            "not persistent.E_BG_Chest", Null(),
            "persistent.E_BG_Chest == 'modded black corset' and persistent.E_BG_Over", "images/EmmaSprite/EmmaSprite_Chest_modded black corset_TitsX.png",   
            "'modded' in persistent.E_BG_Chest", GetModdedString("images/EmmaSprite/EmmaSprite_Chest_", persistent.E_BG_Chest, ".png"),
            ...
            "persistent.E_BG_Chest == 'bikini top'", "images/EmmaSprite/EmmaSprite_Bra_Bikini.png",   
...
#            ),
        (0,0), ConditionSwitch(                                                                         #cape layer       
            ...
            "persistent.E_BG_Chest == 'modded black corset'", "images/EmmaSprite/EmmaSprite_Chest_modded black corset_cape1.png",
        ...
        (0,0), ConditionSwitch(                                                                         #Overshirt layer       
            ...
            "Emma_Arms == 2", ConditionSwitch(   
                    ...
                    "persistent.E_BG_Uptop", ConditionSwitch(   
                                    "persistent.E_BG_Chest in ('corset','lace bra','sports bra','bikini top') or persistent.E_BG_Chest in ('modded black corset','modded red sports bra','modded white sports bra', 'modded NewX', 'modded NewX black')", ConditionSwitch(   
                                            #If she's wearing a supporting bra. . .
                                            "persistent.E_BG_Over == 'jacket'", "images/EmmaSprite/EmmaSprite_Jacket_2Up_Up.png",  
                                            "persistent.E_BG_Over == 'nighty'", "images/EmmaSprite/EmmaSprite_Nighty_Up2_Up.png",   
                                            "True", Null(), 
                                            ),  
                                    #if she's not wearing a supporting bra. . .
                                    "persistent.E_BG_Over == 'jacket'", "images/EmmaSprite/EmmaSprite_Jacket_2Down_Up.png",  
                                    "persistent.E_BG_Over == 'nighty'", "images/EmmaSprite/EmmaSprite_Nighty_Up2_Up.png", 
                                    "True", Null(), 
                                    ),    
                    #if not Uptop. . .
                    "persistent.E_BG_Chest in ('corset','lace bra','sports bra','bikini top') or persistent.E_BG_Chest in ('modded black corset','modded red sports bra','modded white sports bra', 'modded NewX', 'modded NewX black')", ConditionSwitch(   
                            #If she's wearing a supporting bra. . .
                            "'modded' in persistent.E_BG_Over", GetModdedString("images/EmmaSprite/EmmaSprite_Over_", persistent.E_BG_Over, "_2Up.png"),
                            "persistent.E_BG_Over == 'jacket'", "images/EmmaSprite/EmmaSprite_Jacket_2Up.png",  
                            "persistent.E_BG_Over == 'nighty'", "images/EmmaSprite/EmmaSprite_Nighty_2Up.png",      
                            "persistent.E_BG_Over == 'towel'", "images/EmmaSprite/EmmaSprite_Towel_Up2.png",  
                            "True", Null(), 
                            ),  
                    #if she's not wearing a supporting bra. . .
                    "'modded' in persistent.E_BG_Over", GetModdedString("images/EmmaSprite/EmmaSprite_Over_", persistent.E_BG_Over, "_2Down.png"),
                    "persistent.E_BG_Over == 'jacket'", "images/EmmaSprite/EmmaSprite_Jacket_2Down.png",  
                    "persistent.E_BG_Over == 'nighty'", "images/EmmaSprite/EmmaSprite_Nighty_2Down.png",      
                    "persistent.E_BG_Over == 'towel'", "images/EmmaSprite/EmmaSprite_Towel_Down2.png",  
                    "True", Null(), 
                    ),   
            #if her arms are up, preventng her breasts from sinking
            "persistent.E_BG_Uptop", ConditionSwitch(   
                            #if her top is up. . .
                            "persistent.E_BG_Over == 'jacket'", "images/EmmaSprite/EmmaSprite_Jacket_1Up_Up.png",  
                            "persistent.E_BG_Over == 'nighty'", "images/EmmaSprite/EmmaSprite_Nighty_Up1_Up.png",   
                            "True", Null(), 
                            ),    
            #if her top is not up. . .
            "'modded' in persistent.E_BG_Over", GetModdedString("images/EmmaSprite/EmmaSprite_Over_", persistent.E_BG_Over, "_1Up.png"),
        ...
        (0,0), ConditionSwitch(                                                                         #clothed peircings        
            "not persistent.E_BG_Pierce or persistent.E_BG_Uptop or (not persistent.E_BG_Over and not persistent.E_BG_Chest)", Null(),  
            "persistent.E_BG_Pierce == 'barbell'", ConditionSwitch(   
                    #if it's the barbell pericings
...
label Define_Outfit_BG:
    ...
    default persistent.E_BG_Arms = "modded black gloves"                  #her gloves
    default persistent.E_BG_Neck = "modded NewX black"
    default persistent.E_BG_Legs = 0
    default persistent.E_BG_Over = "modded black cape"    
    default persistent.E_BG_Chest = "modded black corset"    
    ...
    default persistent.E_BG_Panties = "modded black panties"
    ...
    default persistent.E_BG_Uptop = 0
