...
label Mystique_Chat:
    ...
    menu:
        ...
        "Show me the plug." if newgirl["Mystique"].Plugged:
                    ...
                    if Mod_ApprovalCheck("Mystique", 1450, TabM = 3) or Mod_ApprovalCheck("Mystique", 800, "O") or "exhibitionist" in newgirl["Mystique"].Traits: # 145, 160, 175, Taboo -160(355)
                        ...
                        #    $ newgirl["Mystique"].PantiesDown = 0
                        #    pause .1
                        #    #call SetLegsMystique(Temp_E_Legs)
                        #    $ newgirl["Mystique"].Upskirt = 0
                        #    pause
        ...
        "Sex Menu" if newgirl["Mystique"].Loc == bg_current:
                    ...
                    elif Mod_ApprovalCheck("Mystique", 600, "LI"):
                        call NewGirl_Face("Mystique","sexy")
                        ch_m "I suppose. . ."
                        call Mystique_SexMenu
                        return
                    elif Mod_ApprovalCheck("Mystique", 400, "OI"):
        ...
        #             if Mod_ApprovalCheck("Mystique", 800, "LI"):
        #                 ch_m "Well, why not."
        #                 $ Digits.append("Mystique") 
        #             elif Mod_ApprovalCheck("Mystique", 500, "OI"):
        ...
        #             if Mod_ApprovalCheck("Mystique", 1250):
        #                 $ Party.append("Mystique")
        #                 ch_m "Ok, let's go then."
        #                 return
        #             elif Mod_ApprovalCheck("Mystique", 950):
        #                 $ Party.append("Mystique")
        #                 ch_m "You'd better not bore me."
        #                 return
        #             elif not Mod_ApprovalCheck("Mystique", 400):
    ...
    menu:
        ...
        "Do you want to be my girlfriend?" if "dating" not in newgirl["Mystique"].Traits and "ex" not in newgirl["Mystique"].Traits:
                ...
                if newgirl["Mystique"].Love >= 800:
                        ...
                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, 40)
        ...
        "Do you want to get back together?" if "ex" in newgirl["Mystique"].Traits:
                ...
                if "asked boyfriend" in newgirl["Mystique"].DailyActions and "angry" in newgirl["Mystique"].DailyActions:
                    ...
                    if "dating" in (R_Traits,K_Traits):   
                        ...
                        if not Mod_ApprovalCheck("Mystique", 1500) or newgirl["Mystique"].Break[1] > 5:
                ...
                if newgirl["Mystique"].Love >= 800:
                    ...
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 5)
                    ...
                    call NewGirl_Face("Mystique","kiss", 1)
                    $ newgirl["Mystique"].Kissed += 1
                elif newgirl["Mystique"].Love >= 600 and Mod_ApprovalCheck("Mystique", 1500):
                    call NewGirl_Face("Mystique","smile", 1)
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 5)
                    ch_m "Hrm, very well."
                    if "boyfriend" not in newgirl["Mystique"].Petnames:
        ...
        # End Back Together
                ...
                menu:
                    ...
                    "She said I can be with you too." if "poly rogue" in newgirl["Mystique"].Traits:
                        if Mod_ApprovalCheck("Rogue", 1800, Bonus = Cnt):
                    ...
                    "Could you ask?":
                        if R_LikeNewGirl["Mystique"] >= 700:
                            ...
                            $ R_Love = Mod_Statupdate("Rogue", "Love", R_Love, 90, 5)
                            $ R_Obed = Mod_Statupdate("Rogue", "Obed", R_Obed, 70, 1)
                            $ R_Inbt = Mod_Statupdate("Rogue", "Inbt", R_Inbt, 80, 5)
...
label Mystique_OtherWoman(Other="Rogue", Poly = 0, Cnt = 0):
    ...
    menu: 
        ...
        "She said I can be with you too." if Poly:
                if Mod_ApprovalCheck("Mystique", 1800, Bonus = Cnt):
                    call NewGirl_Face("Mystique","smile", 1)
                    if newgirl["Mystique"].Love >= newgirl["Mystique"].Obed:
        ...
        "What she doesn't know won't hurt her.":
                if not Mod_ApprovalCheck("Mystique", 1800, Bonus = -Cnt): #checks if Rogue likes you more than Mystique
                    call NewGirl_Face("Mystique","angry", 1)
                    if not Mod_ApprovalCheck("Mystique", 1800):
...
label Mystique_Settings:
    menu:
                ...
                if newgirl["Mystique"].Loc != "bg player" and newgirl["Mystique"].Loc != "bg Mystique":  
                    if Taboo:
                        if "exhibitionist" in newgirl["Mystique"].Traits:
                            ch_m "Mmmmm. . ."  
                        elif Mod_ApprovalCheck("Mystique", 900, TabM=4) or Mod_ApprovalCheck("Mystique", 400, "I", TabM=3): 
                            ch_m "This isn't really the appropriate place for it, however. . ."
                        else:
                            ch_m "I'd rather discuss that in private."
                            return
                    call Mystique_Clothes
                elif Mod_ApprovalCheck("Mystique", 600, "L") or Mod_ApprovalCheck("Mystique", 300, "O"):
        ...
        #         elif Mod_ApprovalCheck("Mystique", 1000, TabM=3) or Mod_ApprovalCheck("Mystique", 800, "I") or Mod_ApprovalCheck("Mystique", 750, "O"): 
        ...
        #             return
        #         $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 90, 5) 
        #         $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 90, 5) 
        #         $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 90, 5) 
        #         $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 5) 
        ...
        # "Shift her Personality" if Mod_ApprovalCheck("Mystique", 900, "L", TabM=0) or Mod_ApprovalCheck("Mystique", 900, "O", TabM=0) or Mod_ApprovalCheck("Mystique", 900, "I", TabM=0):
        #         ch_p "Could we talk about us?"
        #         call Mystique_Personality
            
        # "Your Pet Name":
        #         ch_p "Could we talk about my pet name?"
        #         if Mod_ApprovalCheck("Mystique", 600, "L", TabM=0) or Mod_ApprovalCheck("Mystique", 300, "O", TabM=0):
        #             call Mystique_Names    
        #         else:
        #             $ newgirl["Mystique"].Mouth = "smile"
        ...
        #         if Mod_ApprovalCheck("Mystique", 600, "L", TabM=0):
        #             ch_m "I'm dying to hear it. . ." 
        #         elif Mod_ApprovalCheck("Mystique", 300, "O", TabM=0):
        #             ch_m "Do you now."
        #         else:
        ...
        #                         $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -2)
        #                         $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 30, 5) 
        ...
        #                     if "follow" not in newgirl["Mystique"].DailyActions:
        #                         $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, 2) 
        #                         $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 60, 2) 
        #                     $ Line = "ask"
                                                
        #             "Don't ever leave when I'm around." if "lockedtravels" not in newgirl["Mystique"].Traits:
        #                     if Mod_ApprovalCheck("Mystique", 600, "O") or Mod_ApprovalCheck("Mystique", 900, "L"):   
        ...
        #                                     $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 99, 2)
        #                                 $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 10)                             
        #                         $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, -5, 1) 
        #                         $ Line = "lock"
        #                     else:
...
label Mystique_Chitchat(O=0, Options = ["default","default","default"]):
    if O:                                               #adds only a specific option that was sent
        ...
        if "Mystique" not in Digits:
                if Mod_ApprovalCheck("Mystique", 500, "L") or Mod_ApprovalCheck("Mystique", 250, "I"):
                    ch_m "You know, I never got around to giving you my number, here you go."
                    $ Digits.append("Mystique")  
                    return
                elif Mod_ApprovalCheck("Mystique", 250, "O"):
        ...
        if newgirl["Mystique"].Event[0] and "key" not in newgirl["Mystique"].Chat:
            $ Options.append("key")
        if "lover" in newgirl["Mystique"].Petnames and Mod_ApprovalCheck("Mystique", 900, "L"): # luvy dovey       
            $ Options.append("luv")
        ...
        if (bg_current == "bg Mystique" or bg_current == "bg player") and "relationship" not in newgirl["Mystique"].DailyActions:
            if "boyfriend" not in newgirl["Mystique"].Petnames and Mod_ApprovalCheck("Mystique", 750, "L"): # newgirl["Mystique"].Event[5]
                $ Options.append("boyfriend?")
            elif "lover" not in newgirl["Mystique"].Petnames and Mod_ApprovalCheck("Mystique", 900, "L"): # newgirl["Mystique"].Event[6]        
                $ Options.append("lover?")
            elif "sir" not in newgirl["Mystique"].Petnames and Mod_ApprovalCheck("Mystique", 500, "O"): # newgirl["Mystique"].Event[7]
                $ Options.append("sir?")      
            elif "daddy" not in newgirl["Mystique"].Petnames and Mod_ApprovalCheck("Mystique", 750, "L") and Mod_ApprovalCheck("Mystique", 500, "O") and Mod_ApprovalCheck("Mystique", 500, "I"): # newgirl["Mystique"].Event[5]
                $ Options.append("daddy?")
            elif "master" not in newgirl["Mystique"].Petnames and Mod_ApprovalCheck("Mystique", 900, "O"): # newgirl["Mystique"].Event[8]
                $ Options.append("master?")
            elif "sex friend" not in newgirl["Mystique"].Petnames and Mod_ApprovalCheck("Mystique", 500, "I"): # newgirl["Mystique"].Event[9]
                $ Options.append("sexfriend?")
            elif "fuck buddy" not in newgirl["Mystique"].Petnames and Mod_ApprovalCheck("Mystique", 900, "I"): # newgirl["Mystique"].Event]10]
                $ Options.append("fuckbuddy?")  
            
        
        if not Mod_ApprovalCheck("Mystique", 300):            #She dislikes you
            $ Options.append("hate") 
    ...
    if Options[0] == "mandrill":                             
        ...
        ch_m ". . . I may not be able to keep my hands to myself. . ."
            ...
            if "caught chat" in newgirl["Mystique"].Chat:
                    ...
                    if not Mod_ApprovalCheck("Mystique", 500, "I"):
                         ch_m "Or not. . ."
            else:    
            ...
            if "shower" in newgirl["Mystique"].Chat: 
                ...
                menu:
                    ...
                    "It was a total accident!  I promise!":             
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 50, 5)    
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 2) 
                            if Mod_ApprovalCheck("Mystique", 1200):
                                call NewGirl_Face("Mystique","sly",1)
                    ...
                    "Just you.":        
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 40, 5)   
                            if Mod_ApprovalCheck("Mystique", 1000) or Mod_ApprovalCheck("Mystique", 700, "L"):      
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 3)    
                                    call NewGirl_Face("Mystique","sly",1)
                                    ch_m "You know how to make a woman feel special, [newgirl[Mystique].Petname]."
                            else:                
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -5) 
                                    call NewGirl_Face("Mystique","angry")
                                    ch_m "You are {i}such{/i} a dork, [Playername], you know that?"                                                       
                    "Totally on purpose. I regret nothing.":
                            if Mod_ApprovalCheck("Mystique", 1200):                     
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 3)          
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 10)            
                                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 5) 
                                    call NewGirl_Face("Mystique","sly",1)
                                    ch_m "Hmm. . .next time, we'll have to take advantage of the moment."
                            elif Mod_ApprovalCheck("Mystique", 800):                          
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 5)            
                                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 5) 
                                    call NewGirl_Face("Mystique","perplexed",2)
                                    ch_m "Wha. . . um. . . okay?"
                                    $ newgirl["Mystique"].Blush = 1
                            else:                
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 50, -10) 
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 80, -10)          
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 10)  
                                    call NewGirl_Face("Mystique","angry")
            ...
            menu:
                ...
                "Good.  You looked like you could use to learn a thing or two from them.":                     
                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -3)          
                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 5)            
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 5) 
                        call NewGirl_Face("Mystique","angry")
            ...
            if "blow" not in newgirl["Mystique"].Chat:
                    ...
                    menu:
                        ...
                        "You were totally amazing.":                            
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 5)            
                                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 60, 10) 
                                    call NewGirl_Face("Mystique","sexy",1)
                                    ch_m "Good to know i stll got it then."
                        "Honest? It was good. . .but you could use a little practice, I think.":
                                if Mod_ApprovalCheck("Mystique", 300, "I") or not Mod_ApprovalCheck("Mystique", 800):                     
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -5)          
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 10)            
                                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 10) 
                                    call NewGirl_Face("Mystique","perplexed",1)
                                    ch_m "Yeah?  Well then maybe I'll get some practice in before we do it again."
                                else:                              
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 15)            
                                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 5) 
                                    call NewGirl_Face("Mystique","sexy",1)
                        ...
                        "I guess. If you're into weird sounds and too much teeth. Spoiler, I'm not.":                     
                                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -10)          
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 10)   
        ...
        menu:        
            ...
            "Kiss her cheek":                                                                                   #Kiss her cheek
                    ...
                    # else:    
                        ...
                        if Mod_ApprovalCheck("Mystique", 700, "L", TabM=2):
                            call NewGirl_Face("Mystique","sexy", 1)
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 1)          
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 40, 2) 
                            ch_m ". . ."
                            ch_m "Hello. . ."
                        elif Mod_ApprovalCheck("Mystique", 400, "L", TabM=3):
                            call NewGirl_Face("Mystique","surprised", 1)
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, 2)
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 1)          
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 40, 2)            
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 20, 1) 
                            ch_m ". . . to what do I owe the pleasure?"
                        elif Taboo and Mod_ApprovalCheck("Mystique", 500, "L"):                    
                            call NewGirl_Face("Mystique","angry", 1)
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -1)          
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 2)            
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 40, 1) 
            ...
            "Kiss her lips":                                                                                    #Kiss her
                    ...
                    # else:    
                        if Mod_ApprovalCheck("Mystique", 1000, TabM=2) or Mod_ApprovalCheck("Mystique", 600, "L", TabM=2):        
                        ...
                        elif Mod_ApprovalCheck("Mystique", 1000) or Mod_ApprovalCheck("Mystique", 600, "L"):     
                            call NewGirl_Face("Mystique","bemused", 1)
                            $ newgirl["Mystique"].Eyes = "side"         
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, -5)            
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 40, 2) 
                            ...
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -10)          
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 5)            
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 40, 5) 
                            "You lean close for a kiss, but Mystique steps back."
                            ch_m "No." 
                            return
                        if newgirl["Mystique"].Kissed:
                                if Mod_ApprovalCheck("Mystique", 800, "L", TabM=2):
                                    call NewGirl_Face("Mystique","sexy", 1)
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 2)          
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 2)
                                    ch_m "Mmmmmmm. . ."
                                elif Mod_ApprovalCheck("Mystique", 700, "L", TabM=2):
                                    call NewGirl_Face("Mystique","sexy", 1)
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 2)          
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 2) 
                                    ch_m "Hmm, hello [newgirl[Mystique].Petname]. . ."
                                elif Mod_ApprovalCheck("Mystique", 550, "L", TabM=2):
                                    call NewGirl_Face("Mystique","surprised", 1)
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, 1) 
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 2)          
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 2) 
                                    ch_m "You're incorrigible."
                                elif Taboo and Mod_ApprovalCheck("Mystique", 750):
                                    call NewGirl_Face("Mystique","angry", 1)
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -5)          
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 3)            
                                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 40, 2) 
                                    ...
                                    call NewGirl_Face("Mystique","angry", 1)
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -5)          
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 90, 6)            
                                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 40, 3) 
                                    ch_m "Down boy."
                                
                        else:                   #If this is the first kiss
                                if Mod_ApprovalCheck("Mystique", 800, "L", TabM=2) or Mod_ApprovalCheck("Mystique", 1200, TabM=2):
                                    call NewGirl_Face("Mystique","surprised", 1)
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 95, 30)          
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 15)
                                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 15)
                                    ch_m ". . ."
                                    ch_m "Hmmm, that was a pleasant surprise. . ."
                                    call NewGirl_Face("Mystique","sexy")
                                    ch_m "I could always use some more, [newgirl[Mystique].Petname]."
                                elif Mod_ApprovalCheck("Mystique", 650, "L", TabM=2):
                                    call NewGirl_Face("Mystique","surprised", 1)
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 80, 25)            
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 20)
                                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 15)
                                    ch_m "Hmm?"
                                    ch_m "So we're there now, are we? . ."
                                elif Mod_ApprovalCheck("Mystique", 500, "L", TabM=2):
                                    call NewGirl_Face("Mystique","surprised", 1)
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 20)
                                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 20)
                                    ch_m "I don't think that's really appropriate, [newgirl[Mystique].Petname]."
                                elif Taboo and Mod_ApprovalCheck("Mystique", 800):
                                    call NewGirl_Face("Mystique","angry", 1)
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 60, -5) 
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 35)
                                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 20)
                                    ch_m "We can't be seen doing that, [newgirl[Mystique].Petname]."
                                else: 
                                    call NewGirl_Face("Mystique","angry", 1)
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 60, -10) 
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 45)
                                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 25)
                                    ch_m "How dare you?"
                        ...
                        if Mod_ApprovalCheck("Mystique", 700, TabM=3) and not Taboo:
                            ...
                            menu:
                                "Keep kissing?"
                                "You know it.":
                                    $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 60, 3)  
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 1)
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 60, 3) 
                                ...
                                "Not now [[no].":
                                    call NewGirl_Face("Mystique","bemused", 1)
                                    $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 40, 1) 
                                    $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 60, 4) 
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 3)
                                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 1)
                                    ch_m "Tease. . ."
                                "Nope.":
                                    call NewGirl_Face("Mystique","angry", 1)
                                    $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 40, 1) 
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 80, -2) 
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 4)
                                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 1)
            ...
            "Hug her":                                                                                          #Hug her
                    ...
                    # else:
                        ...
                        if newgirl["Mystique"].SEXP >= 30: 
                            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 60, 3) 
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 1)          
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 90, 3)            
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 90, 2) 
                            call NewGirl_Face("Mystique","sexy")
                            ch_m "Hmmm, what did you have in mind, [newgirl[Mystique].Petname]."
                        elif Mod_ApprovalCheck("Mystique", 800, "L", TabM=2):
                            call NewGirl_Face("Mystique","sexy")
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 1)          
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 40, 2)            
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 30, 1) 
                            ch_m "Hmm, I do enjoy this. . ."
                        elif Mod_ApprovalCheck("Mystique", 550, TabM=2):
                            call NewGirl_Face("Mystique","surprised", 1)
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 1)  
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, 1)        
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 40, 2)            
                        ...
                        elif Taboo and Mod_ApprovalCheck("Mystique", 550):
                            call NewGirl_Face("Mystique","angry", 1)
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, 1)        
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 3)            
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 30, 2) 
                            ch_m "We can't be seen like this. . ."
                        else: 
                            call NewGirl_Face("Mystique","angry", 1)
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 40, -4)       
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 4)            
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 30, 2) 
            ...
            "Pinch her ass":                                                                                    #Pinch her ass
                    ...
                    # else:
                        ...
                        if newgirl["Mystique"].SEXP >= 40: 
                            ...
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 1)           
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 2)          
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 90, 1)            
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 3) 
                            call NewGirl_Face("Mystique","sexy")
                            ch_m "Mmm, what was that for?"
                        elif Mod_ApprovalCheck("Mystique", 8000, TabM=2):
                            call NewGirl_Face("Mystique","surprised")
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 1)           
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 4)          
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 90, 2)            
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 2) 
                            ch_m "Mmm, watch it."
                        elif Taboo and Mod_ApprovalCheck("Mystique", 800):
                            call NewGirl_Face("Mystique","angry")
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -4)           
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 5)          
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 90, 3)            
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 1) 
                            ...
                            call NewGirl_Face("Mystique","angry")
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -8)           
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 5)          
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 90, 4)            
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 2)
            ...
            "Flip her skirt up" if P_Lvl >= 4 and newgirl["Mystique"].Legs and "skirt" in newgirl["Mystique"].Legs and not newgirl["Mystique"].Upskirt:   #Flip her skirt           
                        ...
                        if newgirl["Mystique"].Panties and not Taboo:
                            if Mod_ApprovalCheck("Mystique", 750, "L", TabM=2):
                                call NewGirl_Face("Mystique","sexy", 1)
                            ...
                            elif Mod_ApprovalCheck("Mystique", 300, "I", TabM=1):
                                call NewGirl_Face("Mystique","sexy", 1)
                                ch_m "Hey, what do you think you're doing, [newgirl[Mystique].Petname]?"
                            elif Mod_ApprovalCheck("Mystique", 300, TabM=1):
                                call NewGirl_Face("Mystique","angry", 1)
                                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -3)           
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 1)  
                                ch_m "Not cool, [newgirl[Mystique].Petname]!"
                            else: 
                                call NewGirl_Face("Mystique","angry", 1)
                                ch_m "What the fuck, [newgirl[Mystique].Petname]!"
                                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -5)          
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 2)  
                                ch_m "That is not how you treat a lady!"
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 5)             
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 30, 2)           
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 3) 
                            $ newgirl["Mystique"].SeenPanties = 1
                            
                        elif newgirl["Mystique"].Panties: #panties on, but Taboo
                            if Mod_ApprovalCheck("Mystique", 750, "L") and Mod_ApprovalCheck("Mystique", 1300, TabM=2):
                                call NewGirl_Face("Mystique","sexy", 1)
                                ch_m "Oh, naughty, [newgirl[Mystique].Petname]!"
                                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 3) 
                                ch_m "You could have just asked, you know. . ."
                            elif Mod_ApprovalCheck("Mystique", 600, "L") and Mod_ApprovalCheck("Mystique", 1200, TabM=2):
                                call NewGirl_Face("Mystique","sexy", 1)
                                ch_m "[newgirl[Mystique].Petname]! A little warning!"
                            elif Mod_ApprovalCheck("Mystique", 600, "L"):
                                call NewGirl_Face("Mystique","angry", 1)
                                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -3)           
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 3)  
                                ch_m "[newgirl[Mystique].Petname]! This isn't the time or place for this!"
                            elif Mod_ApprovalCheck("Mystique", 800, TabM=2):
                                call NewGirl_Face("Mystique","angry", 1)
                                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -5)           
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 2)  
                                ...
                                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -10)          
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 2)           
                                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 1) 
                                ch_m "Why would you even do that in public?"
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 7)             
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 30, 3)           
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 3)
                            $ newgirl["Mystique"].SeenPanties = 1
                            
                        elif not Taboo: #no panties, no taboo
                            if Mod_ApprovalCheck("Mystique", 850, "L"):
                                call NewGirl_Face("Mystique","sexy", 1)
                                ch_m "Oh, naughty, [newgirl[Mystique].Petname]!"
                                ch_m "You could have just asked, you know. . ."
                            elif Mod_ApprovalCheck("Mystique", 700, "L"):
                                call NewGirl_Face("Mystique","sexy", 1)
                                ch_m "[newgirl[Mystique].Petname]! A little warning!"
                            elif Mod_ApprovalCheck("Mystique", 600, "L"):
                                call NewGirl_Face("Mystique","bemused", 1)
                            ...
                            elif Mod_ApprovalCheck("Mystique", 500):
                                call NewGirl_Face("Mystique","angry", 1)
                                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -5)           
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 2)  
                                ch_m "Wha! [newgirl[Mystique].Petname]!"
                            ...
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 7)             
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 30, 3)           
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 4)  
                            call Mystique_First_Bottomless
                            
                        else: #no panties, taboo
                            if Mod_ApprovalCheck("Mystique", 850, "L") and Mod_ApprovalCheck("Mystique", 1500):
                                call NewGirl_Face("Mystique","sexy", 1)
                                ch_m "Oh, naughty, [newgirl[Mystique].Petname]!"
                                ch_m "You could have just asked, you know. . ."
                            elif Mod_ApprovalCheck("Mystique", 700, "L") and Mod_ApprovalCheck("Mystique", 1500):
                                call NewGirl_Face("Mystique","sexy", 1)
                                ch_m "[newgirl[Mystique].Petname]! A little warning!"
                            elif Mod_ApprovalCheck("Mystique", 700):
                                call NewGirl_Face("Mystique","bemused", 1)
                                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -3)           
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 3)  
                                ch_m "[newgirl[Mystique].Petname]! This isn't the time or place for this!"
                            elif Mod_ApprovalCheck("Mystique", 1000):
                                call NewGirl_Face("Mystique","angry", 1)
                                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -5)           
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 2)  
                                ch_m "Wha! [newgirl[Mystique].Petname]!"
                                ...
                                ch_m "I- I don't usually, you know. . ." 
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 7)             
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 30, 4)           
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 4)  
                            call Mystique_First_Bottomless
                        $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 60, 1) 
                        if "exhibitionist" in newgirl["Mystique"].Traits:
                            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 200, 4) 
                    #End Flip her Skirt
            ...
            "Grab her tit":                                                                                     #Grab her tit
                    ...
                    # else:    
                        ...
                        if newgirl["Mystique"].SEXP >= 40: 
                            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 60, 7) 
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 2) 
                            call NewGirl_Face("Mystique","sly")
                            ch_m "I do enjoy this, [newgirl[Mystique].Petname]. . ."
                            $ Count = 10
                        elif Mod_ApprovalCheck("Mystique", 850, "L", TabM=2):
                            call NewGirl_Face("Mystique","sexy")
                            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 60, 3) 
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 1) 
                            ch_m "Mmmmmm. . ."
                            $ Count = 7
                        elif Mod_ApprovalCheck("Mystique", 1200, TabM=2):
                            call NewGirl_Face("Mystique","perplexed")
                            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 60, 2)         
                            ch_m "Rather forward of you, [newgirl[Mystique].Petname]."
                            $ Count = 5
                        elif Taboo and Mod_ApprovalCheck("Mystique", 900):
                            call NewGirl_Face("Mystique","angry")
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -5)          
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 90, 4)            
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 90, 1) 
                        ...
                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 3)            
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 2)                     
                        while Count > 0:
                            if Count == 5:
                                call NewGirl_Face("Mystique","sexy", 1)
                                ch_m "Mmmmm, I do enjoy that. . ."  
                                $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 90, 2)       
                                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 1)
                            elif Count == 3:
                                call NewGirl_Face("Mystique","perplexed")
                                $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 90, 2) 
                            ...
                            if Count > 0:
                                menu:
                                    ...
                                    "Fondle it a little":                            
                                        if newgirl["Mystique"].FondleB and Mod_ApprovalCheck("Mystique", 1100, TabM=3):                                
                                            call NewGirl_Face("Mystique","sexy",1)
                                            $ newgirl["Mystique"].Eyes = "closed"
                                            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 90, 5) 
                                        else:
                                            call NewGirl_Face("Mystique","perplexed")
                                            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 90, 3) 
                                            $ Count -= 1
                                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 4)            
                                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 2)
                                        ch_m "Mmm. . ."
                                    ...
                                    "Just leave it there.":
                                        ...
                                        if Count == 5:
                                            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 90, 4) 
                                        elif Count == 2:
                                            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 90, 2) 
                                        ch_m "Um, [newgirl[Mystique].Petname]."                     
                                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 2)            
                                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 1)
                                        call NewGirl_Face("Mystique","perplexed")
                        if Taboo:
                            ch_m "Show some respect when in public, [newgirl[Mystique].Petname]."
                        elif newgirl["Mystique"].FondleB and Mod_ApprovalCheck("Mystique", 1200, TabM = 3): 
                            call NewGirl_Face("Mystique","sexy", 1)
                            ch_m "Were you just sampling, or did you want to continue?"
                            menu:
                                extend ""
                                "Yeah!":
                                        $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 60, 5) 
                                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 2)          
                                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 3)            
                                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 60, 3) 
            ...
            "Rub her shoulders":                                                                                #Rub her shoulders
                    ...
                    # else:
                        ...
                        elif Mod_ApprovalCheck("Mystique", 500, TabM = 2):
                            call NewGirl_Face("Mystique","surprised", 1)
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 1)
                            ch_m "Well hello, [newgirl[Mystique].Petname]."
                        elif Mod_ApprovalCheck("Mystique", 400):
                            call NewGirl_Face("Mystique","angry", 1)
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -1)
                            if Taboo:
...
label Mystique_AskPanties(Store = 0):
    ...
    if not newgirl["Mystique"].Panties or newgirl["Mystique"].Panties == "shorts":
        if Mod_ApprovalCheck("Mystique", 900):
            call NewGirl_Face("Mystique","sexy", 1)
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 80, 5) 
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 60, 5) 
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 40, 10)            
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 60, 5)            
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 30, 10) 
        ...
        if newgirl["Mystique"].SeenPussy and Mod_ApprovalCheck("Mystique", 500): #You've seen her Pussy.
            $ Tempmod += 15
        elif newgirl["Mystique"].SeenPanties and Mod_ApprovalCheck("Mystique", 500): #You've seen her panties.
            $ Tempmod += 5 
        if "exhibitionist" in newgirl["Mystique"].Traits:
            $ Tempmod += (Taboo * 5)
        ...
        $ Line = 0
        if newgirl["Mystique"].Legs == "pants" or newgirl["Mystique"].Legs == "black pants" or newgirl["Mystique"].Legs == "NewX" or newgirl["Mystique"].Legs == "NewX black" or ModHoseNum("Mystique") >= 10: 
            if Mod_ApprovalCheck("Mystique", 1000, "OI", TabM = 5) or "exhibitionist" in newgirl["Mystique"].Traits:   
                $ Line = "here"
            elif Mod_ApprovalCheck("Mystique", 900, TabM = 5):
                $ Line = "change"
                
        elif newgirl["Mystique"].Legs == "skirt":
            if Mod_ApprovalCheck("Mystique", 600, "OI", TabM = 5) or "exhibitionist" in newgirl["Mystique"].Traits:   
                $ Line = "here"
            elif Mod_ApprovalCheck("Mystique", 1100, TabM = 5):
                $ Line = "change"
                
        else:
            if Mod_ApprovalCheck("Mystique", 1200, TabM = 5) or "exhibitionist" in newgirl["Mystique"].Traits:
                $ Line = "here"
        ...
        if Line == "here":                              #She's agreed to change and will do it here
                ...
                if newgirl["Mystique"].Legs == "skirt":      
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 4)            
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 60, 4)
                else: #no pants or skirt         
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 6)            
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 60, 6) 
                ...
                if Taboo:
                    ...
                    if "exhibitionist" in newgirl["Mystique"].Traits: 
                        $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 80, 5)
                        $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 200, 5)    
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 10)            
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 10)        
                ...
                if not Taboo:                           #If it's in one of your rooms                                    
                    ...
                    menu:
                        ...
                        "And miss the show?":
                            if Mod_ApprovalCheck("Mystique", 1000, "LI"): 
                                $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 70, 5)          
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 5)            
                                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 60, 5) 
                                call NewGirl_Face("Mystique","sly", 1)
                                ch_m "How precious."
                        ...
                        "Nope, I'm staying.":
                            if Mod_ApprovalCheck("Mystique", 600, "OI"): 
                                call NewGirl_Face("Mystique","perplexed", 1)
                                $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 70, 5)          
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 10)            
                                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 60, 5) 
            ...
            call NewGirl_Face("Mystique","angry", 2)
            if not Mod_ApprovalCheck("Mystique", 500):
                $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 60, 5) 
                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -10)          
                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 3)            
                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 60, 3) 
            ...
            elif not Mod_ApprovalCheck("Mystique", 500, TabM = 5):
                $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 60, 5) 
                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -5)          
                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 5)            
                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 60, 5) 
                ...
                call NewGirl_Face("Mystique","bemused", 2)
                $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 60, 3)            
                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 60, 1)
                if Taboo:            
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 60, 2)
    ...
    menu:
        ...
        "Give her a dildo." if "dildo" in P_Inventory: #If you have a Dildo, you'll give it.
            ...
            if "dildo" not in newgirl["Mystique"].Inventory:                            
                ...
                if Mod_ApprovalCheck("Mystique", 1000) or Mod_ApprovalCheck("Mystique", 400, "I"):                    
                    call NewGirl_Face("Mystique","bemused")
                    $ P_Inventory.remove("dildo")
                    $ newgirl["Mystique"].Inventory.append("dildo")
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, 30)
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 200, 30)
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 200, 30)
                    ch_m "I'm sure I can find some place to store it. . ."
                    $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 89, 10)
                    $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 89, 10)
                elif Mod_ApprovalCheck("Mystique", 800) or Mod_ApprovalCheck("Mystique", 300, "I"):
                    call NewGirl_Face("Mystique","confused")
                    $ P_Inventory.remove("dildo")
                    $ newgirl["Mystique"].Inventory.append("dildo")
                    ch_m "This is not an appropriate gift from a kid. . ."  
                    $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 89, 5)
                    $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 89, 10)
                    call NewGirl_Face("Mystique","sadside",1)
                    ch_m "Hm. . ."
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, 10)
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 200, 10)
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 200, 10)
                    call NewGirl_Face("Mystique","sly")
                    ...
                    call NewGirl_Face("Mystique","angry")
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 50, -20)
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 20, 10)
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 20, 20)                    
        ...
        "Give her the vibrator." if "vibrator" in P_Inventory: #If you have a vibrator, you'll give it.
            ...
            if "vibrator" not in newgirl["Mystique"].Inventory:                            
                ...
                if Mod_ApprovalCheck("Mystique", 700):                    
                    call NewGirl_Face("Mystique","bemused")
        ...
        "Give her the lace bra." if "lace bra" in P_Inventory: #If you have a bra, you'll give it.
            ...
            if "lace bra" not in newgirl["Mystique"].Inventory:                            
                ...
                if Mod_ApprovalCheck("Mystique", 1200):                    
                    ...
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, 25)
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 200, 30)
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 200, 20)
                    ...
                    $ P_Inventory.remove("lace bra")
                    $ newgirl["Mystique"].Inventory.append("lace bra")
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, 20)
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 200, 30)
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 200, 15)
                    ch_m "I'm not exactly running low on this sort of thing. . ."                    
                    call NewGirl_Face("Mystique","bemused",1)
                elif Mod_ApprovalCheck("Mystique", 600):
                    call NewGirl_Face("Mystique","confused")
                    $ P_Inventory.remove("lace bra")
                    $ newgirl["Mystique"].Inventory.append("lace bra")
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, 20)
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 200, 20)
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 200, 25)
        ...
        "Give her the lace panties." if "lace panties" in P_Inventory: #If you have a bra, you'll give it.
            ...
            if "lace panties" not in newgirl["Mystique"].Inventory:                            
                ...
                if Mod_ApprovalCheck("Mystique", 900):
                    ...
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, 20)
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 200, 25)
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 200, 20)
                    ...
                    call NewGirl_Face("Mystique","angry")
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 50, -15)
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 20, 10)
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 20, 20)
        ...
        "Give her the \"Dazzler and Longshot\" book." if "Dazzler and Longshot" in P_Inventory: #If you have a vibrator, you'll give it.
            ...
            if "Dazzler and Longshot" not in newgirl["Mystique"].Inventory:                            
                ...
                $ newgirl["Mystique"].Blush = 1
                if Mod_ApprovalCheck("Mystique", 600, "L"):                    
                    call NewGirl_Face("Mystique","angry")
                ...
                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, 50) 
            else: 
        ...
        "Give her the \"256 Shades of Grey\" book." if "256 Shades of Grey" in P_Inventory: #If you have a book, you'll give it.
            ...
            if "256 Shades of Grey" not in newgirl["Mystique"].Inventory:                            
                "You give Mystique the book."
                $ newgirl["Mystique"].Blush = 1
                if Mod_ApprovalCheck("Mystique", 500, "O"):                    
                    call NewGirl_Face("Mystique","bemused")
                ...
                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 200, 50)  
            else: 
                ch_m "You're repeating yourself."                  
        ...
        "Give her the \"Avengers Tower Penthouse\" book." if "Avengers Tower Penthouse" in P_Inventory: #If you have a book, you'll give it.
            ...
            if "Avengers Tower Penthouse" not in newgirl["Mystique"].Inventory:                            
                "You give Mystique the book."
                $ newgirl["Mystique"].Blush = 1
                if Mod_ApprovalCheck("Mystique", 500, "I"):                    
                    call NewGirl_Face("Mystique","bemused")
                ...
                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 200, 50)  
            else: 
                ch_m "You're repeating yourself."                     
            ...
            "Polite":
                menu:
                    ...
                    "I think I'll just call you Mystique.":
                        if Mod_ApprovalCheck("Mystique", 700) or "classcaught" in newgirl["Mystique"].History:
                    ...
                    "I think I'll call you \"Raven\".":
                        ...
                        if "boyfriend" in newgirl["Mystique"].Petnames or Mod_ApprovalCheck("Mystique", 600, "L"):
                            call NewGirl_Face("Mystique","sexy", 1)
                    ...
                    "I think I'll call you \"blue\".":
                        ...
                        if "boyfriend" in newgirl["Mystique"].Petnames or Mod_ApprovalCheck("Mystique", 800, "L"):
                            call NewGirl_Face("Mystique","bemused", 1)
                    ...
                    "I think I'll call you \"baby\".":
                        ...
                        if "boyfriend" in newgirl["Mystique"].Petnames or Mod_ApprovalCheck("Mystique", 500, "L"):
                            call NewGirl_Face("Mystique","sexy", 1)
                    ...
                    "I think I'll call you \"sexy\".":
                        ...
                        if "lover" in newgirl["Mystique"].Petnames or Mod_ApprovalCheck("Mystique", 900):
                            call NewGirl_Face("Mystique","sexy", 1)
                    ...
                    "I think I'll call you \"lover\".":
                        ...
                        if "lover" in newgirl["Mystique"].Petnames or Mod_ApprovalCheck("Mystique", 900, "L"):
                            call NewGirl_Face("Mystique","sexy", 1)
            ...
            "Risky":
                menu:                   
                    "I think I'll call you \"slave\".":
                        ...
                        if "master" in newgirl["Mystique"].Petnames or Mod_ApprovalCheck("Mystique", 700, "O"):
                            call NewGirl_Face("Mystique","bemused", 1)
                            ch_m "As you \"wish\", [newgirl[Mystique].Petname]."
                        else: 
                            call NewGirl_Face("Mystique","angry", 1)
                    ...
                    "I think I'll call you \"pet\".":
                        ...
                        if "master" in newgirl["Mystique"].Petnames or Mod_ApprovalCheck("Mystique", 600, "O"):
                            call NewGirl_Face("Mystique","bemused", 1)
                    ...
                    "I think I'll call you \"slut\".":
                        ...
                        if "sex friend" in newgirl["Mystique"].Petnames or Mod_ApprovalCheck("Mystique", 1000, "OI"):
                            call NewGirl_Face("Mystique","sexy")
                    ...
                    "I think I'll call you \"whore\".":
                        ...
                        if "fuckbuddy" in newgirl["Mystique"].Petnames or Mod_ApprovalCheck("Mystique", 1100, "OI"):
                            call NewGirl_Face("Mystique","sly")
                    ...
                    "I think I'll call you \"mistress\".":
                        ...
                        if "sex friend" in newgirl["Mystique"].Petnames or Mod_ApprovalCheck("Mystique", 1400):
                            call NewGirl_Face("Mystique","sly", 1)
                    ...
                    "I think I'll call you \"sex friend\".":
                        ...
                        if "sex friend" in newgirl["Mystique"].Petnames or Mod_ApprovalCheck("Mystique", 600, "I"):
                            call NewGirl_Face("Mystique","sly")
                    ...
                    "I think I'll call you \"fuckbuddy\".":
                        ...
                        if "fuckbuddy" in newgirl["Mystique"].Petnames or Mod_ApprovalCheck("Mystique", 700, "I"):
                            call NewGirl_Face("Mystique","sly")
                            ch_m "Mmm, I guess so."
                        else:           
                            call NewGirl_Face("Mystique","angry", 1)
                    ...
                    "I think I'll call you \"baby girl\".":
                        ...
                        if "daddy" in newgirl["Mystique"].Petnames or Mod_ApprovalCheck("Mystique", 1200):
                            call NewGirl_Face("Mystique","smile", 1)
                    ...
                    "I think I'll call you \"mommy\".":
                        ...
                        if "mommy" in newgirl["Mystique"].Pets or Mod_ApprovalCheck("Mystique", 1500):
...
label Mystique_Namecheck(Girl_Pet = newgirl["Mystique"].Pet, Cnt = 0, Ugh = 0):#Girl_Pet is the internal pet name, Cnt and Ugh are internal count variable
    ...
    if Girl_Pet == "Raven":                                         #easy options
        if Mod_ApprovalCheck("Mystique", 500, "L", TabM=1):       
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 80, 1)
        else:
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 50, -1)
            $ Ugh = 1
        ...
        if Mod_ApprovalCheck("Mystique", 500, "L", TabM=1):
            ...
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 30, -1)
            $ Ugh = 1
    elif Girl_Pet == "kitten":
        if Mod_ApprovalCheck("Mystique", 600, "L", TabM=1):
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 80, 2)
        else:
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 50, -1)
            $ Ugh = 1
    elif Girl_Pet == "sweetie":
        if not Mod_ApprovalCheck("Mystique", 500, "L", TabM=1):
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 80, 1)
        else:
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 40, -1)
            $ Ugh = 1
      
    elif Girl_Pet == "sexy" or Girl_Pet == "lover":
        if Mod_ApprovalCheck("Mystique", 900, TabM=1):                                                        #over 150
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 80, 2)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 1)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 1)
        else:                                                       
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 50, (-1-Cnt))
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 1)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 20, -1)
            $ Ugh = 1
      
    elif Girl_Pet == "slave":                                        #tougher options
        if Mod_ApprovalCheck("Mystique", 800, "O", TabM=3):                                            #over 80
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 90, (3+Cnt))
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 95, (2+Cnt))
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 30, 1)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 1) 
        elif Mod_ApprovalCheck("Mystique", 500, "O", TabM=3):                                                  #between 50 and 80
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 90, 1)
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -1)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 81, 2)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 1)   
        else:                                                                                           # under 50
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -2)
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 50, -1, 1)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 1)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, -1)
            $ Ugh = 1

    elif Girl_Pet == "pet":                                        #tougher options
        if Mod_ApprovalCheck("Mystique", 1500, TabM=2):                                            #over 150
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 90, (3+Cnt))
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 95, (2+Cnt))
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 30, 1)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 1) 
        elif Mod_ApprovalCheck("Mystique", 1200, TabM=2):                                                  #between 120 and 150
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 60, 1)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 81, 2)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 1)   
        else:                                                                                           # under 120
        ...
        if Mod_ApprovalCheck("Mystique", 500, "O", TabM=2) or Mod_ApprovalCheck("Mystique", 500, "I", TabM=2):        #over 50
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 90, (4+Cnt))
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 95, (2+Cnt))
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 40, 2)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 1)
        elif Mod_ApprovalCheck("Mystique", 300, "O", TabM=2) or Mod_ApprovalCheck("Mystique", 300, "I", TabM=2):      #between 30 and 50
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 90, 1)
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, (-1-Cnt))
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, (2+Cnt))
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 1)   
        else:                                                                                           # under 40
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, (-2-Cnt))
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 50, (-1-Cnt), 1)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 1)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 20, -1)
            $ Ugh = 1
      
    elif Girl_Pet == "whore":
        if Mod_ApprovalCheck("Mystique", 600, "O", TabM=2) or Mod_ApprovalCheck("Mystique", 600, "I", TabM=2):        #over 60
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 90, 4)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 95, 2)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 2)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 1)
        elif Mod_ApprovalCheck("Mystique", 400, "O", TabM=2) or Mod_ApprovalCheck("Mystique", 400, "I", TabM=2):      #between 40 and 60
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 90, 1)
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, (-2-Cnt))
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 2)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 1)
        else:                                                                                           # under 40
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, (-3-Cnt))
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 50, (-2-Cnt), 1)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 1)       
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 21, 1, 1)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 20, -1)
            $ Ugh = 1
      
    elif Girl_Pet == "mistress":
        if Mod_ApprovalCheck("Mystique", 1500, TabM=1):                                                        #over 150
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 1)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 2)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 1)       
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 30, 2)
        ...
        if Mod_ApprovalCheck("Mystique", 750, "O", TabM=1) or Mod_ApprovalCheck("Mystique", 600, "I", TabM=1):        #over 75/60
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 90, 3)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 95, 2)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 40, 2)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 1)
        elif Mod_ApprovalCheck("Mystique", 600, "O", TabM=1) or Mod_ApprovalCheck("Mystique", 400, "I", TabM=1):      #between 60/40 and 75/60
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 90, 2)
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, (-1-Cnt))
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 1)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 1)
            ...
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -Cnt)
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 50, (-1-Cnt), 1)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 1)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 20, -1)
            $ Ugh = 1
        ...
        if Mod_ApprovalCheck("Mystique", 700, "O", TabM=2) or Mod_ApprovalCheck("Mystique", 700, "I", TabM=1):        #over 70/70
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 90, 3)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 95, 2)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 40, 2)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 85, 1)
        elif Mod_ApprovalCheck("Mystique", 600, "O", TabM=2) or Mod_ApprovalCheck("Mystique", 500, "I", TabM=1):      #between 60/50 and 70/70
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 90, 2)
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, (-1-Cnt))
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 1)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 1)
            ...
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -Cnt)
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 60, (-2-Cnt), 1)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 1)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 20, -1)
            $ Ugh = 1
      
    elif Girl_Pet == "baby girl":
        if Mod_ApprovalCheck("Mystique", 1200, TabM=1):                                                        #over 150
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 1)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 2)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 1)       
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 30, 2)
...
label Mystique_Summon(Tempmod=Tempmod):
    ...
    if Current_Time == "Night": 
                if Mod_ApprovalCheck("Mystique", 700, "L") or Mod_ApprovalCheck("Mystique", 300, "O"):                              
    ...
    if D20 <= 3:                                                                        
        #unlucky refusal
        $ Line = "no"       
    elif not Mod_ApprovalCheck("Mystique", 700, "L") or not Mod_ApprovalCheck("Mystique", 600, "O"):                       
        #It's not night time, but she's busy 
        if not Mod_ApprovalCheck("Mystique", 300):
        ...
        if "summoned" in newgirl["Mystique"].RecentActions:
            ...
            if Mod_ApprovalCheck("Mystique", 1600):
        ...
        if "summoned" in newgirl["Mystique"].RecentActions:
            ...
            menu:
                ...
                "But I'd {i}really{/i} like to see you over here.":
                        if Mod_ApprovalCheck("Mystique", 600, "L") or Mod_ApprovalCheck("Mystique", 1400):
                                $ Line = "lonely"
                        else: 
                                $ Line = "no"                        
                "I said come over here.":
                        if Mod_ApprovalCheck("Mystique", 600, "O"):                                    
                                #she is obedient
                                $ Line = "command"                        
                        elif D20 >= 7 and Mod_ApprovalCheck("Mystique", 1400):                         
                                #she is generally favorable 
                                ch_m "Hmm, very well."              
                                $ Line = "yes"                        
                        elif Mod_ApprovalCheck("Mystique", 200, "O"):                                  
                                #she is not obedient  
            ...
            menu:
                ...
                "Sure, I'll be right there.":
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 55, 1) 
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 30, 1)
                    ch_m "I'll be waiting."
                    $ Line = "go to"
                ...
                "Nah, we can talk later.":
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 1)                            
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 30, 2)
                    ch_m "Very well."
                ...
                "I said come over here.":
                    if Mod_ApprovalCheck("Mystique", 600, "O"):                              
                        ...
                        #she is not obedient   
                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -4)  
                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -2)   
                        ...
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 1)                                    
                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 50, -1, 1)
                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, -1)  
                        $ Line = "no" 
                    #end "ordered"
    else:                                                                               
    ...
    if Line == "no":                                                                    
            ...
            #         jump Danger_Room
            if newgirl["Mystique"].Loc == "bg Mystique": 
...
label Mystique_Leave(Tempmod=Tempmod, GirlsNum = 0):        
    if "leaving" in newgirl["Mystique"].RecentActions:
        call Mod_DrainWord("Mystique","leaving")
    else:
        return
    ...
    if "Mystique" in Party or "lockedtravels" in newgirl["Mystique"].Traits:           
    ...
    elif "freetravels" in newgirl["Mystique"].Traits or not Mod_ApprovalCheck("Mystique", 700):
            ...
            elif newgirl["Mystique"].Loc == "bg showerroom" and Mod_ApprovalCheck("Mystique", 1400):
    ...
    if Line == "no":                                                                    
            ...
            #You agreed to go to her instead  
            $ Tempmod = 0
            call Mod_DrainWord("All","leaving")
            call Mod_DrainWord("All","arriving")
            hide Mystique_Sprite
            call Gym_Clothes("auto", "Mystique")
            call Pool_Clothes("auto", "Mystique")
            if newgirl["Mystique"].Loc == "bg teacher":
...
label Mystique_Dismissed(Leaving = 0):
    ...
    menu:
        "You can leave if you like.":
                if newgirl["Mystique"].Loc != bg_current and not Mod_ApprovalCheck("Mystique", 600, "O"):
        ...
        "Could you give me the room please?":                            
                if newgirl["Mystique"].Loc != bg_current and not Mod_ApprovalCheck("Mystique", 800, "LO"):
                        ch_m "As it happens, I don't have any other plans."
                elif not Mod_ApprovalCheck("Mystique", 500, "LO"):
                        ch_m "I don't think that I can."               
                else:
                        if "dismissed" not in newgirl["Mystique"].DailyActions:
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 30, 7)
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 5)
                        ch_m "Very well. . ." 
                        $ Leaving = 1                              
        "You can go now.":                         
                if newgirl["Mystique"].Loc != bg_current and not Mod_ApprovalCheck("Mystique", 450, "O"):
                        ch_m "No, I don't believe that I can."
                elif not Mod_ApprovalCheck("Mystique", 250, "O"):
                        call NewGirl_Face("Mystique","confused")
                        ch_m "Now I am intrigued."
                else:
                        if "dismissed" not in newgirl["Mystique"].DailyActions:
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 40, 10)
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 7)
                        ch_m "Very well. . ."
                        $ Leaving = 1                               
        "Nevermind.":
                        return                                           
    ...
    if not Leaving:     
            menu:
                extend ""
                "I insist, get going.":  
                        if newgirl["Mystique"].Loc != bg_current and (Mod_ApprovalCheck("Mystique", 1200, "LO") or Mod_ApprovalCheck("Mystique", 400, "O")):
                                #If she has someplace to be and is obedient
                                if "dismissed" not in newgirl["Mystique"].DailyActions:
                                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -5, 1)
                                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 10)
                                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 5)
                                ch_m "Very well. . ."  
                                $ Leaving = 1                                  
                        elif newgirl["Mystique"].Loc != bg_current and (Mod_ApprovalCheck("Mystique", 1000, "LO") or Mod_ApprovalCheck("Mystique", 250, "O")):
                                #If she has someplace to be and is less obedient
                                if "dismissed" not in newgirl["Mystique"].DailyActions:
                                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 50, -5, 1)
                                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -5, 1)
                                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 10)
                                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 5)
                                call NewGirl_Face("Mystique","angry")
                                ...
                                if "dismissed" not in newgirl["Mystique"].DailyActions:
                                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 50, -5, 1)
                                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -10, 1)
                                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, -3)
                                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 5)
                                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 3)
                                call NewGirl_Face("Mystique","angry")
                                ch_m "Well now I'm definitely not."          
                        elif Mod_ApprovalCheck("Mystique", 1400, "LO") or Mod_ApprovalCheck("Mystique", 400, "O"):
                                ...
                                if "dismissed" not in newgirl["Mystique"].DailyActions:
                                        ...
                                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, -5)
                                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 3)
                                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 2)
                                call NewGirl_Face("Mystique","sad")
...
label Mystique_Clothes(Public=0,Bonus=0):   
        ...
        "Never mind, you look good like that.":
                if "wardrobe" not in newgirl["Mystique"].RecentActions: 
                        ...
                        if newgirl["Mystique"].Chat[1] <= 1:                
                                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, 15)
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 40, 20)
                                ch_m "I thought so as well."
                        elif newgirl["Mystique"].Chat[1] <= 10:
                                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, 5)
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 40, 7)
                                ch_m "Isn't it?" 
                        elif newgirl["Mystique"].Chat[1] <= 50:
                                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, 1)
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 40, 1) 
    ...
    menu Mystique_Clothes_Outfits:                                                                                 # Outfits
        ...
        "Your birthday suit looks really great. . .":                                     
            ...
            if not newgirl["Mystique"].Chest and not newgirl["Mystique"].Panties and not newgirl["Mystique"].Over and not newgirl["Mystique"].Legs and not newgirl["Mystique"].Hose:  
                ...
                ch_m "Apparently so. . ."  
            elif newgirl["Mystique"].SeenChest and newgirl["Mystique"].SeenPussy and Mod_ApprovalCheck("Mystique", 1200, TabM=(5-Public)):
                #if you've seen it all and she likes you well enough (yes)
                ch_m "I'll take that as an invitation. . ."  
                $ Line = 1
            elif Mod_ApprovalCheck("Mystique", 2000, TabM=(5-Public)):
                #if you haven't seen everything but she really likes you (yes)
                ch_m "I suppose you've earned it. . ."    
                $ Line = 1
            elif newgirl["Mystique"].SeenChest and newgirl["Mystique"].SeenPussy and Mod_ApprovalCheck("Mystique", 1200, TabM=0):
                # if you've seen it but it's in public (no)
                ch_m "As you're well aware, but this isn't the appropriate venue. . ."  
            elif Mod_ApprovalCheck("Mystique", 2000, TabM=0):
            ...
            elif Mod_ApprovalCheck("Mystique", 1000, TabM=0):     
                ...
                menu:
                    "You know, you should wear this one out. [[set current outfit]":
                        if "exhibitionist" in newgirl["Mystique"].Traits:
                            ...
                            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 50, 10) 
                            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 70, 5) 
                            $ newgirl["Mystique"].Shame = newgirl["Mystique"].OutfitShame[0]
                            call NewGirl_Face("Mystique","sexy",1)
                        elif Mod_ApprovalCheck("Mystique", 800, "I") and Mod_ApprovalCheck("Mystique", 2800, TabM=0): 
                            ch_m "Oooh, that would cause quite a stir. . ." 
                            $ newgirl["Mystique"].Outfit = "nude"
                            $ newgirl["Mystique"].Shame = newgirl["Mystique"].OutfitShame[0]
                        elif Mod_ApprovalCheck("Mystique", 400, "I") and Mod_ApprovalCheck("Mystique", 1200, TabM=0): 
    ...
    menu Mystique_Clothes_Over:                                                                                            # Overshirts
        "Why don't you go with no Overshirt?" if newgirl["Mystique"].Over:
            call NewGirl_Face("Mystique","bemused", 1)
            if Mod_ApprovalCheck("Mystique", 800, TabM=(3-Public)) and (newgirl["Mystique"].Chest or newgirl["Mystique"].SeenChest):
                ch_m "Certainly."
            elif Mod_ApprovalCheck("Mystique", 1200, TabM=0):
                call Mystique_NoBra
                if not _return:
                    jump Mystique_Clothes                    
            $ Line = newgirl["Mystique"].Over
            call SetOverMystique(0)
    ...
    label Mystique_NoBra: #fix test this
        menu:
            ...
            "Then you could slip something on under it. . .":   
                        if (newgirl["Mystique"].SeenChest and Mod_ApprovalCheck("Mystique", 1000, TabM=(4-Public))) or Mod_ApprovalCheck("Mystique", 1200, TabM=(5-Public)):
                                ch_m "-not that I'm overly concerned about it. . ."
                        elif Mod_ApprovalCheck("Mystique", 900, TabM=2) and "black bra" in newgirl["Mystique"].Inventory:
                                ch_m "I suppose I could."
                                call SetChestMystique("black bra")
                                call Mystique_Tits_Up
                                "She pulls out her black bra and slips it on under her [newgirl[Mystique].Over]."
                        elif Mod_ApprovalCheck("Mystique", 800, TabM=2):
                                ch_m "I suppose I could."
                                call SetChestMystique("top")
                                "She pulls out her top and slips it on under her [newgirl[Mystique].Over]."
                        elif Mod_ApprovalCheck("Mystique", 700, TabM=(3-Public)):
                                ch_m "I suppose I could."
                                call SetChestMystique("workout top")
                                call Mystique_Tits_Up
            ...
            "You could always just wear nothing at all. . .":
                        if Mod_ApprovalCheck("Mystique", 1100, "LI", TabM=(3-Public)) and newgirl["Mystique"].Love > newgirl["Mystique"].Inbt:               
                                ch_m "The things I do for you. . ."
                        elif Mod_ApprovalCheck("Mystique", 700, "OI", TabM=(3-Public)) and newgirl["Mystique"].Obed > newgirl["Mystique"].Inbt:
                                ch_m "If that's what you insist. . ."
                        elif Mod_ApprovalCheck("Mystique", 600, "I", TabM=(3-Public)):
                                ch_m "I suppose I could. . ."
                        elif Mod_ApprovalCheck("Mystique", 1300, TabM=(3-Public)):
                                ch_m "Very well."
                        else: 
                                call NewGirl_Face("Mystique","surprised")
    ...
    menu Mystique_Clothes_Legs:                                                                                                    # Leggings    
        "Maybe go without the pants." if ModPantsNum("Mystique") > 5:
            call NewGirl_Face("Mystique","sexy", 1)
            if newgirl["Mystique"].SeenPanties and newgirl["Mystique"].Panties and Mod_ApprovalCheck("Mystique", 500, TabM=(6-Public)):
                ch_m "Fine."
            elif newgirl["Mystique"].SeenPussy and Mod_ApprovalCheck("Mystique", 900, TabM=(5-Public)):
                ch_m "Fine."
            elif Mod_ApprovalCheck("Mystique", 1300, TabM=(2-Public)) and newgirl["Mystique"].Panties:
                ch_m "It's not like I haven't worn this look before. . ."
            elif Mod_ApprovalCheck("Mystique", 800) and not newgirl["Mystique"].Panties:
        ...
        "Maybe go without the skirt." if ModPantsNum("Mystique") == 3:
            call NewGirl_Face("Mystique","sexy", 1)
            if newgirl["Mystique"].SeenPanties and newgirl["Mystique"].Panties and Mod_ApprovalCheck("Mystique", 500, TabM=(6-Public)):
                ch_m "Fine."
            elif newgirl["Mystique"].SeenPussy and Mod_ApprovalCheck("Mystique", 900, TabM=(5-Public)):
    ...
    label Mystique_NoPantiesOn: #fix test this
        ...
        menu:
            ...
            "Then you could slip on a pair. . .":   
                        if (newgirl["Mystique"].SeenPussy and Mod_ApprovalCheck("Mystique", 1100, TabM=(5-Public))) or Mod_ApprovalCheck("Mystique", 1500, TabM=(5-Public)):
                                $ newgirl["Mystique"].Blush = 1
                                ch_m "I didn't say that bothered me. . ."
                                $ newgirl["Mystique"].Blush = 0                
                        elif Mod_ApprovalCheck("Mystique", 800, TabM=(5-Public)) and "lace panties" in newgirl["Mystique"].Inventory:
                        ...
                        elif Mod_ApprovalCheck("Mystique", 700, TabM=(5-Public)):
                                ch_m "Yeah, I guess."
                                call SetPantiesMystique("black panties")
                                "She pulls out her white panties, and with your back turned she removes her pants, and slips her panties on."                   
                        elif Taboo and Mod_ApprovalCheck("Mystique", 800, TabM=0):
            ...
            "You could always just wear nothing at all. . .":
                        if Mod_ApprovalCheck("Mystique", 1100, "LI", TabM=(5-Public)) and newgirl["Mystique"].Love > newgirl["Mystique"].Inbt:               
                                ch_m "I suppose I could. . ."
                        elif Mod_ApprovalCheck("Mystique", 700, "OI", TabM=(5-Public)) and newgirl["Mystique"].Obed > newgirl["Mystique"].Inbt:
                                ch_m "If you'd like. . ."
                        elif Mod_ApprovalCheck("Mystique", 600, "I", TabM=(5-Public)):
                                ch_m "I certainly could. . ."
                        elif Mod_ApprovalCheck("Mystique", 1300, TabM=(5-Public)):
                                ch_m "Very well."
                        else: 
                                call NewGirl_Face("Mystique","surprised")
                                $ newgirl["Mystique"].Brows = "angry"
    ...
    menu Mystique_Clothes_Under:  
        ...
        "How about you lose the [newgirl[Mystique].Chest]?" if newgirl["Mystique"].Chest:
            ...
            if newgirl["Mystique"].SeenChest and Mod_ApprovalCheck("Mystique", 900, TabM=(4-Public)):
                ch_m "Of course."    
            elif Mod_ApprovalCheck("Mystique", 1100, TabM=2):
                if Taboo:
        ...
        "I like that workout top you have." if newgirl["Mystique"].Chest != "workout top":
            if newgirl["Mystique"].SeenChest or Mod_ApprovalCheck("Mystique", 1000, TabM=(3-Public)):
                ch_m "So do I."   
                call SetChestMystique("workout top")
        ...
        "I like that yellow bikini you have." if newgirl["Mystique"].Chest != "yellow bikini":
            if newgirl["Mystique"].SeenChest or Mod_ApprovalCheck("Mystique", 1000, TabM=(3-Public)):
                ch_m "So do I."   
                call SetChestMystique("yellow bikini")
                $ newgirl["Mystique"].TitsUp = 1
            else:                
                ch_m "I don't think that would be appropriate. . ."    
        ...
        "You could lose those panties. . ." if newgirl["Mystique"].Panties:
            call NewGirl_Face("Mystique","bemused", 1)
            if (Mod_ApprovalCheck("Mystique", 900) or newgirl["Mystique"].SeenPussy) and not Taboo:
                ...
                elif Mod_ApprovalCheck("Mystique", 500, "O"):
                        ch_m "If you'd like."
                elif Mod_ApprovalCheck("Mystique", 350, "I"):
                        ch_m "I do enjoy going without them. . ."
                else:
                        ch_m "Very well."         
            else:                       
                #low approval or not wearing pants or in public 
                if Mod_ApprovalCheck("Mystique", 1100, "LI", TabM=(4-Public)) and newgirl["Mystique"].Love > newgirl["Mystique"].Inbt:               
                        ch_m "I don't exactly mind you seeing. . ."
                elif Mod_ApprovalCheck("Mystique", 700, "OI", TabM=(4-Public)) and newgirl["Mystique"].Obed > newgirl["Mystique"].Inbt:
                        ch_m "I suppose I could. . ."
                elif Mod_ApprovalCheck("Mystique", 600, "I", TabM=(4-Public)):
                        ch_m "Why not."
                elif Mod_ApprovalCheck("Mystique", 1300, TabM=(4-Public)):
                        ch_m "Fine."
                else: 
                        call NewGirl_Face("Mystique","surprised")
                        $ newgirl["Mystique"].Brows = "angry"
            ...
            call SetPantiesMystique(0)
            if newgirl["Mystique"].Legs:
                if Taboo or Mod_ApprovalCheck("Mystique", 1100) or newgirl["Mystique"].SeenPussy:
        ...
        "Why don't you wear the black panties instead?" if newgirl["Mystique"].Panties and newgirl["Mystique"].Panties != "black panties":
            if Mod_ApprovalCheck("Mystique", 1100, TabM=(4-Public)):
                    ch_m "Ok."
                    call SetPantiesMystique("black panties")
            else:                
        ...
        "Why don't you wear that yellow bikini panties?" if newgirl["Mystique"].Panties and newgirl["Mystique"].Panties != "yellow bikini":
            if Mod_ApprovalCheck("Mystique", 1100, TabM=(4-Public)):
                    ch_m "Ok."
                    call SetPantiesMystique("yellow bikini")
            else:                
                    ch_m "I really don't see how that's any of your concern."
        ...
        "Why don't you wear the black lingerie set instead?" if newgirl["Mystique"].Panties and newgirl["Mystique"].Panties != "black lingerie":
            if Mod_ApprovalCheck("Mystique", 1300, TabM=(4-Public)):
                    ch_m "Fine."
                    call SetPantiesMystique("black lingerie")
            else:
                    ch_m "I really don't see how that's any of your concern."
    ...
    menu Mystique_Clothes_Misc:                     
        ...
        "Hair options":
            ...
            menu Mystique_Clothes_Misc_Hair:
                ...
                "You look good with your hair flowing." if newgirl["Mystique"].Hair != "wave":
                    if Mod_ApprovalCheck("Mystique", 600):
                        ch_m "Like this?"
        ...
        "I like some hair down there." if not newgirl["Mystique"].Pubes and "pubes" not in newgirl["Mystique"].Todo:
            call NewGirl_Face("Mystique","bemused", 1)
            $ Approval = Mod_ApprovalCheck("Mystique", 1150, TabM=0)
            if Mod_ApprovalCheck("Mystique", 850, "L", TabM=0) or (Approval and newgirl["Mystique"].Love > 2 * newgirl["Mystique"].Obed):               
                ch_m "If you like that sort of thing. . ."
            elif Mod_ApprovalCheck("Mystique", 500, "I", TabM=0) or (Approval and newgirl["Mystique"].Inbt > newgirl["Mystique"].Obed):
                ch_m "I could go a bit more. . . wild."
            elif Mod_ApprovalCheck("Mystique", 400, "O", TabM=0) or Approval:
                ch_m "If you insist. . ."
            else: 
                call NewGirl_Face("Mystique","surprised")
                $ newgirl["Mystique"].Brows = "angry"
        ...
        "You know, you'd look really nice with some ring body piercings." if newgirl["Mystique"].Pierce != "ring" and (newgirl["Mystique"].SeenPussy or newgirl["Mystique"].SeenChest) and "ring" not in newgirl["Mystique"].Todo:
            call NewGirl_Face("Mystique","bemused", 1)
            $ Approval = Mod_ApprovalCheck("Mystique", 1350, TabM=0)
            if Mod_ApprovalCheck("Mystique", 900, "L", TabM=0) or (Approval and newgirl["Mystique"].Love > 2* newgirl["Mystique"].Obed):   
                    ch_m "A little handhold, I assume?"
            elif Mod_ApprovalCheck("Mystique", 600, "I", TabM=0) or (Approval and newgirl["Mystique"].Inbt > newgirl["Mystique"].Obed):
                    ch_m "I do like a nice ring. . ."
            elif Mod_ApprovalCheck("Mystique", 500, "O", TabM=0) or Approval:
        ...
        "You know, you'd look better without those piercings." if newgirl["Mystique"].Pierce:
            call NewGirl_Face("Mystique","bemused", 1)
            $ Approval = Mod_ApprovalCheck("Mystique", 1350, TabM=0)
            if Mod_ApprovalCheck("Mystique", 950, "L", TabM=0) or (Approval and newgirl["Mystique"].Love > newgirl["Mystique"].Obed):   
                ch_m "If they aren't working for you. . ."
            elif Mod_ApprovalCheck("Mystique", 700, "I", TabM=0) or (Approval and newgirl["Mystique"].Inbt > newgirl["Mystique"].Obed):
                ch_m "They were being a nuisance."
            elif Mod_ApprovalCheck("Mystique", 600, "O", TabM=0) or Approval:
...
label Mystique_Clothes_Schedule(Cnt = 0):
        ...
        if Mod_ApprovalCheck("Mystique", 1500, "LO"):
                ch_m "I'm open to suggestions."
                $ Cnt = 3
        elif Mod_ApprovalCheck("Mystique", 1000, "LO"):
...
label Mystique_OutfitShame(Custom = 3, Check = 0, Count = 0, Tempshame = 50, Agree = 1):                                                                             #sets custom outfit    
            ...
            if Custom == 9:
                        ...
                        if Mod_ApprovalCheck("Mystique", 1200, TabM=0) or Mod_ApprovalCheck("Mystique", 500, "I", TabM=0):  
                            ch_m "A bit daring. . ."        
                        else:
                            ch_m "I'm not sure about this top."
            elif Count >= 5:
                        if Mod_ApprovalCheck("Mystique", 2300, TabM=0) or Mod_ApprovalCheck("Mystique", 800, "I", TabM=0):  
            ...
            elif (Mod_ApprovalCheck("Mystique", 2700, TabM=0) or Mod_ApprovalCheck("Mystique", 950, "I", TabM=0)):  
            ...
            if not Check:
                        ...
                        if not newgirl["Mystique"].Panties:
                            if Mod_ApprovalCheck("Mystique", 500, "I", TabM=0):
                                ch_m "I do enjoy going without panties."
                            else:
                                ch_m "I don't know about going without panties in this situation."
                    
            elif Count >= 10:
                if Mod_ApprovalCheck("Mystique", 2000, TabM=0) or Mod_ApprovalCheck("Mystique", 700, "I", TabM=0):
                        ch_m "I hope you don't expect me to wear this out. . ."        
                else:
                        call NewGirl_Face("Mystique","angry", 1)
                        ch_m "I couldn't exactly wear this outside. . ."                
            elif (Mod_ApprovalCheck("Mystique", 2500, TabM=0) or Mod_ApprovalCheck("Mystique", 800, "I", TabM=0)):  
            ...
            if Check:
                    ...
                    if Taboo >= 40: #E_Loc != "bg player" and newgirl["Mystique"].Loc != "bg Mystique": 
                            ...
                            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 80, 10)
                    elif Tempshame <= 5:
                            call NewGirl_Face("Mystique","smile")
                            ch_m "Yes, it's a fine choice."
                    elif Tempshame <= 15 and (Mod_ApprovalCheck("Mystique", 1700, TabM=0, C = 0) or Mod_ApprovalCheck("Mystique", 400, "I", TabM=0, C = 0)):        
                    ...
                    #        $ Agree = 0
                    ...
                    elif Tempshame <= 25 and (Mod_ApprovalCheck("Mystique", 2300, TabM=0, C = 0) or Mod_ApprovalCheck("Mystique", 700, "I", TabM=0, C = 0)):
                            ...
                            $ Agree = 0
                    elif (Mod_ApprovalCheck("Mystique", 2500, TabM=0, C = 0) or Mod_ApprovalCheck("Mystique", 800, "I", TabM=0, C = 0)):
                            call NewGirl_Face("Mystique","bemused", 1)
            ...
            if Check:
                    ...
                    pass
            elif Tempshame <= 15 and (Mod_ApprovalCheck("Mystique", 1600) or Mod_ApprovalCheck("Mystique", 550, "I")):
                    ...
                    #If the outfit is light but she's in the gym
                    pass
            elif Tempshame <= 25 and (Mod_ApprovalCheck("Mystique", 2200) or Mod_ApprovalCheck("Mystique", 700, "I")):
                    #If the outfit is sexy but she's cool with that
                    pass
            elif (Mod_ApprovalCheck("Mystique", 2500) or Mod_ApprovalCheck("Mystique", 900, "I")):
...
label Mystique_First_Les(Silent = 0, Undress = 0, GirlsNum = 0): #checked when she engages in a les scene  ## call Mystique_First_Les(0,1)
    ...
    if not Silent: 
        ...
        if newgirl["Mystique"].LikeRogue >= 60 and Mod_ApprovalCheck("Mystique", (1500-(10*newgirl["Mystique"].Les)-(10*(newgirl["Mystique"].LikeRogue-60)))): #If she likes both of you a lot, threeway
                $ State = "threeway"
        elif Mod_ApprovalCheck("Mystique", 1000): #If she likes you well enough, Hetero
                $ State = "hetero"            
        ...
        if Taboo and not Mod_ApprovalCheck("Mystique", 1500):
                call NewGirl_Face("Mystique","surprised", 2)
                ch_m "Um, you should put that away in public."
                call NewGirl_Face("Mystique","bemused", 1)
                if newgirl["Mystique"].SeenPeen == 1: 
                    ch_m "Or maybe. . ."
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 15)                
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 20)
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 60, 35)  
                    
        elif newgirl["Mystique"].SeenPeen > 10:
                return    
        elif Mod_ApprovalCheck("Mystique", 1200) or Mod_ApprovalCheck("Mystique", 500, "L"):
                call NewGirl_Face("Mystique","sly",1)
                if newgirl["Mystique"].SeenPeen == 1: 
                    call NewGirl_Face("Mystique","surprised",2)
                    ...
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 7) 
    ...
    if newgirl["Mystique"].SeenPeen == 1:            
        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 10)                
        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 90, 25)
        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 60, 20) 
        $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 200, 5)
...
label SetLooksLikeMystique(Appearance = "Mystique"):
    if newgirl["Mystique"].LooksLike != Appearance:
        $ newgirl["Mystique"].LooksLike = Appearance
        call Mod_Update_Mystique_Image(1)
    return

label Mod_Update_Mystique_Image(furtransition = 0):
    if furtransition:
        if renpy.showing("Mystique_Sprite"):
            show Mystique_Sprite with fur
        elif renpy.showing("Mystique_Doggy"):
            show Mystique_Doggy with fur
        elif renpy.showing("Mystique_SexSprite"):
            show Mystique_SexSprite with fur
        elif renpy.showing("Mystique_BJ_Animation"):
            show Mystique_BJ_Animation with fur
        elif renpy.showing("Mystique_HJ_Animation"):
            show Mystique_HJ_Animation with fur
        elif renpy.showing("Mystique_TJ_Animation"):
            show Mystique_TJ_Animation with fur
    else:
        if renpy.showing("Mystique_Sprite"):
            show Mystique_Sprite
        elif renpy.showing("Mystique_Doggy"):
