    ...
    while Round >=0:  
        ...
        if Count != 2:   
            if newgirl["Mystique"].Arms and not newgirl["Mystique"].Over:          
                ...
                if Mod_ApprovalCheck("Mystique", 750, TabM = 3):
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 1)
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 25, 1)                 
                    $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 60, 3)
                ...
                if Mod_ApprovalCheck("Mystique", 1000, TabM = 3) or (newgirl["Mystique"].SeenPanties and not Taboo):
                    ...
                    $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 60, 5)
                    ...
                    if not newgirl["Mystique"].SeenPanties:
                        ...
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 200, 2)
                ...
                if HoseNum("Mystique") >= 10:
                    if Mod_ApprovalCheck("Mystique", 1200, TabM = 3):
                        $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 50, 6)
                        $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 60, 6)
                    else:    
                        jump Mystique_Strip_Ultimatum
                        
                elif HoseNum("Mystique") >= 5 and Mod_ApprovalCheck("Mystique", 1200, TabM = 3):
                    if Mod_ApprovalCheck("Mystique", 1200, TabM = 3):
                        $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 50, 4)
                        $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 60, 4)
                    else:    
                        jump Mystique_Strip_Ultimatum
                else:
                    $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 50, 3)
                    $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 60, 3)
                ...
                if Mod_ApprovalCheck("Mystique", 1200, TabM = 3) or (newgirl["Mystique"].SeenChest and not Taboo):
                    ...
                    $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 80, 15)     
                    $ Line = newgirl["Mystique"].Over
                    call SetOverMystique(0)
                    if not newgirl["Mystique"].SeenChest:
                        ...
                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 200, 4)
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 3)
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 200, 3)    
                ...
                if Mod_ApprovalCheck("Mystique", 1350, TabM = 3) or (newgirl["Mystique"].SeenPussy and not Taboo):
                    $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 75, 10)    
                    $ Line = newgirl["Mystique"].Legs
                    call SetLegsMystique(0)
                    if not newgirl["Mystique"].SeenPussy:
                        ...
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 4)
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 200, 4)  
                        ...
                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 1)                              
                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 75, 1)
                        "She unzips and pulls down her [Line], dropping them to the floor."   
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 2)           
                    $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 85, 15)
                else:
                    jump Mystique_Strip_Ultimatum
                ...
                if Mod_ApprovalCheck("Mystique", 1350, TabM = 3) or (newgirl["Mystique"].SeenPussy and not Taboo):    
                    ...
                    if not newgirl["Mystique"].Chest:
                        if not newgirl["Mystique"].SeenChest:                
                            ...
                            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 60, 15)                
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 3)                              
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 75, 1)
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 3)
                    else:
                ...
                $ Count = 2        
        $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 70, 2)               #lust/Focus
        if "exhibitionist" in newgirl["Mystique"].Traits:
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 200, 2)
        $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 60, 3)
        if Trigger2 == "jackin":
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 200, 2)
            $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 200, 5)
                ...
                if "watching" not in newgirl["Mystique"].RecentActions:
                    if Count != 2:
                        if Taboo and newgirl["Mystique"].Strip <= 10:
                            ...
                            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 70, 2) 
...
label Mystique_Strip_Ultimatum:      
    ...
    menu:
        ...
        "You'd better." if newgirl["Mystique"].Forced:
            if not Mod_ApprovalCheck("Mystique", 500, "O", TabM=5) and not Mod_ApprovalCheck("Mystique", 800, "L", TabM=5):                    
        ...
        "You can do better than that. Keep going." if not newgirl["Mystique"].Forced:
            if not Mod_ApprovalCheck("Mystique", 300, "O", TabM=5) and not Mod_ApprovalCheck("Mystique", 700, "L", TabM=5):                   
                call MystiqueFace("angry")
                ch_m "I think you're overstepping your bounds here, [newgirl[Mystique].Petname]."
                ch_m "Remember your place."  
                $ newgirl["Mystique"].RecentActions.append("angry")
            ...
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 3)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 75, 5)
            $ Tempmod += 25
            $ newgirl["Mystique"].Forced = 1
            call MystiqueFace("sad")
...
label Mystique_Top_Off(Intro = 1, Line = 0, Cnt = 0):                                                    # Will she take her top off? Modifiers
    ...
    if newgirl["Mystique"].SeenChest and Mod_ApprovalCheck("Mystique", 600) and not Taboo:                              #You've seen her tits.
        $ Tempmod += 20
    if "exhibitionist" in newgirl["Mystique"].Traits:
        $ Tempmod += (4*Taboo)
    if "dating" in newgirl["Mystique"].Traits or "sex friend" in newgirl["Mystique"].Petnames and not Taboo:
    ...
    $ Approval = Mod_ApprovalCheck("Mystique", 1200, TabM = 4) # 110, 125, 140, 300 taboo, -20 if already seen
    
    if Situation == "auto":  
        $Line = 0
        if newgirl["Mystique"].Over: # If she's in a top
            if newgirl["Mystique"].Chest and Mod_ApprovalCheck("Mystique", 800, TabM = 1):
                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 40, 1)
            elif Approval >= 2 or (newgirl["Mystique"].SeenChest and Mod_ApprovalCheck("Mystique", 600) and not Taboo):
            ...
            if not newgirl["Mystique"].Chest:
                if Taboo:
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 90, (int(Taboo/20)))   
                call Mystique_First_Topless(1)
                
        if newgirl["Mystique"].Chest:
            if Approval >= 2 or (newgirl["Mystique"].SeenChest and Mod_ApprovalCheck("Mystique", 600) and not Taboo):
                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 1)
                if Taboo:
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 90, (int(Taboo/20)))  
                if Line:
    ...
    if Approval >= 2:                                                                               # Does she assume top off?            
        ...
        if newgirl["Mystique"].Forced:
            call MystiqueFace("sad", 1)
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 20, -2, 1)
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -3, 1)
    ...
    menu:
        ...
        "Ok, that's fine." if "no topless" not in newgirl["Mystique"].RecentActions: 
            ...
            if newgirl["Mystique"].Forced:
                ...
                if "ask topless" not in newgirl["Mystique"].DailyActions:
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 20, 2)
        ...
        "How about just the [newgirl[Mystique].Over]?" if newgirl["Mystique"].Over:                                                # asked to go shirtless. 
            if Mod_ApprovalCheck("Mystique", 1000, TabM = 3) and newgirl["Mystique"].Chest: #80, 160 taboo 
                call MystiqueFace("sexy")
                ...
                call SetOverMystique(0)
                "Mystique shrugs off her [Line]."   
                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 30, 1)
                ...
                menu:
                    ...
                    "I think I could handle it.":
                        if Mod_ApprovalCheck("Mystique", 700, "I", TabM=3) or Mod_ApprovalCheck("Mystique", 1100, TabM=3):
                            call MystiqueFace("bemused", 1)
                            ch_m "Well, I suppose it couldn't hurt to try."                               
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 20, 2)                                                         
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 1)
                            call MystiqueFace("sexy")
                            $ Line = newgirl["Mystique"].Over
                            call SetOverMystique(0)
        ...
        "Come on, Please? [[take it all off]":                                                                      # asked to go topless. 110, 270 Taboo   
            if Approval and Mod_ApprovalCheck("Mystique", 600, "L", TabM=1):                 
                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 40, 2)
                call MystiqueFace("sexy")
                if "no topless" in newgirl["Mystique"].RecentActions:     
...
label Mystique_ToplessorNothing:
    call MystiqueFace("angry")
    if Mod_ApprovalCheck("Mystique", 1000, "OI", TabM = 4) and Mod_ApprovalCheck("Mystique", 500, "O", TabM = 3):       
        #She agrees to your ultimatum 
        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 20, -2, 1)
        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 80, -5, 1)
        ...
        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -10)                
        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 40, -1, 1)
        if "no topless" in newgirl["Mystique"].RecentActions: 
            $ newgirl["Mystique"].Brows = "angry"
...
label Mystique_First_Topless(Silent = 0, TempLine = 0):          
    ...
    call Mod_DrainWord("Mystique","no topless")
    call Mystique_Tits_Up
    ...
    if not Silent:
        ...
        menu:
            ...
            "Definitely, and more.":            
                ...
                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 40, 20)  
            ...
            ". . . [[EXCELSIOR!]":            
                ...
                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 40, 10)  
            "Huh, not what I was expecting. . .":        
                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -30)
                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 60, 25)
                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, -15)                          
        ...
        if Mod_ApprovalCheck("Mystique", 800) and not newgirl["Mystique"].Forced:                #if she's not forced and happy about it
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, 15) 
            ...
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -40)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, -20)                          
            call MystiqueFace("angry")
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 40)
    return
...
label Mystique_Bottoms_Off(Intro = 1, Line = 0, Cnt = 0):
    ...
    if newgirl["Mystique"].SeenPussy and Mod_ApprovalCheck("Mystique", 800): #You've seen her Pussy.
        $ Tempmod += 20
    elif not newgirl["Mystique"].Panties:
        $ Tempmod -= 20
    elif newgirl["Mystique"].SeenPanties and Mod_ApprovalCheck("Mystique", 600): #You've seen her panties.
        $ Tempmod += 5 
    if Intro == "dildo":
        $ Tempmod += 20
    if "exhibitionist" in newgirl["Mystique"].Traits:
    ...
    $ Approval = Mod_ApprovalCheck("Mystique", 1300, TabM = 5) # 120, 135, 150, -200(320) taboo, -25 if already seen
    ...
    if Situation == "auto":
            ...
            if not newgirl["Mystique"].Upskirt:                      
                if newgirl["Mystique"].Legs == "skirt" and not newgirl["Mystique"].Upskirt:                                          
                    ...
                    if Approval >= 2 or (newgirl["Mystique"].SeenPussy and Mod_ApprovalCheck("Mystique", 700) and not Taboo):
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 60, 1)
                        if Taboo:
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 90, (int(Taboo/20)))                 
                ...
                if ModPantsNum("Mystique") >= 5 or HoseNum("Mystique") >= 5:            
                    ...
                    if Taboo:
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 90, (int(Taboo/10)))  
                    $ Cnt = 1 
            ...
            menu:            
                ...
                "Ok, never mind." if "no bottomless" not in newgirl["Mystique"].RecentActions:  
                    if "ask bottomless" not in newgirl["Mystique"].DailyActions:
                        $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 80, 2)
                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, 1)
                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 1)
                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 2)
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 2)
                    if newgirl["Mystique"].Forced:
                        ...
                        ch_m "Very. . . generous."
                        if "ask bottomless" not in newgirl["Mystique"].DailyActions:
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 20, 3)
                ...
                "Come on, Please?":       
                    if "no bottomless" in newgirl["Mystique"].DailyActions:  
                            ...
                            if Approval and Mod_ApprovalCheck("Mystique", 600, "L", TabM=2):   
                                call MystiqueFace("sexy", 1)
                ...
                "No, lose 'em.":            #85 and -200 taboo             
                    if (Approval and newgirl["Mystique"].Obed >= 250) or (Mod_ApprovalCheck("Mystique", 1000, "OI", TabM = 5) and Mod_ApprovalCheck("Mystique", 500, "O", TabM = 3)):                    
                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 20, -1, 1)
                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -5, 1)
                        ...
                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -10)
                        if Mod_ApprovalCheck("Mystique", 400, "O"):
                            ch_m "Definitely not." 
                        else:
                            call MystiqueFace("angry")
...
label Mystique_Bottoms_Off_Legs:    
    ...
    if newgirl["Mystique"].Forced:        
        call MystiqueFace("sad", 1)
    elif Mod_ApprovalCheck("Mystique", 1100, "OI", TabM = 3):        
        call MystiqueFace("sly")
    elif Mod_ApprovalCheck("Mystique", 1400, TabM = 3):  
        call MystiqueFace("sexy", 1)
    else:
        call MystiqueFace("bemused", 1)
...
label Mystique_NoPanties: 
    ...
    menu:
        ...
        "Could you do it anyway?":
            if Mod_ApprovalCheck("Mystique", 1100, "LI", TabM=1):                                             
                ch_m "I suppose. . . "
            else:
                ch_m "I'm afraid not."
                call Mystique_Bottoms_Off_Refused
                $ renpy.pop_call()  
        "Don't care, lose'em.":
            if Mod_ApprovalCheck("Mystique", 800, "OI", TabM=1):
                ch_m "If you insist."  
            else:
                call Mystique_Bottoms_Off_Refused
                $ renpy.pop_call()  
...
label Mystique_Bottoms_Off_Refused:     
    ...
    menu:
        ...
        "Yeah, let's do something else.":
            ...
            ch_m "Your loss."               
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 50, 5)
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -2, 1)
...
label Mystique_First_Bottomless(Silent = 0): 
    ...
    call Mod_DrainWord("Mystique","no bottomless")
    ...
    if not Silent:
        ...
        menu:        
            ...
            "Delicious. . .":            
                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 20)
                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 60, 25)            
                call MystiqueFace("smile")
                ch_m "I'm aware. . . "
                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 40, 20)
            "I see you keep it smooth down there." if not newgirl["Mystique"].Pubes:          
                ...
                ch_m "Yes?"
                if Mod_ApprovalCheck("Mystique", 700, "LO"):    
                    call MystiqueFace("bemused")
                    menu:
            ...
            "Not bad for someone your age.":        
                ...
                if not newgirl["Mystique"].Forced and not Mod_ApprovalCheck("Mystique", 900, "LO"):                    
                        $ K_RecentActions.append("angry")
                        $ K_DailyActions.append("angry")  
                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 25)
                ch_m "You will regret that remark. . ."
    else:
        
        if Mod_ApprovalCheck("Mystique", 800) and not newgirl["Mystique"].Forced:
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 20)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 60, 25)          
            call MystiqueFace("smile")
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 40, 20)
            ...
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 70, -20)
            call MystiqueFace("angry")
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 30)
    return
...
label Mystique_First_Peen(Silent = 0, Undress = 0, GirlsNum = 0): #checked each time she sees your cock  ## call Mystique_First_Peen(0,1)
    ...
    if not Silent:        
        ...
        if False:
#        if not Mod_ApprovalCheck("Mystique", 800) and not Mod_ApprovalCheck("Mystique", 400, "I") and "detention" not in newgirl["Mystique"].RecentActions and "classcaught" not in newgirl["Mystique"].RecentActions:
                ...
                if newgirl["Mystique"].SeenPeen == 1: 
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -10)                
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 35)
        ...
        elif (Taboo and not Mod_ApprovalCheck("Mystique", 1500) or newgirl["Mystique"].SEXP < 10) and bg_current != "bg showerroom":
                ...
                if newgirl["Mystique"].SeenPeen == 1: 
                    ...
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 30, 15) 
