...
image Mystique_Sprite:
    ...
    "newgirl['Mystique'].LooksLike", "Mystique_" + str(newgirl['Mystique'].LooksLike) + "_Sprite",
...
image Mystique_HJ_Animation:
    ConditionSwitch(          
    "newgirl['Mystique'].LooksLike == 'Raven'", "Mystique_Mystique_HJ_Animation",
    "newgirl['Mystique'].LooksLike", "Mystique_" + str(newgirl['Mystique'].LooksLike) + "_HJ_Animation",
    ...
    "True", "Mystique_Mystique_HJ_Animation",
    ),
...
image Mystique_BJ_Animation:
    ...
    "newgirl['Mystique'].LooksLike", "Mystique_" + str(newgirl['Mystique'].LooksLike) + "_BJ_Animation",
    ...
    "True", "Mystique_Mystique_BJ_Animation",
    ),
    ...
    LiveComposite(    
        ...
        (0,0), ConditionSwitch(                                                                 # cock
         ...
         (0,0), ConditionSwitch(                                                                 # the masked overlay for when her head overlaps the cock
             ...
             #"Speed == 3", At(AlphaMask("Emma_BJ_Head_2", "Emma_BJ_Mask_"), BJ_Sucking()),
...
image Mystique_Emma_BJ_Head_3:
    AlphaMask("Mystique_Emma_BJ_Head_2", "Emma_BJ_Mask_")    #zoom .75
    #zoom 4.05
    pos (275,-110)
    offset (-240, -200) #-140 - 125
