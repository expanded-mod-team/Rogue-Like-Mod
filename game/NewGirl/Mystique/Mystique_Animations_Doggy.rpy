...
image Mystique_Doggy_Body:
    LiveComposite(                                                                                         #Upper body
        ...
        (0,0), ConditionSwitch(                                                                                 #tanktop
            ...
            "True", im.MatrixColor("images/MystiqueDoggy/Mystique_Doggy_Chest" + str(newgirl['Mystique'].Colors['Chest'].colored) + "_" + str(newgirl['Mystique'].Chest) + ".png",im.matrix.opacity(float(newgirl['Mystique'].Colors['Chest'].opacity)/255.0)*im.matrix.tint(float(newgirl['Mystique'].Colors['Chest'].red)/255.0, float(newgirl['Mystique'].Colors['Chest'].green)/255.0, float(newgirl['Mystique'].Colors['Chest'].blue)/255.0)),
            "True", Null(),            
            ), 
...
image Mystique_Doggy_Ass:
    LiveComposite(                                                                                          #Lower body
        ...
        (0,0), ConditionSwitch(                                                                                 #Panties back
            ...
            "True", im.MatrixColor("images/MystiqueDoggy/Mystique_Doggy_Panties" + str(newgirl['Mystique'].Colors['Panties'].colored) + "_" + str(newgirl['Mystique'].Panties) + "_Back.png",im.matrix.opacity(float(newgirl['Mystique'].Colors['Panties'].opacity)/255.0)*im.matrix.tint(float(newgirl['Mystique'].Colors['Panties'].red)/255.0, float(newgirl['Mystique'].Colors['Panties'].green)/255.0, float(newgirl['Mystique'].Colors['Panties'].blue)/255.0)),
            "True", Null(),                     
            ),  
        (0,0), ConditionSwitch(                                                                                 #Wet look
        ...
        (0,0), ConditionSwitch(                                                                                 #Panties if Down
            "not newgirl['Mystique'].PantiesDown or (newgirl['Mystique'].Legs == 'pants' and not newgirl['Mystique'].Upskirt)", Null(),
            "True", im.MatrixColor("images/MystiqueDoggy/Mystique_Doggy_Panties" + str(newgirl['Mystique'].Colors['Panties'].colored) + "_" + str(newgirl['Mystique'].Panties) + "_Down.png",im.matrix.opacity(float(newgirl['Mystique'].Colors['Panties'].opacity)/255.0)*im.matrix.tint(float(newgirl['Mystique'].Colors['Panties'].red)/255.0, float(newgirl['Mystique'].Colors['Panties'].green)/255.0, float(newgirl['Mystique'].Colors['Panties'].blue)/255.0)),
            "True", Null(),                     
            ),  
        ...
        (0,0), ConditionSwitch(                                                                                 #Panties if up
            ...
            "True", im.MatrixColor("images/MystiqueDoggy/Mystique_Doggy_Panties" + str(newgirl['Mystique'].Colors['Panties'].colored) + "_" + str(newgirl['Mystique'].Panties) + ".png",im.matrix.opacity(float(newgirl['Mystique'].Colors['Panties'].opacity)/255.0)*im.matrix.tint(float(newgirl['Mystique'].Colors['Panties'].red)/255.0, float(newgirl['Mystique'].Colors['Panties'].green)/255.0, float(newgirl['Mystique'].Colors['Panties'].blue)/255.0)),
            "True", Null(),                     
            ),  
        ...
        #    "True", Null(), 
        #    ),
        (0,0), ConditionSwitch(                     #Legs Layer(skirts)
            "newgirl['Mystique'].Upskirt and P_Sprite and P_Cock == 'anal' and Speed", im.MatrixColor("images/MystiqueDoggy/Mystique_Doggy_Legs" + str(newgirl['Mystique'].Colors['Legs'].colored) + "_" + str(newgirl['Mystique'].Legs) + "_UpAnal.png",im.matrix.opacity(float(newgirl['Mystique'].Colors['Legs'].opacity)/255.0)*im.matrix.tint(float(newgirl['Mystique'].Colors['Legs'].red)/255.0, float(newgirl['Mystique'].Colors['Legs'].green)/255.0, float(newgirl['Mystique'].Colors['Legs'].blue)/255.0)),
            "newgirl['Mystique'].Upskirt", im.MatrixColor("images/MystiqueDoggy/Mystique_Doggy_Legs" + str(newgirl['Mystique'].Colors['Legs'].colored) + "_" + str(newgirl['Mystique'].Legs) + "_Up.png",im.matrix.opacity(float(newgirl['Mystique'].Colors['Legs'].opacity)/255.0)*im.matrix.tint(float(newgirl['Mystique'].Colors['Legs'].red)/255.0, float(newgirl['Mystique'].Colors['Legs'].green)/255.0, float(newgirl['Mystique'].Colors['Legs'].blue)/255.0)),
            "True", im.MatrixColor("images/MystiqueDoggy/Mystique_Doggy_Legs" + str(newgirl['Mystique'].Colors['Legs'].colored) + "_" + str(newgirl['Mystique'].Legs) + ".png",im.matrix.opacity(float(newgirl['Mystique'].Colors['Legs'].opacity)/255.0)*im.matrix.tint(float(newgirl['Mystique'].Colors['Legs'].red)/255.0, float(newgirl['Mystique'].Colors['Legs'].green)/255.0, float(newgirl['Mystique'].Colors['Legs'].blue)/255.0)),
            "True", Null(),                      
            ),   
