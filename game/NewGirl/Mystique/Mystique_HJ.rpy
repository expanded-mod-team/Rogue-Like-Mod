...
label Mystique_Handjob:
    ...
    $ Approval = Mod_ApprovalCheck("Mystique", 1100, TabM = 3) # 110, 125, 140, Taboo -120(230)
    ...
    if Approval >= 2:                                                                   #She's into it. . .               
        ...
        menu:
            ...
            "Come on, get to work.":                                               # Pressured into it
                $ Approval = Mod_ApprovalCheck("Mystique", 350, "OI", TabM = 3) # 35, 50, 65, -120(155)
    ...
    if "no hand" in newgirl["Mystique"].DailyActions:
        ...
        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -2) if newgirl["Mystique"].Love > 300 else newgirl["Mystique"].Love
        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, -2)    
        $ newgirl["Mystique"].RecentActions.append("angry")
        $ newgirl["Mystique"].DailyActions.append("angry")   
...
label MystiqueHJ_Prep:
    ...
    call Mod_DrainWord("Mystique","no hand")
                    ...
                    menu:
                        ...
                        "No, get back down there.":
                                if Mod_ApprovalCheck("Mystique", 1200) or Mod_ApprovalCheck("Mystique", 500, "O"):
                                    ...
                                    $ newgirl["Mystique"].DailyActions.append("angry")   
                                    jump Mystique_HJAfter
        elif Cnt == 10 and newgirl["Mystique"].SEXP <= 100 and not Mod_ApprovalCheck("Mystique", 1200, "LO"):
                    $ newgirl["Mystique"].Brows = "confused"
...
label Mystique_Blowjob:
    ...
    $ Approval = Mod_ApprovalCheck("Mystique", 1300, TabM = 4) # 130, 145, 160, Taboo -160(290)
        ...
        if Approval > 2:                                                      # fix, add Mystique auto stuff here
            ...
            menu:
                ...
                "Praise her.":       
                    ...
                    call Mystique_Namecheck
                    "Mystique continues her actions."
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 85, 1)
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 90, 1)
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 2)
                "Ask her to stop.":     
                    call MystiqueFace("surprised")
        ...
        menu:
            ...
            "Come on, please?":             
                if Approval:
                    ...
                    if Mod_ApprovalCheck("Mystique", 1100, TabM = 3): # 110, 125, 140, Taboo -120(230)             Handy instead?    
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 1) 
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 60, 3) 
            ...
            "Suck it, [newgirl[Mystique].Pet]":                                               # Pressured into it                
                call Mystique_Namecheck
                $ Approval = Mod_ApprovalCheck("Mystique", 750, "OI", TabM = 3) # 75, 90, 105, -120(195)
                if Approval > 1 or (Approval and newgirl["Mystique"].Forced):
                    call MystiqueFace("sad")
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -5, 1)
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -2)                 
...
label MystiqueBJ_Prep:   
    ...
    if not newgirl["Mystique"].Blow:        
        if newgirl["Mystique"].Forced:
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -70)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 45)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 60) 
        else:
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, 5)
    ...
    if Taboo:
        call Mod_DrainWord("Mystique","tabno")
    call Mod_DrainWord("Mystique","no blow")
                ...
                menu:
                    ...
                    "No, get back down there.":
                            if Mod_ApprovalCheck("Mystique", 1200) or Mod_ApprovalCheck("Mystique", 500, "O"):
                                ...
                                $ newgirl["Mystique"].DailyActions.append("angry")   
                                jump Mystique_BJAfter        
        elif Cnt == (5 + newgirl["Mystique"].Blow) and newgirl["Mystique"].SEXP <= 100 and not Mod_ApprovalCheck("Mystique", 1200, "LO"):
                    $ newgirl["Mystique"].Brows = "confused"
                    ...
                    menu:
                        ...
                        "Take it deeper." if Speed != 4:
                                if "pushed" not in newgirl["Mystique"].RecentActions and newgirl["Mystique"].Blow < 5:
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 80, -(20-(2*newgirl["Mystique"].Blow))) 
                                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, (30-(3*newgirl["Mystique"].Blow)))
                                ...
                                "How about a handy?":
                                        if newgirl["Mystique"].Action and MultiAction:
                                            if  newgirl["Mystique"].Over == "armbinder":
                                                ...
                                                if newgirl["Mystique"].Chest or newgirl["Mystique"].Legs or newgirl["Mystique"].Panties:
...
#     if newgirl["Mystique"].SeenChest and Mod_ApprovalCheck("Mystique", 500): # You've seen her tits.
#         $ Tempmod += 10    
...
#     $ Approval = Mod_ApprovalCheck("Mystique", 1200, TabM = 5) # 120, 135, 150, Taboo -200(320)
...
#                     jump MystiqueTJ_Prep
#                 else:   
#                     $ Approval = Mod_ApprovalCheck("Mystique", 1100, TabM = 3) # 110, 125, 140, Taboo -120(230)             Handy instead?
#                     if Approval >= 2:       
#                         $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 1) 
#                         $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 60, 3) 
#                         call MystiqueFace("confused", 1)
...
#                 call Mystique_Namecheck
#                 $ Approval = Mod_ApprovalCheck("Mystique", 700, "OI", TabM = 4) # 70, 85, 100, -160(230)
#                 if Approval > 1 or (Approval and newgirl["Mystique"].Forced):
#                     call MystiqueFace("sad")
#                     $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -5, 1)
#                     $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -2)                 
...
#     if Taboo:
#         call Mod_DrainWord("Mystique","tabno")
#     call Mod_DrainWord("Mystique","no titjob")
...
#             $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 40, 2) 
#         if P_Focus > 60:
#             $ P_Focus -= 5
#         else:
#             $ P_Focus += 3
...
#             $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 70, 15)
...
#             $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 40, 15, 1)
#             $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 200, 5) 
...
#                 "She pauses to rub her nipples across the shaft",
#                 "She gently caresses the shaft between her tits"])            
#             $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 60, 10)
#             $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 200, 5) 
#             $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 60, 3)
...
#             $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 50, 8, 1)
#             $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 200, 7) 
#             $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 60, 2)
#             $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 200, 4) 
...
#             $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 60, 7)
#             $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 200, 5) 
#             $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 60, 3)
#             $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 200, 3)                 
#         else:                                                       #fast
...
#             $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 60, 7)
#             $ P_Focus = Mod_Statupdate("Mystique", "Focus", P_Focus, 200, 4) 
#             $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 60, 2)
#             $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 200, 3) 
...
label Mystique_Dildo_Pussy:
    ...
    $ Approval = Mod_ApprovalCheck("Mystique", 1250, TabM = 4) # 125, 140, 155, Taboo -160(335)
                ...
                if (newgirl["Mystique"].DildoP and Approval) or (Approval > 1):                                                                      #this is not the first time you've had sex, or she's into it         
                    ...
                    menu:
                        ...
                        "Just playing with my favorite toys.":                    
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 80, -10, 1)  
                            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -10)
                            "You press it inside some more."                              
                            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 3)
                            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 3) 
                            if not Mod_ApprovalCheck("Mystique", 700, "O", TabM=1): #Checks if Obed is 700+                             
                                call MystiqueFace("angry")
                                "Mystique shoves you away and slaps you in the face."
                                ch_m "Jerk!"
                                ch_m "Ask nice if you want to stick something in my ass!"                                               
                                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 50, -10, 1)                        
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 3)
                                $ renpy.pop_call()
                                if Situation:
                                    $ renpy.pop_call()
            ...
            menu:
                ...
                "[[press it against her]":                                               # Pressured into it
                    ...
                    if Approval > 1 or (Approval and newgirl["Mystique"].Forced):
                        ...
                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 4)
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 1) 
                        $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 60, 3)  
                        $ newgirl["Mystique"].Forced = 1  
                        jump MystiqueDP_Prep
...
label MystiqueDP_Prep: #Animation set-up 
    ...
    if not newgirl["Mystique"].DildoP:        
        if newgirl["Mystique"].Forced:
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -75)
            ...
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 20)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 45)
    if Taboo:
        $ newgirl["Mystique"].Inbt += int(Taboo/10)  
        $ newgirl["Mystique"].Lust += int(Taboo/5)
    ...
    if Taboo:
        call Mod_DrainWord("Mystique","tabno")
    call Mod_DrainWord("Mystique","no dildo")
...
label MystiqueDP_Cycle: #Repeating strokes    
    while Round >=0:  
        ...
        if Cnt == (5 + newgirl["Mystique"].DildoP):
                    ...
                    pass
        elif Cnt == (15 + newgirl["Mystique"].DildoP) and newgirl["Mystique"].SEXP >= 15 and not Mod_ApprovalCheck("Mystique", 1500):
                    $ newgirl["Mystique"].Brows = "confused"        
                    menu:
...
label Mystique_Dildo_Ass:
    ...
    $ Approval = Mod_ApprovalCheck("Mystique", 1450, TabM = 4) # 145, 160, 175, Taboo -160(355)
    ...
    if Approval >= 2:                                                                  
            ...
            menu:
                ...
                "[[press it against her]":                                               # Pressured into it
                    $ Approval = Mod_ApprovalCheck("Mystique", 1050, "OI", TabM = 3) # 105, 120, 135, -120(225)
                    if Approval > 1 or (Approval and newgirl["Mystique"].Forced):
                        call MystiqueFace("sad")
                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -5, 1)
                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -5)                 
...
label MystiqueDA_Cycle: #Repeating strokes    
    while Round >=0:  
        ...
        if Cnt == (5 + newgirl["Mystique"].DildoA):
                    ...
                    pass
        elif Cnt == (15 + newgirl["Mystique"].DildoA) and newgirl["Mystique"].SEXP >= 15 and not Mod_ApprovalCheck("Mystique", 1500):
                    $ newgirl["Mystique"].Brows = "confused"        
                    menu:
                        ch_m "[newgirl[Mystique].Petname], this is getting uncomfortable, maybe we could try something else."                         
                        "Finish up.":
...
label Mystique_Footjob:
    ...
    $ Approval = Mod_ApprovalCheck("Mystique", 1250, TabM = 3) # 110, 125, 140, Taboo -120(230)
    ...
    if Approval >= 2:                                                                   #She's into it. . .               
        ...
        menu:
            ...
            "Come on, get to work.":                                               # Pressured into it
                $ Approval = Mod_ApprovalCheck("Mystique", 400, "OI", TabM = 3) # 35, 50, 65, -120(155)
                if Approval > 1 or (Approval and newgirl["Mystique"].Forced):
                    call MystiqueFace("sad")
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -5, 1)
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -2)                 
...
label MystiqueFJ_Prep:
    ...
    if Taboo:
        call Mod_DrainWord("Mystique","tabno")
    call Mod_DrainWord("Mystique","no foot")
...
label Mystique_Les_Response(Girl="Rogue", Step=1, B=0, B2=0, Tempmod=0, Result=0, Approval = 0):
        ...
        $ Approval = Mod_ApprovalCheck("Mystique", 1300, TabM = 2, Bonus = B) # 1300, 1450, 1600, Taboo -800
        ...
        if Step == 2:
            ...
            if Approval >= 2:
                ...
                menu:
                    ...
                    "Get in there, now.":
                            if Mod_ApprovalCheck("Mystique", 550, "OI", TabM = 2):
