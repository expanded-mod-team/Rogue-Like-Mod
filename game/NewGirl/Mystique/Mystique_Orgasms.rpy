...
#                    if newgirl["Mystique"].Addict >= 60 and Mod_ApprovalCheck("Mystique", 1000, "I", Bonus = ((newgirl["Mystique"].Addict*10)- newgirl["Mystique"].Obed)) and newgirl["Mystique"].Swallow:
...
#            if Mod_ApprovalCheck("Mystique", 500, "I", Bonus = ((newgirl["Mystique"].Addict*10)- newgirl["Mystique"].Obed)) and newgirl["Mystique"].Addict > 50 and newgirl["Mystique"].Swallow: #If addict + Inbt is > obedience + 50. . .
#                    $ newgirl["Mystique"].Eyes = "manic"
...
#                                if Mod_ApprovalCheck("Mystique", 250, "I", Bonus = ((newgirl["Mystique"].Addict*10)- newgirl["Mystique"].Obed)) or newgirl["Mystique"].Addict > 75:                            
...
label Mystique_Warn_Her:                                                                                                                       #Warn her start
        ...
        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 80, 5) if newgirl["Mystique"].Obed >= 500 else newgirl["Mystique"].Obed   
...
label Mystique_In_Mouth:      
    ...
    if Situation == "auto":
                ...
                if "full" in newgirl["Mystique"].RecentActions:
                        ...
                        if Mod_ApprovalCheck("Mystique", 800, "LI") and Mod_ApprovalCheck("Mystique", 400, "OI"):
                        ...
                        menu:
                            ...
                            "Why don't you try swallowing it?":
                                    if Mod_ApprovalCheck("Mystique", 1200):
                                        ...
                                        $ newgirl["Mystique"].Spunk.remove("mouth")
                                    elif Mod_ApprovalCheck("Mystique", 1200, "OI", Bonus = (newgirl["Mystique"].Addict*10)):
                                        call MystiqueFace("bemused", 1)
                            ...
                            "Swallow it, now.":
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 30, -1, 1)
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 50, -1, 1)                    
                                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 80, -1, 1)
                                    if Mod_ApprovalCheck("Mystique", 1200, "OI") or newgirl["Mystique"].Addict >= 50:                            
    ...
    if  Mod_ApprovalCheck("Mystique", 300, "LI") or Mod_ApprovalCheck("Mystique", 300, "OI"): 
        call MystiqueFace("bemused")
        $ newgirl["Mystique"].Eyes = "sexy"
    else:
        call MystiqueFace("angry")
    ...
    menu:
        extend ""
        "Sorry about that.":
                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 80, 3)
                $ newgirl["Mystique"].Addictionrate += 1
                if "addictive" in P_Traits:
                    $ newgirl["Mystique"].Addictionrate += 1
                call MystiqueFace("smile", 1)
                ch_m "It is a tempting offer. . ."
                if Mod_ApprovalCheck("Mystique", 1200, TabM=1) and "full" not in newgirl["Mystique"].RecentActions:
                    $ Approval = 2 
        ...
        "Give it a try, you might like it." if "full" not in newgirl["Mystique"].RecentActions:
                if Mod_ApprovalCheck("Mystique", 1200, TabM=1):  
                    $ Approval = 2
        ...
        "Seriously, put it in your mouth.":
                if Mod_ApprovalCheck("Mystique", 1500, "LI", TabM=1) or Mod_ApprovalCheck("Mystique", 1200, "OI", TabM=1):
                        call MystiqueFace("sucking", 1)
                elif Mod_ApprovalCheck("Mystique", 1000, "OI", Bonus = (newgirl["Mystique"].Addict*10)): #Mild addiction included                
    ...
    if Mod_ApprovalCheck("Mystique", 1000) and newgirl["Mystique"].Swallow >= 3:
            ch_m "It does grow on you. . ."    
...
label Mystique_Creampie_P:
        if Trigger == "sex" and Situation == "auto":
                ...
                $ P_Spunk = "in"
                $ Speed = 0
                if Mod_ApprovalCheck("Mystique", 1300) or newgirl["Mystique"].CreamP:              
        ...
        if Mod_ApprovalCheck("Mystique", 1200) or newgirl["Mystique"].CreamP:        
                call MystiqueFace("sexy")
...
label Mystique_SpunkBelly:
    ...
    if newgirl["Mystique"].Addict >= 60 and Mod_ApprovalCheck("Mystique", 800, "I", Bonus = ((newgirl["Mystique"].Addict*10)- newgirl["Mystique"].Obed)) and newgirl["Mystique"].Swallow: 
...
label Mystique_Swallowed: 
        ...
        if Trigger == "anal":    
                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 2)
                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 200, 2)
...
label Mystique_Creampied:
    if Trigger == "sex":
            ...
            $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 200, 10)
...
#    $ newgirl["Mystique"].Girl_Arms = 2
    $ P_Cock = "out"
    $ Speed = 0    
    if Trigger == "anal" and not Mod_ApprovalCheck("Mystique", 1600, TabM=1) and not newgirl["Mystique"].Addict >= 80:
            "She wipes your cock clean."
    elif newgirl["Mystique"].Blow > 3 or newgirl["Mystique"].Swallow: 
            if Mod_ApprovalCheck("Mystique", 1200, TabM=1) or newgirl["Mystique"].Addict >= 60:
                    call Mystique_BJ_Launch("cum")
                    $ Speed = 1
                    call MystiqueFace("sucking", 1)
                    if Mod_ApprovalCheck("Mystique", 1500, TabM=1):
...
label Mystique_Cumming:
    ...
    if "unsatisfied" in newgirl["Mystique"].RecentActions:  #If she had been unsatisfied, you satisfied her. . .        
            ...
            call Mod_DrainWord("Mystique","unsatisfied")
                    ...
                    menu:
                        ...
                        "No, I'm not done yet.":
                            if Trigger == "sex" or Trigger == "anal":
                                if Mod_ApprovalCheck("Mystique", 1000, TabM=1) or Mod_ApprovalCheck("Mystique", 400, "O", TabM=1):
...
label Mystique_Cleanup(Options = [], Cnt = 0, Line = "random", Cleaned = 0):
    ...
    if newgirl["Mystique"].Addict > 80 and newgirl["Mystique"].Swallow:
        ...
        $ newgirl["Mystique"].Eyes = "manic"
        $ newgirl["Mystique"].Mouth = "smile" 
    elif "painted" in newgirl["Mystique"].RecentActions and Mod_ApprovalCheck("Mystique", 1000, "OI"):
        return
    elif Mod_ApprovalCheck("Mystique", 1200, "LO"):  
        $ Line = "ask"            
    elif not Mod_ApprovalCheck("Mystique", 400, "I"):
        call MystiqueFace("bemused")
        $ Line = "clean"   
    else:
        $ Line = "ask"      
    ...
    if Line == "ask":
            ...
            menu:
                ...
                "You should leave it where it is.":
                        if Mod_ApprovalCheck("Mystique", 900, "I") or "exhibitionist" in newgirl["Mystique"].Traits:
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 2)
                        ...
                        elif Mod_ApprovalCheck("Mystique", 600, "I") and Mod_ApprovalCheck("Mystique", 1200, "LO"):
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 90, 1)
                            ...
                            menu:
                                ch_m "Excuse me?" 
                                "Please?":
                                    if Mod_ApprovalCheck("Mystique", 1800):
                                        ...
                                        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 75, -5)
                                ...
                                "I insist.":
                                    call MystiqueFace("sad")
                                    if Mod_ApprovalCheck("Mystique", 400, "I") and Mod_ApprovalCheck("Mystique", 1200, "LO"):
                                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 40, 3)
                                        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 90, 2)
                                        ch_m "Well then."
                                        $ Line = "leave"  
                                    elif Mod_ApprovalCheck("Mystique", 800, "O"):
                ...
                "You should just eat it.":
                        call MystiqueFace("sly")
                        if "hungry" in newgirl["Mystique"].Traits or (newgirl["Mystique"].Swallow >= 5 and Mod_ApprovalCheck("Mystique", 800)): 
                                #lots of swallows
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 90, 1)
                                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 3) 
                                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 1) 
                        ...
                        elif newgirl["Mystique"].Swallow and Mod_ApprovalCheck("Mystique", 800): 
                                #few swallows
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, 1)
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 90, 1)
                                $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 2) 
                                ...
                                #doesn't like you.
                                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 50, -5)
                                $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -3)
                                call MystiqueFace("angry")
                                ch_m "No."
                        #end eat it
                              
                "You should just clean it up.":
                        if Mod_ApprovalCheck("Mystique", 600, "I") and not Mod_ApprovalCheck("Mystique", 1500, "LO"): #rebellious
                                call MystiqueFace("sly")
                                $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, -3)
    ...
    if Line == "random":
            $ Options = ["clean"]
            if newgirl["Mystique"].Swallow and Mod_ApprovalCheck("Mystique", 800):
                $ Options.append("eat") 
                if newgirl["Mystique"].Swallow >=5:                            
                    $ Options.append("eat") 
                if "hungry" in newgirl["Mystique"].Traits:                
                    $ Options.append("eat") 
            if Mod_ApprovalCheck("Mystique", 600, "I"):
                $ Options.append("leave") 
                if Mod_ApprovalCheck("Mystique", 800, "I"):
                    $ Options.append("leave") 
    ...
    if Line == "leave":
            ...
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 200, 1) 
    ...
    if "in" in newgirl["Mystique"].Spunk:
            ...
            $ Cnt += 1 
    if "anal" in newgirl["Mystique"].Spunk and (Mod_ApprovalCheck("Mystique", 800, "I") or Line != "eat"):
