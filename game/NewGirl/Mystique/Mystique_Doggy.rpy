...
label Mystique_Doggy_P:  
    ...
    $ Approval = Mod_ApprovalCheck("Mystique", 1400, TabM = 5) # 135, 150, 165, Taboo -200(335)
    ...
    if not newgirl["Mystique"].Sex and Approval:                                                  #First time dialog        
        if newgirl["Mystique"].Forced: 
            call MystiqueFace("sad")
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -30, 1)
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 20, -20, 1)
    ...
    if Approval >= 2:                                                                   #She's into it. . .               
        ...
        menu:
            ...
            "Bend over.":                                               # Pressured into it
                $ Approval = Mod_ApprovalCheck("Mystique", 1150, "OI", TabM = 3) # 115, 130, 145, -120(235)
...
label Mystique_Doggy_SexPrep:
    ...
    if Situation != "auto":
        ...
        if newgirl["Mystique"].Panties or newgirl["Mystique"].Legs or ModHoseNum("Mystique") >= 5: #If she refuses to take off her pants but agreed to sex
    ...
    if not newgirl["Mystique"].Sex:        
        if newgirl["Mystique"].Forced:
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -150)
    ...
    call Mod_DrainWord("Mystique","no sex")
...
label Mystique_Gagging(Gagtype = 0):
    ...
    $ Approval = Mod_ApprovalCheck("Mystique", 1450, TabM = 5) # 155, 170, 185, Taboo -200(355)
        ...
        if (newgirl["Mystique"].Gagx and Approval) or (Approval > 1):                                                                      #this is not the first time you've had sex, or she's into it         
            ...
            menu:
                ...
                "Just shut up.":                    
                    ...
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 3) 
                    if not Mod_ApprovalCheck("Mystique", 700, "O", TabM=1):                        
                        call MystiqueFace("angry")
    ...
    if Approval >= 2:                                                                   #She's into it. . .               
        ...
        menu:
            ...
            "Shut it.":                                               # Pressured into it
                $ Approval = Mod_ApprovalCheck("Mystique", 1250, "OI", TabM = 3) # 125, 140, 155, -120(245)
                if Approval > 1 or (Approval and newgirl["Mystique"].Forced):
                    call MystiqueFace("sad")
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -5, 1)
                    $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 200, -5)                 
...
label Mystique_GagPrep:    
    ...
    if not newgirl["Mystique"].Gagx:                                                      #First time stat buffs       
        if newgirl["Mystique"].Forced:
            $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 90, -150)
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 70)
            ...
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 30)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 70) 
        ...
        if newgirl["Mystique"].Forced:
            ...
            $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 7)
            $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 80, 5) 
    ...
    if Taboo:
        call Mod_DrainWord("Mystique","tabno")
    #call Mod_DrainWord("Mystique","no anal")
...
label Mystique_Doggy_A:
    ...
    $ Approval = Mod_ApprovalCheck("Mystique", 1550, TabM = 5) # 155, 170, 185, Taboo -200(355)
...
label MystiquePA_Prep:  
    ...
    if Situation != "auto":
        call Mystique_Bottoms_Off
        if newgirl["Mystique"].Panties or newgirl["Mystique"].Legs or ModHoseNum("Mystique") >= 5: #If she refuses to take off her pants but agreed to anal
            ch_m "Well, I guess some things are necessary, [newgirl[Mystique].Petname]."
...
label Mystique_Doggy_H: 
    ...
    $ Approval = Mod_ApprovalCheck("Mystique", 1000, TabM = 3) # 100, 115, 130, Taboo -120(220)
        ...
        if (newgirl["Mystique"].Hotdog and Approval) or (Approval > 1):                                                                      #this is not the first time you've had sex, or she's into it         
            ...
            menu:
                ...
                "You'll see.":                    
                    ...
                    $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 70, 3)
                    $ newgirl["Mystique"].Inbt = Mod_Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 50, 3) 
                    if not Mod_ApprovalCheck("Mystique", 500, "O", TabM=1): #Checks if Obed is 700+  
                        call MystiqueFace("angry")
                        "Mystique shoves you away."
                        ch_m "Dick!"
    ...
    if newgirl["Mystique"].Forced:
        ...
        $ newgirl["Mystique"].Lust = Mod_Statupdate("Mystique", "Lust", newgirl["Mystique"].Lust, 200, 5)  
        $ newgirl["Mystique"].Love = Mod_Statupdate("Mystique", "Love", newgirl["Mystique"].Love, 70, -1) if newgirl["Mystique"].Love > 300 else newgirl["Mystique"].Love
        $ newgirl["Mystique"].Obed = Mod_Statupdate("Mystique", "Obed", newgirl["Mystique"].Obed, 50, -1)  
        $ newgirl["Mystique"].RecentActions.append("angry")
        $ newgirl["Mystique"].DailyActions.append("angry")   
    elif Taboo:                             # she refuses and this is too public a place for her
...
label Mystique_Doggy_HotdogPrep:  
    ...
    if Taboo:
        call Mod_DrainWord("Mystique","tabno")
    call Mod_DrainWord("Mystique","no hotdog")
