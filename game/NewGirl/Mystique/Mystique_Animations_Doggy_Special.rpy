...
image Mystique_Doggy:
    ConditionSwitch(          
    "newgirl['Mystique'].LooksLike == 'Raven'", "Mystique_Mystique_Doggy",
    "newgirl['Mystique'].LooksLike", "Mystique_" + str(newgirl['Mystique'].LooksLike) + "_Doggy",
    # "newgirl['Mystique'].LooksLike == 'Mystique'", "Mystique_Mystique_Doggy",
